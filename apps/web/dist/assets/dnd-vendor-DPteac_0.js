import { r as l, R as M, a as we } from "./react-vendor-BNYpS37_.js";
const $e =
  typeof window < "u" &&
...
const G = $e ? l.useLayoutEffect : l.useEffect;
function Ke(e) {
  const t = l.useRef(e);
  return (
    G(() => {
...
function at(e) {
  if (!e) return !1;
  const { KeyboardEvent: t } = P(e.target);
  return t && e instanceof t;
}
function mn(e) {
  if (!e) return !1;
  const { TouchEvent: t } = P(e.target);
  return t && e instanceof t;
}
function Re(e) {
  if (mn(e)) {
  ...
  return bn(e) ? { x: e.clientX, y: e.clientY } : null;
}
const Ee = Object.freeze({
    ...
    Transform: {
      toString(e) {
        if (e)
          return [Ee.Translate.toString(e), Ee.Scale.toString(e)].join(" ");
      },
    },
    Transition: {
      toString(e) {
...
function xn(e) {
  let { id: t, value: n } = e;
  return M.createElement("div", { id: t, style: wn }, n);
}
function Dn(e) {
...
function An(e) {
  ...
  const { announce: i, announcement: a } = Cn(),
    s = Ue("DndLiveRegion"),
    [c, u] = l.useState(!1);
  if (
    (l.useEffect(() => {
    ...
    Sn(
      l.useMemo(
        () => ({
          ...
          onDragMove(d) {
            let { active: v, over: h } = d;
            t.onDragMove && i(t.onDragMove({ active: v, over: h }));
          },
          onDragOver(d) {
            let { active: v, over: h } = d;
            i(t.onDragOver({ active: v, over: h }));
          },
          onDragEnd(d) {
            let { active: v, over: h } = d;
            i(t.onDragEnd({ active: v, over: h }));
          },
          onDragCancel(d) {
            let { active: v, over: h } = d;
            i(t.onDragCancel({ active: v, over: h }));
          },
        }),
        [i, t],
      ),
  ...
  const f = M.createElement(
    M.Fragment,
    null,
    M.createElement(xn, { id: r, value: o.draggable }),
    M.createElement(Dn, { id: s, announcement: a }),
  );
...
const kn = (e) => {
  ...
  for (const i of r) {
    ...
    if (s) {
      const c = Ln(s, t);
      c > 0 && o.push({ id: a, data: { droppableContainer: i, value: c } });
    }
  }
  return o.sort(Nn);
};
...
function Ut(e, t) {
  return e && t ? { x: e.left - t.left, y: e.top - t.top } : K;
}
function Pn(e) {
  return function (n) {
    for (
...
function Bn(e, t, n) {
  ...
  const { scaleX: o, scaleY: i, x: a, y: s } = r,
    ...
    u = e.top - s - (1 - i) * parseFloat(n.slice(n.indexOf(" ") + 1)),
    f = o ? e.width / o : e.width,
    d = i ? e.height / i : e.height;
  return { width: f, height: d, top: u, right: c + f, bottom: u + d, left: c };
}
...
function Ne(e, t) {
  ...
  if (t.ignoreTransform) {
    const { transform: u, transformOrigin: f } = P(e).getComputedStyle(e);
    u && (n = Bn(n, u, f));
  }
  const { top: r, left: o, width: i, height: a, bottom: s, right: c } = n;
  return { top: r, left: o, width: i, height: a, bottom: s, right: c };
}
function Nt(e) {
...
function lt(e, t) {
  ...
  function r(o) {
    ...
    if (!Ae(o) || Yt(o) || n.includes(o)) return n;
    const i = P(e).getComputedStyle(o);
    return (o !== e && Yn(o, i) && n.push(o), jn(o, i) ? n : r(o.parentNode));
  }
  return e ? r(e) : n;
}
function Ht(e) {
...
function Kn(e, t, n, r, o) {
  let { top: i, left: a, right: s, bottom: c } = n;
  (r === void 0 && (r = 10), o === void 0 && (o = $n));
  const { isTop: u, isBottom: f, isLeft: d, isRight: v } = Gt(e),
    h = { x: 0, y: 0 },
    C = { x: 0, y: 0 },
  ...
  return (
    !u && i <= t.top + g.height
      ? ((h.y = T.Backward),
        (C.y = r * Math.abs((t.top + g.height - i) / g.height)))
      : !f &&
        c >= t.bottom - g.height &&
        ((h.y = T.Forward),
        (C.y = r * Math.abs((t.bottom - g.height - c) / g.height))),
    !v && s >= t.right - g.width
      ? ((h.x = T.Forward),
        (C.x = r * Math.abs((t.right - g.width - s) / g.width)))
      : !d &&
        a <= t.left + g.width &&
        ((h.x = T.Backward),
        (C.x = r * Math.abs((t.left + g.width - a) / g.width))),
    { direction: h, speed: C }
  );
}
function Un(e) {
...
class en {
  constructor(t) {
    ...
    ((this.props = t),
      (this.listeners = new xe(ve(n))),
      (this.windowListeners = new xe(P(n))),
  ...
  attach() {
    (this.handleStart(),
      ...
      setTimeout(() => this.listeners.add(j.Keydown, this.handleKeyDown)));
  }
  handleStart() {
  ...
  handleKeyDown(t) {
    if (at(t)) {
      ...
      const { collisionRect: u } = r.current,
        f = u ? { x: u.left, y: u.top } : K;
      this.referenceCoordinates || (this.referenceCoordinates = f);
      const d = a(t, { active: n, context: r.current, currentCoordinates: f });
      if (d) {
        const v = Xe(d, f),
          h = { x: 0, y: 0 },
        ...
        for (const g of C) {
          const p = t.code,
            ...
            m = {
              x: Math.min(
                p === D.Right ? b.right - b.width / 2 : b.right,
                Math.max(p === D.Right ? b.left : b.left + b.width / 2, d.x),
              ),
              y: Math.min(
                p === D.Down ? b.bottom - b.height / 2 : b.bottom,
                Math.max(p === D.Down ? b.top : b.top + b.height / 2, d.y),
              ),
            },
            E = (p === D.Right && !x) || (p === D.Left && !w),
            L = (p === D.Down && !N) || (p === D.Up && !y);
          if (E && m.x !== d.x) {
            const A = g.scrollLeft + v.x,
              H = (p === D.Right && A <= S.x) || (p === D.Left && A >= R.x);
            if (H && !v.y) {
              g.scrollTo({ left: A, behavior: s });
              return;
            }
            (H
              ? (h.x = g.scrollLeft - A)
              : (h.x = p === D.Right ? g.scrollLeft - S.x : g.scrollLeft - R.x),
              h.x && g.scrollBy({ left: -h.x, behavior: s }));
            break;
          } else if (L && m.y !== d.y) {
            const A = g.scrollTop + v.y,
              H = (p === D.Down && A <= S.y) || (p === D.Up && A >= R.y);
            if (H && !v.x) {
              g.scrollTo({ top: A, behavior: s });
              return;
            }
            (H
              ? (h.y = g.scrollTop - A)
              : (h.y = p === D.Down ? g.scrollTop - S.y : g.scrollTop - R.y),
              h.y && g.scrollBy({ top: -h.y, behavior: s }));
            break;
          }
        }
        this.handleMove(t, he(Xe(d, this.referenceCoordinates), h));
      }
    }
  }
  handleMove(t, n) {
...
en.activators = [
  {
    eventName: "onKeyDown",
    handler: (e, t, n) => {
      let { keyboardCodes: r = Zt, onActivation: o } = t,
        { active: i } = n;
...
class ut {
  constructor(t, n, r) {
    ...
    ((this.props = t),
      (this.events = n),
      (this.document = ve(a)),
      (this.documentListeners = new xe(this.document)),
      (this.listeners = new xe(r)),
      (this.windowListeners = new xe(P(a))),
      (this.initialCoordinates = (o = Re(i)) != null ? o : K),
  ...
  attach() {
    ...
    if (
      ...
      this.windowListeners.add(j.Resize, this.handleCancel),
      this.windowListeners.add(j.DragStart, Tt),
      this.windowListeners.add(j.VisibilityChange, this.handleCancel),
      this.windowListeners.add(j.ContextMenu, Tt),
  ...
  handleStart() {
    ...
    t &&
      ((this.activated = !0),
      this.documentListeners.add(j.Click, Jn, { capture: !0 }),
      this.removeTextSelection(),
      this.documentListeners.add(j.SelectionChange, this.removeTextSelection),
      n(t));
  }
  handleMove(t) {
    var n;
    ...
    if (!o) return;
    const c = (n = Re(t)) != null ? n : K,
      u = Xe(o, c);
    if (!r && s) {
      if (Lt(s)) {
        if (s.tolerance != null && et(u, s.tolerance))
          return this.handleCancel();
        if (et(u, s.distance)) return this.handleStart();
      }
      if (kt(s) && et(u, s.tolerance)) return this.handleCancel();
...
const Qn = { move: { name: "mousemove" }, end: { name: "mouseup" } };
var rt;
(function (e) {
...
Zn.activators = [
  {
    ...
    handler: (e, t) => {
      let { nativeEvent: n } = e,
        { onActivation: r } = t;
      return n.button === rt.RightClick ? !1 : (r?.({ event: n }), !0);
    },
  },
];
const tt = {
...
class er extends ut {
  ...
  static setup() {
    return (
      window.addEventListener(tt.move.name, t, { capture: !1, passive: !1 }),
      function () {
...
function tr(e) {
  ...
  const h = rr({ delta: d, disabled: !i }),
    ...
    N = l.useCallback(() => {
      const R = w.current;
      if (!R) return;
      const b = p.current.x * y.current.x,
        m = p.current.y * y.current.y;
      R.scrollBy(b, m);
    }, []),
  ...
  l.useEffect(() => {
    ...
    for (const R of S) {
      ...
      const b = u.indexOf(R),
        m = f[b];
      if (!m) continue;
      const { direction: E, speed: L } = Kn(R, m, x, t, v);
      for (const A of ["x", "y"]) h[A][E[A]] || ((L[A] = 0), (E[A] = 0));
      if (L.x > 0 || L.y > 0) {
        (g(), (w.current = R), C(N, a), (p.current = L), (y.current = E));
        return;
      }
    }
    ((p.current = { x: 0, y: 0 }), (y.current = { x: 0, y: 0 }), g());
  }, [
    t,
    N,
    r,
...
const nr = {
  x: { [T.Backward]: !1, [T.Forward]: !1 },
  y: { [T.Backward]: !1, [T.Forward]: !1 },
};
function rr(e) {
...
function sr(e, t) {
  ...
  const [i, a] = l.useState(null),
    { frequency: s, measure: c, strategy: u } = o,
    f = l.useRef(e),
    d = p(),
    v = Se(d),
    h = l.useCallback(
      function (y) {
        (y === void 0 && (y = []),
          !v.current &&
            a((x) =>
              x === null ? y : x.concat(y.filter((w) => !x.includes(w))),
            ));
      },
      [v],
    ),
  ...
  return (
      ...
      if (e !== i) {
        ...
        const s = e
          .map((c) => {
            const u = Ze(c);
            return u
              ? (u.addEventListener("scroll", o, { passive: !0 }), [u, nt(u)])
              : null;
          })
          .filter((c) => c != null);
    ...
    l.useMemo(
      () =>
        e.length
          ? t
            ? Array.from(t.values()).reduce((i, a) => he(i, a), K)
            : _t(e)
          : K,
      [e, t],
    )
...
function nn(e) {
  return l.useMemo(() => (e ? Xn(e) : null), [e]);
}
const Ft = [];
function vr(e, t) {
  t === void 0 && (t = Ne);
...
function pr(e) {
  ...
  const [n, r] = l.useState(null),
      ...
      (u) => {
        for (const { target: f } of u)
          if (Ae(f)) {
            r((d) => {
              const v = t(f);
              return d ? { ...d, width: v.width, height: v.height } : v;
            });
            break;
          }
      },
    ...
    [s, c] = Be(a);
  return l.useMemo(() => ({ nodeRef: s, rect: n, setRef: c }), [n, s, c]);
}
const br = [
    { sensor: tn, options: {} },
    { sensor: en, options: {} },
...
const yr = {
    ...
    over: null,
    dragOverlay: { nodeRef: { current: null }, rect: null, setRef: je },
    scrollableAncestors: [],
  ...
  Te = l.createContext(on),
  sn = l.createContext(yr);
function wr() {
  return {
    draggable: {
      active: null,
...
function xr(e, t) {
  switch (t.type) {
    ...
    case O.RegisterDroppable: {
      const { element: n } = t,
        { id: r } = n,
        o = new Ce(e.droppable.containers);
      return (
        o.set(r, n),
...
function Dr(e) {
  let { disabled: t } = e;
  const { active: n, activatorEvent: r, draggableNodes: o } = l.useContext(Te),
    i = Fe(r),
    a = Fe(n?.id);
  return (
    l.useEffect(() => {
      if (!t && !r && i && a != null) {
        ...
        const s = o.get(a);
        if (!s) return;
        const { activatorNode: c, node: u } = s;
...
function Sr(e) {
  ...
  const i = l.useRef(!1),
    { x: a, y: s } = typeof o == "boolean" ? { x: o, y: o } : o;
  G(() => {
    if ((!a && !s) || !t) {
      i.current = !1;
      return;
    ...
    if (
      ...
      const v = Ht(u);
      v && v.scrollBy({ top: d.y, left: d.x });
    }
  }, [t, a, s, r, n]);
}
const He = l.createContext({ ...K, scaleX: 1, scaleY: 1 });
var re;
(function (e) {
...
const Wr = l.memo(function (t) {
    ...
    let {
      ...
      children: u,
      sensors: f = br,
      collisionDetection: d = kn,
      measuring: v,
      modifiers: h,
      ...C
    } = t;
    const g = l.useReducer(xr, void 0, wr),
      [p, y] = g,
      [x, w] = Rn(),
      [N, S] = l.useState(re.Uninitialized),
      R = N === re.Initialized,
      {
        draggable: { active: b, nodes: m, translate: E },
        droppable: { containers: L },
      } = p,
      A = b != null ? m.get(b) : null,
      H = l.useRef({ initial: null, translated: null }),
      V = l.useMemo(() => {
        var I;
        return b != null
          ? { id: b, data: (I = A?.data) != null ? I : mr, rect: H }
          : null;
      }, [b, A]),
      _ = l.useRef(null),
      ...
      Ve = Ue("DndDescribedBy", a),
      vt = l.useMemo(() => L.getEnabled(), [L]),
      ie = Cr(v),
      {
        droppableRects: le,
      ...
      Y = or(m, b),
      bt = l.useMemo(() => (q ? Re(q) : null), [q]),
      mt = vn(),
      yt = ar(Y, ie.draggable.measure);
    Sr({
      activeNode: b != null ? m.get(b) : null,
      config: mt.layoutShiftCompensation,
      initialRect: yt,
      measure: ie.draggable.measure,
    });
    const $ = Pt(Y, ie.draggable.measure, yt),
      ...
      wt = L.getNodeFor((n = se.current.over) == null ? void 0 : n.id),
      ae = pr({ measure: ie.dragOverlay.measure }),
      ...
      Ie = vr(Q),
      Pe = an(h, {
        transform: { x: E.x - Dt.x, y: E.y - Dt.y, scaleX: 1, scaleY: 1 },
        activatorEvent: q,
        active: V,
        activeNodeRect: $,
      ...
      un = xt ? Pe : he(Pe, cn),
      dn = In(un, (i = Z?.rect) != null ? i : null, $),
      Ge = l.useRef(null),
      Mt = l.useCallback(
        (I, z) => {
          let { sensor: B, options: ee } = z;
          if (_.current == null) return;
          const X = m.get(_.current);
          if (!X) return;
          const F = I.nativeEvent,
            U = new B({
              ...
              onAbort(k) {
                if (!m.get(k)) return;
                const { onDragAbort: W } = oe.current,
                  J = { id: k };
                (W?.(J), x({ type: "onDragAbort", event: J }));
              },
              onPending(k, te, W, J) {
                if (!m.get(k)) return;
                const { onDragPending: me } = oe.current,
                  ne = {
                    id: k,
                    constraint: te,
                ...
                (me?.(ne), x({ type: "onDragPending", event: ne }));
              },
              onStart(k) {
                const te = _.current;
                if (te == null) return;
                const W = m.get(te);
                if (!W) return;
                const { onDragStart: J } = oe.current,
                  be = {
                    activatorEvent: F,
                    active: { id: te, data: W.data, rect: H },
                  };
                we.unstable_batchedUpdates(() => {
                  (J?.(be),
                    S(re.Initializing),
                    y({ type: O.DragStart, initialCoordinates: k, active: te }),
                    x({ type: "onDragStart", event: be }),
                    ht(Ge.current),
                    gt(F));
                });
              },
              onMove(k) {
                y({ type: O.DragMove, coordinates: k });
              },
              onEnd: fe(O.DragEnd),
          ...
          function fe(k) {
            return async function () {
              ...
              let ne = null;
              if (W && me) {
                const { cancelDrop: ye } = oe.current;
                ((ne = {
                  activatorEvent: F,
                  active: W,
                  collisions: J,
              ...
              ((_.current = null),
                we.unstable_batchedUpdates(() => {
                  (y({ type: k }),
                    ...
                    gt(null),
                    (Ge.current = null));
                  const ye = k === O.DragEnd ? "onDragEnd" : "onDragCancel";
                  if (ne) {
                    const _e = oe.current[ye];
                    (_e?.(ne), x({ type: ye, event: ne }));
                  }
                }));
            };
          }
      ...
      fn = l.useCallback(
        (I, z) => (B, ee) => {
          const X = B.nativeEvent,
            F = m.get(ee);
          if (_.current !== null || !F || X.dndKit || X.defaultPrevented)
            return;
          const U = { active: F };
          I(B, z.options, U) === !0 &&
            ((X.dndKit = { capturedBy: z.sensor }), (_.current = ee), Mt(B, z));
        },
        [m, Mt],
      ),
      At = ir(f, fn);
    (hr(f),
      ...
      l.useEffect(() => {
        ...
        if (!I || _.current == null || !z || !X) return;
        const { onDragOver: F } = oe.current,
          U = ee.get(Rt),
          fe =
            U && U.rect.current
              ? {
        ...
        we.unstable_batchedUpdates(() => {
          (Et(fe), F?.(k), x({ type: "onDragOver", event: k }));
        });
      }, [Rt]),
      G(() => {
        ((se.current = {
          ...
          (H.current = { initial: ce, translated: de }));
      }, [V, Y, pe, de, m, ke, ce, le, L, Z, Q, ue]),
      tr({
        ...mt,
        delta: E,
        draggingRect: de,
    ...
    const hn = l.useMemo(
        ...
        [V, Y, $, q, pe, qe, ae, m, L, le, Z, Le, Q, Ie, ie, pt, Je],
      ),
      gn = l.useMemo(
        () => ({
          activatorEvent: q,
          ...
          active: V,
          activeNodeRect: $,
          ariaDescribedById: { draggable: Ve },
          dispatch: y,
          draggableNodes: m,
          over: Z,
          measureDroppableContainers: Le,
    ...
    return M.createElement(
      ...
      M.createElement(
        ...
        M.createElement(
          sn.Provider,
          { value: hn },
          M.createElement(He.Provider, { value: dn }, u),
        ),
        M.createElement(Dr, { disabled: s?.restoreFocus === !1 }),
      ),
      M.createElement(An, { ...s, hiddenTextDescribedById: Ve }),
    );
    function vn() {
      const I = ft?.autoScrollEnabled === !1,
        z = typeof c == "object" ? c.enabled === !1 : c === !1,
        B = R && !I && !z;
      return typeof c == "object" ? { ...c, enabled: B } : { enabled: B };
    }
  }),
...
function Hr(e) {
  ...
  G(
    () => (
      d.set(t, { id: t, key: i, node: x, activatorNode: N, data: b }),
      () => {
        const E = d.get(t);
  ...
  const m = l.useMemo(
    () => ({
      ...
      tabIndex: g,
      "aria-disabled": r,
      "aria-pressed": p && h === Xt ? !0 : void 0,
      "aria-roledescription": C,
      "aria-describedby": f.draggable,
    }),
    [r, h, g, p, C, f.draggable],
  );
  return {
    active: c,
    activatorEvent: s,
...
function Vr(e) {
  ...
  const i = Ue(Ar),
    ...
    f = l.useRef({ disabled: n }),
    d = l.useRef(!1),
    v = l.useRef(null),
    h = l.useRef(null),
    { disabled: C, updateMeasurementsFor: g, timeout: p } = { ...Or, ...o },
    y = Se(g ?? r),
    x = l.useCallback(() => {
      if (!d.current) {
        d.current = !0;
    ...
    w = We({ callback: x, disabled: C || !a }),
    N = l.useCallback(
      (m, E) => {
        w && (E && (w.unobserve(E), (d.current = !1)), m && w.observe(m));
      },
      [w],
    ),
    [S, R] = Be(N),
  ...
  return (
    l.useEffect(() => {
      !w ||
        !S.current ||
        (w.disconnect(), (d.current = !1), w.observe(S.current));
    }, [S, w]),
    l.useEffect(
      () => (
        s({
          type: O.RegisterDroppable,
          element: { id: r, key: i, disabled: n, node: S, rect: v, data: b },
        }),
        () => s({ type: O.UnregisterDroppable, key: i, id: r })
      ),
      [r],
    ),
    l.useEffect(() => {
      n !== f.current.disabled &&
        (s({ type: O.SetDroppableDisabled, id: r, key: i, disabled: n }),
        (f.current.disabled = n));
    }, [r, i, n, s]),
    { active: a, rect: v, isOver: c?.id === r, node: S, over: c, setNodeRef: R }
  );
}
function Nr(e) {
  ...
  return (
    ...
    M.createElement(
      ...
      null,
      n,
      r ? l.cloneElement(r, { ref: a }) : null,
    )
  );
}
const Tr = { x: 0, y: 0, scaleX: 1, scaleY: 1 };
function Lr(e) {
  let { children: t } = e;
  return M.createElement(
    Te.Provider,
    { value: on },
    M.createElement(He.Provider, { value: Tr }, t),
  );
}
const kr = { position: "fixed", touchAction: "none" },
  Ir = (e) => (at(e) ? "transform 250ms ease" : void 0),
  Pr = l.forwardRef((e, t) => {
    let {
      as: n,
      activatorEvent: r,
    ...
    const d = o ? u : { ...u, scaleX: 1, scaleY: 1 },
      v = {
        ...
        top: s.top,
        left: s.left,
        transform: Ee.Transform.toString(d),
        transformOrigin: o && r ? On(r, s) : void 0,
        transition: typeof f == "function" ? f(r) : f,
        ...c,
      };
    return M.createElement(n, { className: a, style: v, ref: t }, i);
  }),
  zr = (e) => (t) => {
  ...
  Br = (e) => {
    ...
    return [
      { transform: Ee.Transform.toString(t) },
  ...
  Fr = {
    ...
    easing: "ease",
    keyframes: Br,
    sideEffects: zr({ styles: { active: { opacity: "0" } } }),
  };
function Xr(e) {
  let {
    config: t,
  ...
  return Ke((i, a) => {
    ...
    const u = rn(a);
    if (!u) return;
    const { transform: f } = P(a).getComputedStyle(a),
      d = Wt(f);
    if (!d) return;
    const v = typeof t == "function" ? t : jr(t);
    return (
      Qt(c, o.draggable.measure),
      v({
        active: { id: i, data: s.data, node: c, rect: o.draggable.measure(c) },
        draggableNodes: n,
...
function jr(e) {
  ...
  return (i) => {
    let { active: a, dragOverlay: s, transform: c, ...u } = i;
    if (!t) return;
    const f = { x: s.rect.left - a.rect.left, y: s.rect.top - a.rect.top },
      d = {
        scaleX: c.scaleX !== 1 ? (a.rect.width * c.scaleX) / s.rect.width : 1,
        scaleY: c.scaleY !== 1 ? (a.rect.height * c.scaleY) / s.rect.height : 1,
      },
      v = { x: c.x - f.x, y: c.y - f.y, ...d },
      h = o({
        ...u,
        active: a,
        dragOverlay: s,
        transform: { initial: c, final: v },
      }),
      [C] = h,
      g = h[h.length - 1];
    if (JSON.stringify(C) === JSON.stringify(g)) return;
    const p = r?.({ active: a, dragOverlay: s, ...u }),
      y = s.node.animate(h, { duration: t, easing: n, fill: "forwards" });
...
const qr = M.memo((e) => {
  ...
  Jr = (e) => {
    let { activatorEvent: t, draggingNodeRect: n, transform: r } = e;
    if (n && t) {
      const o = Re(t);
      if (!o) return r;
      const i = o.x - n.left,
        a = o.y - n.top;
      return { ...r, x: r.x + i - n.width / 2, y: r.y + a - n.height / 2 };
    }
    return r;
  };
export {
