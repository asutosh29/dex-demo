import { b as Ve, G as g, i as m, v as E } from "./graph-YGIG_HlS.js";
import {
  i as z,
  c as I,
  k as Ye,
...
function An(e, n, r) {
  for (
    var t = -1, i = e.criteria, o = n.criteria, a = i.length, u = r.length;
    ++t < a;
  ) {
    var d = Fn(i[t], o[t]);
    if (d) {
...
function Un(e, n) {
  ...
  var r = Kn(e, n || Hn),
    t = Jn(r.graph, r.buckets, r.zeroIdx);
  return O(
    w(t, function (i) {
...
function oe(e, n, r, t) {
  ...
  return (
    arguments.length >= 4 && ((i.rank = r), (i.order = t)),
    N(e, "border", i, n)
  );
}
function Pe(e) {
...
function or(e) {
  function n(r) {
    var t = e.children(r),
      i = e.node(r);
    if (
      (t.length && f(t, n), Object.prototype.hasOwnProperty.call(i, "minRank"))
    ) {
      ((i.borderLeft = []), (i.borderRight = []));
      for (var o = i.minRank, a = i.maxRank + 1; o < a; ++o)
        (ue(e, "borderLeft", "_bl", r, i, o),
          ue(e, "borderRight", "_br", r, i, o));
    }
  }
  f(e.children(), n);
}
...
function jr(e) {
  ...
  function r(o) {
    return function (a) {
      a.merged ||
        ((m(a.barycenter) || m(o.barycenter) || a.barycenter >= o.barycenter) &&
          Gr(o, a));
    };
  }
  function t(o) {
...
function je(e, n, r, t) {
  ...
  f(s, function (p) {
    if (e.children(p.v).length) {
      var b = je(e, p.v, r, t);
      ((d[p.v] = b),
        Object.prototype.hasOwnProperty.call(b, "barycenter") && Dr(p, b));
    }
  });
  var c = Br(s, r);
  $r(c, d);
    ...
    return (
      f(a, function (c, l) {
        if (e.node(c).dummy === "border") {
          ...
          h.length &&
            ((d = e.node(h[0]).order), t(a, s, l, u, d), (s = l), (u = d));
        }
...
function ot(e, n, r) {
  return function (t, i, o) {
    var a = t.node(i),
      ...
      s;
    if (
      ((d += a.width / 2), Object.prototype.hasOwnProperty.call(a, "labelpos"))
    )
