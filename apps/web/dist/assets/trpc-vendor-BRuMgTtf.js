import { r as j, b as fr } from "./react-vendor-BNYpS37_.js";
var Fe = { exports: {} },
  fe = {};
var at;
function hr() {
...
var Mt = class {
    ...
    clearGcTimeout() {
      this.#t && (ie.clearTimeout(this.#t), (this.#t = void 0));
    }
  },
  Er = class extends Mt {
    #t;
...
var me = class extends ae {
  ...
  #O() {
    this.#l && (ie.clearTimeout(this.#l), (this.#l = void 0));
  }
  #P() {
    this.#f && (ie.clearInterval(this.#f), (this.#f = void 0));
  }
  createResult(e, t) {
    const r = this.#e,
      s = this.options,
