import { j as X } from "./trpc-vendor-BRuMgTtf.js";
import {
  r as l,
  b as Wr,
  a as Ut,
...
import { T as Ni } from "./textarea-_adpzycP.js";
var z = {};
var Di = [
  ...
  gn = function (e, r) {
    ...
    return (
      r.getShadowRoot
        ...
        : (o = Gr(e, r.includeContainer, Dn.bind(null, r))),
      Qr(o)
    );
  },
  qi = function (e, r) {
    ...
    return (
      r.getShadowRoot
        ...
        : (o = Gr(e, r.includeContainer, Nn.bind(null, r))),
      o
    );
  },
  eo = function (e, r) {
        ...
        queueMicrotask(() => {
          const fe = F(),
            Ve = !(
              ...
              (y &&
                (It(y.nodesRef.current, fe).find((q) => {
                  var ce, G;
                  return (
                    _e(
                      (ce = q.context) == null ? void 0 : ce.elements.floating,
                      oe,
                    ) ||
                    _e(
                      (G = q.context) == null
                  ...
                  gr(y.nodesRef.current, fe).find((q) => {
                    var ce, G, xe;
                    return (
                      [
                        (ce = q.context) == null
...
function $s(t, e) {
  ...
  (l.useEffect(() => {
    ...
    return (
      v &&
        (qe(n.domReference) && (T = sn(n.domReference)),
        qe(n.floating) && (T = T.concat(sn(n.floating))),
        !qe(n.reference) &&
          n.reference &&
...
function Us(t) {
  ...
  const h = pi({ ...t, elements: { ...n, ...(u && { reference: u }) } }),
    ...
    p = l.useCallback(
      (A) => {
        ((qe(A) || A === null) && ((b.current = A), i(A)),
          (qe(h.refs.reference.current) ||
  ...
  (pe(() => {
      ...
      if (a && r && n.floating)
        if (u == null) {
          ...
          if (
            ...
            const ce = () => {
              i.current[0] == null
                ? (q < 2 && (q ? requestAnimationFrame : queueMicrotask)(ce),
                  q++)
                : ((I.current =
    ...
    pe(() => {
      ...
      const ce = y.nodesRef.current,
        G =
          (q = ce.find((ke) => ke.id === J)) == null || (q = q.context) == null
            ? void 0
            : q.elements.floating,
        xe = nt(Be(n.floating)),
        we = ce.some(
      ...
      G && !we && $.current && G.focus({ preventScroll: !0 });
    }, [a, n.floating, y, J, p]),
    pe(() => {
      if (!a || !y || !p || J) return;
      function q(ce) {
      ...
      return (
        y.events.on("virtualfocus", q),
        () => {
          y.events.off("virtualfocus", q);
        }
      );
    }, [a, y, p, J, D]),
    pe(() => {
  ...
  const me = u != null,
    ie = l.useMemo(() => {
      function q(G) {
        ...
        const xe = i.current.indexOf(G);
        xe !== -1 && I.current !== xe && ((I.current = xe), S());
      }
      return {
        onFocus(G) {
          let { currentTarget: xe } = G;
          ((he.current = !0), q(xe));
        },
        onClick: (G) => {
          let { currentTarget: xe } = G;
        ...
        onMouseMove(G) {
          let { currentTarget: xe } = G;
          ((he.current = !0), (ae.current = !1), P && q(xe));
        },
        onPointerLeave(G) {
          let { pointerType: xe } = G;
          if (
            !(!$.current || xe === "touch") &&
    ...
    oe = l.useCallback(() => {
      ...
      return (
        Q ??
        (y == null ||
        (q = y.nodesRef.current.find((ce) => ce.id === J)) == null ||
        (q = q.context) == null ||
        (q = q.dataRef) == null
          ? void 0
    ...
    Pe = Te((q) => {
      if (
        (($.current = !1),
        (he.current = !0),
        q.which === 229 || (!Ae.current && q.currentTarget === Z.current))
      )
        return;
      if (h && _r(q.key, F, R, K)) {
        (on(q.key, oe()) || Ke(q),
          o(!1, q.nativeEvent, "list-navigation"),
          Je(n.domReference) &&
            (p
      ...
      if (
        (ee ||
          (q.key === "Home" && (Ke(q), (I.current = G), S()),
          q.key === "End" && (Ke(q), (I.current = xe), S())),
        K > 1)
      ) {
        const we =
            B ||
            ...
            ke[
              io(
                ...
                },
                {
                  ...
                  maxIndex: Pt,
                  prevIndex: uo(
                    I.current > xe ? G : I.current,
                    we,
                    ke,
                    K,
                    q.key === ht ? "bl" : q.key === (R ? vt : bt) ? "tr" : "tl",
                  ),
                  stopEvent: !0,
                },
              )
      ...
      if (on(q.key, F)) {
        if (
          (Ke(q),
          r && !p && nt(q.currentTarget.ownerDocument) === q.currentTarget)
        ) {
          ((I.current = kn(q.key, F, R) ? G : xe), S());
          return;
        }
        (kn(q.key, F, R)
          ? v
    ...
    Ve = l.useMemo(() => {
      function q(G) {
        E === "auto" && ro(G.nativeEvent) && (_.current = !0);
      }
      function ce(G) {
        ((_.current = E),
          E === "auto" && oo(G.nativeEvent) && (_.current = !0));
      }
      return {
        ...Me,
        onKeyDown(G) {
          $.current = !1;
          const xe = G.key.startsWith("Arrow"),
            we = ["Home", "End"].includes(G.key),
            ke = xe || we,
            Qe = Fr(G.key, F, R),
            Pt = _r(G.key, F, R, K),
            yt = Fr(G.key, oe(), R),
            ze = on(G.key, F),
            ot = (h ? yt : ze) || G.key === "Enter" || G.key.trim() === "";
          if (p && r) {
            ...
            if (ke && et && D) {
              ...
              if (Qe || Pt) {
                ...
                const tt =
                    ((Mt = et.context) == null
                      ? void 0
                      : Mt.elements.domReference) === G.currentTarget,
                  Gt =
                    Pt && !tt
                      ? (jt = et.context) == null
                        ? void 0
                      ...
                      : Qe
                        ...
                        : null;
                Gt && (Ke(G), Gt.dispatchEvent(it), re(void 0));
              }
              if (
                (ze || we) &&
                et.context &&
                et.context.open &&
                et.parentId &&
                G.currentTarget !== et.context.elements.domReference
              ) {
                var Wt;
                (Ke(G),
          ...
          if (!(!r && !C && xe)) {
            if (ot) {
              const Ot = on(G.key, oe());
              T.current = h && Ot ? null : G.key;
            }
            if (h) {
              yt &&
                (Ke(G),
                r
                  ...
                  : o(!0, G.nativeEvent, "list-navigation"));
              return;
            }
            ze &&
              (d != null && (I.current = d),
              Ke(G),
              !r && C ? o(!0, G.nativeEvent, "list-navigation") : Pe(G),
              r && S());
          }
        },
        onFocus() {
...
function iu(t) {
  ...
  const d = (b) => {
    ...
    return function (F) {
      ...
      if (
        (H && qe(F.relatedTarget) && An(p.floating, F.relatedTarget)) ||
...
function cu() {
  ...
  function K({
    ...
    const Re = P(),
      ...
      ),
      {
        ...
        placement: Oe,
        middleware: ft,
        whileElementsMounted: Ce ? void 0 : (...Ge) => e.autoUpdate(...Ge, dt),
        strategy: le,
      });
    (C(() => {
      if (!c) return;
      const Ge = m && "getBoundingClientRect" in m,
        lt = Ge ? m : m?.current;
      lt && (Ge ? mt.setPositionReference(lt) : mt.setReference(lt), Dt());
    }, [c, m, mt, Dt]),
      n.useEffect(() => {
    ...
    const [ct = "bottom", xt = "start"] = Ye.split("-"),
      Qt = n.useMemo(() => {
        const Ge = A[ct];
        return `${xt === "end" ? "start" : xt === "start" ? "end" : "center"} ${Ge}`;
      }, [ct, xt]),
      or = n.useCallback(
        (Ge = {}) => ({ ...Ge, "data-side": ct, "data-align": xt }),
        [ct, xt],
      ),
      ir = n.useMemo(() => {
        const Ge = Q(Nt) ? Nt : 0,
          lt = Q(kt) ? kt : 0;
        return { position: ut, top: Ge, left: lt, [b]: Qt };
      }, [ut, kt, Nt, Qt]),
  ...
  function ke() {
    return ze(/^iPad/) || (G() && navigator.maxTouchPoints > 1);
  }
  function Qe() {
    return xe() || ke();
  }
      ...
      function Re() {
        ...
        if (Qe()) {
          ...
          (Object.assign(O.style, {
            ...
            q() && !$e && (te.style.marginRight = `${ge}px`),
  ...
  var Jn = {
    ...
    Go = { overflow: "auto", scrollbarWidth: "none", msOverflowStyle: "none" },
