...
import {
  ...
  e as ae,
  f as se,
} from "./chunk-YZCP3GAM-Drz9XLIb.js";
import { I as fr } from "./chunk-QZHKN3VN-C6JuHObi.js";
  ...
  var e = g(function (ut, w, v, k) {
    ...
    Gt = {
      ...
      performAction: g(function (w, v, k, y, z, o, St) {
        ...
        switch (z) {
          ...
          case 24:
            ...
            break;
          case 30:
            (y.setDiagramTitle(o[T].substring(6)),
              (this.$ = o[T].substring(6)));
            break;
          case 31:
            (y.setDiagramTitle(o[T].substring(7)),
              (this.$ = o[T].substring(7)));
            break;
          case 32:
          ...
          case 60:
            this.$ = [
              o[T - 1],
              { type: "addLinks", actor: o[T - 1].actor, text: o[T] },
            ];
            break;
          case 61:
            this.$ = [
              o[T - 1],
              { type: "addALink", actor: o[T - 1].actor, text: o[T] },
            ];
            break;
          case 62:
            this.$ = [
              o[T - 1],
              { type: "addProperties", actor: o[T - 1].actor, text: o[T] },
            ];
            break;
          case 63:
            this.$ = [
              o[T - 1],
              { type: "addDetails", actor: o[T - 1].actor, text: o[T] },
            ];
            break;
          case 66:
            this.$ = [o[T - 2], o[T]];
      ...
      parse: g(function (w) {
        ...
        function tr(nt) {
          ((k.length = k.length - 2 * nt),
            (z.length = z.length - nt),
            (o.length = o.length - nt));
        }
        g(tr, "popStack");
        function Pe() {
          var nt;
          return (
            (nt = y.pop() || X.lex() || Ne),
            typeof nt != "number" &&
              (nt instanceof Array && ((y = nt), (nt = y.pop())),
              (nt = v.symbols_[nt] || nt)),
            nt
          );
        }
            ...
            case 2:
              if (
                ...
                (Zt = this.performAction.apply(
                  Ot,
                  [T, we, vt, gt.yy, ct[1], z, o].concat($e),
                )),
                typeof Zt < "u")
              )
                return Zt;
      ...
      var ut = {
        ...
        unput: g(function (w) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [z[0], z[0] + this.yyleng - v]),
...
` +
        ...
        next: g(function () {
          ...
          for (var z = this._currentRules(), o = 0; o < z.length; o++)
            if (
              ((k = this._input.match(this.rules[z[o]])),
              k && (!v || k[0].length > v[0].length))
            ) {
...
` +
        ...
        ((i = l?.type ?? i),
          l?.alias &&
            (!r || r.text === a) &&
            (r = { text: l.alias, wrap: r?.wrap, type: i }));
        const E = this.state.records.actors.get(t);
        if (E) {
          if (
            this.state.records.currentBox &&
            E.box &&
            this.state.records.currentBox !== E.box
          )
            throw new Error(
      ...
      parseBoxData(t) {
        ...
        if (window?.CSS)
          window.CSS.supports("color", r) ||
            ((r = "transparent"), (i = t.trim()));
        else {
          const l = new Option().style;
          ((l.color = r),
            l.color !== r && ((r = "transparent"), (i = t.trim())));
        }
        const { wrap: n, cleanedText: s } = this.extractWrap(i);
        return { text: s ? Vt(s, $()) : void 0, color: r, wrap: n };
      }
      addNote(t, a, r) {
        const i = {
            actor: t,
...
`;
  ...
  Kt = g(async function (e, t, a = null) {
    ...
    if (
      (r
        .attr("height", Math.round(s.height))
        .attr("width", Math.round(s.width)),
      t.class === "noteText")
    ) {
  ...
  mt = g(function (e, t) {
    ...
    if (t.valign !== void 0 && t.textMargin !== void 0 && t.textMargin > 0)
      switch (t.valign) {
        ...
        case "end":
          d = g(
            () => Math.round(t.y + (a + r + 2 * t.textMargin) - t.textMargin),
            "yfunc",
          );
          break;
      }
  ...
  br = g(function (e, t, a, r, i) {
    ...
    r ||
      ...
      Object.keys(t.links || {}).length &&
        !a.forceMenus &&
        p.attr("onclick", Ht(`actor${M}_popup`)).attr("cursor", "pointer"),
      p
        .append("line")
        .attr("id", "actor" + M)
        .attr("x1", s)
    ...
    if (
      (pt.has(d) &&
        (I.style("stroke", u[L % u.length]), I.style("fill", x[L % u.length])),
  ...
  `;
    ...
    if (
      ...
      const H = t.properties.icon.trim(),
        U = f.x + f.width - 20,
        G = f.y + 10;
  ...
  wr = g(function (e, t, a, r, i) {
    ...
    pt.has(d) &&
      (p.style("stroke", u[S % u.length]), p.style("fill", x[S % u.length]));
  ...
  Nr = g(function (e, t, a, r, i) {
    ...
    r ||
      ...
      Object.keys(t.links || {}).length &&
        !a.forceMenus &&
        f.attr("onclick", Ht(`actor${M}_popup`)).attr("cursor", "pointer"),
      f
        .append("line")
        .attr("id", "actor" + M)
        .attr("x1", s)
  ...
  l 0,-${b - 2 * A}
`;
    (N.append("path").attr("d", B),
      c === "neo" && N.attr("filter", "url(#drop-shadow)"));
  ...
  Dr = g(async function (e, t, a, r, i, n, s) {
    const l =
      s ?? new Map([...n.db.getActors().values()].map((E, d) => [E.name, d]));
    switch (t.type) {
      case "actor":
  ...
  Mr = g(function (e, t, a, r, i, n, s) {
    ...
    const f = wt(O, u),
      I =
        (
          s ??
          new Map([...n.db.getActors().values()].map((L, b) => [L.name, b]))
        ).get(p) ?? 0;
    pt.has(l) &&
      (f.style("stroke", c[I % c.length]),
      f.style("fill", d[I % c.length] ?? x));
  }, "drawActivation"),
      ...
      for (const [_, I] of Object.entries(t.sectionTitles))
        if (I.message) {
          ((p.text = I.message),
            ...
            (p.wrap = t.wrap),
            Z(p.text)
              ? ((t.starty = t.sections[_].y), await Kt(u, p, t))
              : mt(u, p));
          let L = Math.round(
            f
              .map((b) => (b._groups || b)[0][0].getBBox().height)
              .reduce((b, S) => b + S),
          );
  ...
  zr = g(function (e, t) {
    ...
    e.append("defs")
      ...
      .attr(
        "flood-color",
        `${a === "redux" || a === "redux-color" ? "#000000" : "#FFFFFF"}`,
      );
  }, "insertDropShadow"),
  Fe = g(function () {
    return {
  ...
  $r = g(async function (e, t, a) {
    (R.bumpVerticalPos(h.boxMargin),
      (t.height = h.boxMargin),
      (t.starty = R.getVerticalPos()));
    const r = dt();
    ((r.x = t.startx),
      (r.y = t.starty),
      (r.width = t.width || h.width),
      (r.class = "note"));
    const i = e.append("g");
    ...
    ((s.x = t.startx),
      ...
      (s.valign = "center"));
    const l = Z(s.text) ? await Kt(i, s) : mt(i, s),
      E = Math.round(
        l
...
async function He(e, t) {
  ...
  const { startx: a, stopx: r, message: i } = t,
    ...
    s = Z(i),
    l = s ? await Nt(i, $()) : J.calculateTextDimensions(i, Rt(h));
  if (!s) {
    const x = l.height / n;
...
var jr = g(async function (e, t, a, r, i, n) {
    const {
      ...
      O = J.calculateTextDimensions(d, Rt(h)),
      p = re();
    ((p.x = s),
      (p.y = E + 10),
      (p.width = l - s),
      ...
      (p.tspan = !1),
      Z(p.text)
        ? await Kt(e, p, { startx: s, stopx: l, starty: a })
        : mt(e, p));
    const f = O.width;
    let _;
    if (s === l) {
    ...
    if (
      ...
      (c === r.db.LINETYPE.BIDIRECTIONAL_SOLID ||
        c === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) &&
  ...
  qe = g(function (e, t, a, r) {
    ...
    for (const s of a) {
      ...
      (d.height > i && (i = d.height),
        d.width + l.x > n && (n = d.width + l.x));
    }
      ...
      e.fontFamily &&
        (h.actorFontFamily =
          ...
          h.messageFontFamily =
            e.fontFamily),
      e.fontSize &&
        (h.actorFontSize = h.noteFontSize = h.messageFontSize = e.fontSize),
      e.fontWeight &&
        (h.actorFontWeight =
          h.noteFontWeight =
          h.messageFontWeight =
...
function ht(e, t, a, r, i) {
  ...
  if (t.id && t.message && e[t.id]) {
    const s = e[t.id].width,
      l = Rt(h);
    ((t.message = J.wrapLabel(`[${t.message}]`, s - 2 * h.wrapPadding, l)),
      (t.width = s),
      (t.wrap = !0));
    const E = J.calculateTextDimensions(t.message, l),
...
var ea = g(async function (e, t, a, r) {
  ...
  i === "sandbox" && (l = Bt("#i" + t));
  const E =
      i === "sandbox" ? Bt(l.nodes()[0].contentDocument.body) : Bt("body"),
    d = i === "sandbox" ? l.nodes()[0].contentDocument : document;
  (R.init(), at.debug(r.db));
  const c = i === "sandbox" ? E.select(`[id="${t}"]`) : Bt(`[id="${t}"]`),
    x = r.db.getActors(),
  ...
  if (
    ...
    L &&
      (R.bumpVerticalPos(h.boxMargin),
      b && R.bumpVerticalPos(p[0].textMaxHeight)),
  ...
  function B(m, D) {
    ...
    (lt.starty + 18 > D && ((lt.starty = D - 6), (D += 12)),
      F.drawActivation(c, lt, D, h, qt(m.from).length, r, A),
  ...
  for (const m of _) {
    ...
    switch (m.type) {
      ...
      case r.db.LINETYPE.LOOP_START:
        ht(N, m, h.boxMargin, h.boxMargin + h.boxTextMargin, (W) =>
          R.newLoop(W),
        );
        break;
      ...
      case r.db.LINETYPE.ALT_ELSE:
        ht(N, m, h.boxMargin + h.boxTextMargin, h.boxMargin, (W) =>
          R.addSectionToLoop(W),
        );
        break;
  ...
  (at.debug("createdActors", u),
    at.debug("destroyedActors", O),
    await ee(c, x, f, !1, t, r, A));
  ...
  for (const m of R.models.boxes) {
    ((m.height = R.getVerticalPos() - m.y),
      R.insert(m.x, m.y, m.x + m.width, m.height));
  ...
  for (const i of t)
    if (e.get(i.to) && e.get(i.from)) {
      ...
      const s = i.placement !== void 0,
        ...
        E = s ? Lt(h) : Rt(h),
        d = i.wrap
          ? J.wrapLabel(i.message, h.width - 2 * h.wrapPadding, E)
          : i.message,
        x =
          (Z(d) ? await Nt(i.message, $()) : J.calculateTextDimensions(d, E))
            .width +
          2 * h.wrapPadding;
            ...
            : i.placement === a.db.PLACEMENT.RIGHTOF
              ...
              : i.placement === a.db.PLACEMENT.LEFTOF
                ...
                : i.placement === a.db.PLACEMENT.OVER &&
                  (n.prevActor &&
                    (r[n.prevActor] = P.getMax(r[n.prevActor] || 0, x / 2)),
...
var ra = g(function (e) {
  ...
  for (const r in e.links) {
    const n =
      J.calculateTextDimensions(r, a).width +
      2 * h.wrapPadding +
      2 * h.boxMargin;
    t < n && (t = n);
  }
...
async function Xe(e, t, a) {
  ...
  for (const n of e.keys()) {
    const s = e.get(n);
    s.wrap &&
      (s.description = J.wrapLabel(
        s.description,
        h.width - 2 * h.wrapPadding,
        te(h),
      ));
    const l = Z(s.description)
      ? await Nt(s.description, $())
      : J.calculateTextDimensions(s.description, te(h));
    ((s.width = s.wrap
      ? h.width
      : P.getMax(h.width, l.width + 2 * h.wrapPadding)),
  ...
  return (
    a.forEach((n) => {
      const s = Rt(h);
      let l = n.actorKeys.reduce(
        (x, u) => (x += e.get(u).width + (e.get(u).margin || 0)),
        0,
      );
      const E = h.boxMargin * 8;
      ((l += E),
        (l -= 2 * h.boxTextMargin),
        n.wrap && (n.name = J.wrapLabel(n.name, l - 2 * h.wrapPadding, s)));
    ...
    return (
      e.placement === a.db.PLACEMENT.RIGHTOF
        ...
        : e.placement === a.db.PLACEMENT.LEFTOF
          ...
          : e.to === e.from
            ? ((E = J.calculateTextDimensions(
                l
                  ? J.wrapLabel(e.message, P.getMax(h.width, r.width), Lt(h))
                  : e.message,
                Lt(h),
              )),
              (d.width = l
            ...
            : ((d.width =
                Math.abs(n + r.width / 2 - (s + i.width / 2)) + h.actorMargin),
              (d.startx =
                n < s
                  ? n + r.width / 2 - h.actorMargin / 2
                  : s + i.width / 2 - h.actorMargin / 2)),
      l &&
        (d.message = J.wrapLabel(
          e.message,
        ...
        ? ((l = await aa(d, t, r)),
          ...
          n.forEach((x) => {
            ((s = x),
              ...
              (s.width =
                P.getMax(s.width, Math.abs(s.from - s.to)) - h.labelBoxWidth));
          }))
        : ((E = oa(d, t, r)),
          (d.msgModel = E),
          E.startx &&
            ...
            n.forEach((x) => {
              if (((s = x), E.startx === E.stopx)) {
                ...
                ((s.from = P.getMin(
                  ...
                  (s.width =
                    P.getMax(s.width, Math.abs(s.to - s.from)) -
                    h.labelBoxWidth));
              } else
  ...
  Ia = {
    ...
    init: g((e) => {
      (e.sequence || (e.sequence = {}),
        e.wrap &&
          ((e.sequence.wrap = e.wrap), er({ sequence: { wrap: e.wrap } })));
    }, "init"),
  };
