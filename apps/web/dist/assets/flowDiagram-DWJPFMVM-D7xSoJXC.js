import { g as qe } from "./chunk-FMBD7UC4-BsoGomFe.js";
import {
  h as b,
  v as Me,
  l as J,
...
import { c as ht } from "./chunk-YZCP3GAM-EhPY_T3S.js";
import { g as dt } from "./chunk-55IACEB6-D1lW6dHe.js";
import { s as pt } from "./chunk-EDXVE4YY-B7A2tvs3.js";
import { c as ft } from "./channel-CxI1U7Si.js";
...
` +
        ...
        if (
          ...
          (u?.label &&
            ((g.text = u?.label),
            (g.labelType = this.sanitizeNodeLabelType(u?.labelType))),
            u?.icon &&
              ((g.icon = u?.icon),
              !u.label?.trim() && g.text === i && (g.text = "")),
...
You have to call mermaid.initialize.`);
        ...
        for (const c of i)
          for (const p of a) {
            const l = c === i[i.length - 1],
              A = p === a[0];
            l && A
              ? this.addSingleLink(c, p, r, n)
              : this.addSingleLink(c, p, r, void 0);
          }
      }
      ...
      setTooltip(i, a) {
        if (a !== void 0) {
          ...
          for (const r of i.split(","))
            this.tooltips.set(
              this.version === "gen-1" ? this.lookUpDomId(r) : r,
              a,
            );
        }
      }
      ...
      setLink(i, a, r) {
        (i.split(",").forEach((n) => {
          ...
          c !== void 0 &&
            ((c.link = re.formatUrl(a, this.config)), (c.linkTarget = r));
        }),
      ...
      addSubGraph(i, a, r) {
        ...
        if (
          ((u =
            u ??
            (k.inheritDir
              ? (this.getDirection() ?? g1().direction ?? void 0)
              : void 0)),
          this.version === "gen-1")
        )
      ...
      destructEndLink(i) {
        ...
        switch (a.slice(-1)) {
          case "x":
            ((n = "arrow_cross"),
              a.startsWith("x") && ((n = "double_" + n), (r = r.slice(1))));
            break;
          case ">":
            ((n = "arrow_point"),
              a.startsWith("<") && ((n = "double_" + n), (r = r.slice(1))));
            break;
          case "o":
            ((n = "arrow_circle"),
              a.startsWith("o") && ((n = "double_" + n), (r = r.slice(1))));
            break;
        }
        let c = "normal",
          p = r.length - 1;
        (r.startsWith("=") && (c = "thick"),
          r.startsWith("~") && (c = "invisible"));
        const l = this.countChar(".", r);
        return (
          l && ((c = "dotted"), (p = l)),
          { type: n, stroke: c, length: p }
        );
      }
      destructLink(i, a) {
      ...
      getData() {
        ...
        return (
          A.forEach((u, k) => {
            const { arrowTypeStart: F, arrowTypeEnd: g } =
      ...
      J1 = {
        ...
        performAction: b(function (h, d, f, o, x, e, G1) {
          ...
          switch (x) {
            ...
            case 63:
              ((this.$ = e[t - 3]),
                o.addVertex(e[t - 3], e[t - 1], "cylinder"));
              break;
            case 64:
            ...
            case 68:
              ((this.$ = e[t - 3]),
                o.addVertex(e[t - 3], e[t - 1], "trapezoid"));
              break;
            case 69:
              ((this.$ = e[t - 3]),
            ...
            case 71:
              ((this.$ = e[t - 3]),
                o.addVertex(e[t - 3], e[t - 1], "lean_left"));
              break;
            case 72:
            ...
            case 121:
              ((this.$ = e[t - 4]),
                o.addVertex(e[t - 2], void 0, void 0, e[t]));
              break;
            case 122:
        ...
        parse: b(function (h) {
          ...
          b(Pe, "lex");
          for (var Y, k1, Q, ee, w1 = {}, q1, c1, Oe, X1; ; ) {
            if (
              ((k1 = f[f.length - 1]),
              this.defaultActions[k1]
                ? (Q = this.defaultActions[k1])
                : ((Y === null || typeof Y > "u") && (Y = Pe()),
                  (Q = G1[k1] && G1[k1][Y])),
              ...
              case 2:
                if (
                  ...
                  (ee = this.performAction.apply(
                    w1,
                    [t, Ne, L, A1.yy, Q[1], x, e].concat(je),
                  )),
                  typeof ee < "u")
                )
                  return ee;
        ...
        var f1 = {
          ...
          unput: b(function (h) {
            ...
            return (
              ...
              this.options.ranges &&
                (this.yylloc.range = [x[0], x[0] + this.yyleng - d]),
...
` +
          ...
          next: b(function () {
            ...
            for (var x = this._currentRules(), e = 0; e < x.length; e++)
              if (
                ((f = this._input.match(this.rules[x[e]])),
...
` +
    ...
    return (b(H1, "Parser"), (H1.prototype = J1), (J1.Parser = H1), new H1());
  })();
ae.parser = ae;
var Ue = ae,
  ze = Object.assign({}, Ue);
