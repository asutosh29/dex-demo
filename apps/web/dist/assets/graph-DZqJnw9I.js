...
class J {
  ...
  isLeaf(e) {
    var r;
    return (
      this.isDirected() ? (r = this.successors(e)) : (r = this.neighbors(e)),
      r.length === 0
    );
  }
  filterNodes(e) {
...
export { J as G, O as b, _ as i, A as v };
