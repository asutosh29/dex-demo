...
import { i as b, G as B } from "./graph-YGIG_HlS.js";
import { l as I } from "./layout-BQ-TL8AS.js";
import { c as L } from "./clone-CG3qR4d2.js";
import { m as A } from "./min-zg1WETvq.js";
...
Parent cluster`,
        ...
        if (
          ...
          const N = await F(p, s.graph, n, a, t.node(f), o),
            x = N.elem;
          (q(s, x),
            (s.diff = N.diff || 0),
            i.info(
          ...
          t.children(f).length > 0
            ...
            : (i.trace("Node - the non recursive path XAX", f, p, t.node(f), l),
              await U(p, t.node(f), { config: o, dir: l }));
      }),
    ),
      await w(async () => {
  ...
  Xe = w(async (e, t) => {
    const n = new B({ multigraph: !0, compound: !0 })
      ...
      a = t.select("g");
    (j(a, e.markers, e.type, e.diagramId),
      H(),
      Y(),
      _(),
      te(),
    ...
    const r = V();
    await F(a, n, e.type, e.diagramId, void 0, r);
  }, "render");
export { Xe as render };
