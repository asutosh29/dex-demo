...
import { p as _ } from "./chunk-4BX2VUAB-tgHv9M0E.js";
...
var L = F.packet,
  ...
  O = m((e, t) => {
    ...
    for (let { start: a, end: s, bits: d, label: c } of e.blocks) {
      if (a !== void 0 && s !== void 0 && s < a)
        throw new Error(
          `Packet block ${a} - ${s} is invalid. End must be greater than start.`,
        );
      if (((a ??= r + 1), a !== r + 1))
        throw new Error(
      ...
      for (
        ...
        const [p, i] = Y({ start: a, end: s, bits: d, label: c }, n, l);
        if (
          (o.push(p), p.end + 1 === n * l && (t.pushWord(o), (o = []), n++), !i)
        )
          break;
  ...
  H = m((e, t, r, o) => {
    ...
    for (const [y, B] of p.entries()) I(f, B, y, l);
    f.append("text")
      .text(i)
      .attr("x", k / 2)
      .attr("y", g - h / 2)
