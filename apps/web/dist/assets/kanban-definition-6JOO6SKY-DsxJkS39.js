...
import { g as Ne } from "./chunk-FMBD7UC4-BsoGomFe.js";
...
var $ = (function () {
  var e = o(function (O, i, n, r) {
    ...
    T = {
      ...
      performAction: o(function (i, n, r, a, u, t, U) {
        var c = t.length - 1;
        switch (u) {
          case 6:
          case 7:
      ...
      parse: o(function (i) {
        ...
        o(ae, "lex");
        for (var _, P, x, Q, j = {}, z, C, oe, X; ; ) {
          if (
            ((P = r[r.length - 1]),
            this.defaultActions[P]
              ? (x = this.defaultActions[P])
              : ((_ === null || typeof _ > "u") && (_ = ae()),
                (x = U[P] && U[P][_])),
...
` +
        ...
        next: o(function () {
          ...
          for (var u = this._currentRules(), t = 0; t < u.length; t++)
            if (
              ((r = this._input.match(this.rules[u[t]])),
...
` +
  ...
  we = o((e) => {
    ...
    const h = H(),
      p = v[v.length - 1];
    (e.icon && (p.icon = F(e.icon, h)),
      e.class && (p.cssClasses = F(e.class, h)));
  }, "decorateNode"),
  Ae = o((e) => {
    switch (e) {
      case y.DEFAULT:
...
` + e,
    ...
    b.htmlLabels = !1;
    const l = fe(h);
    for (const f of k.nodes) f.domId = `${h}-${f.id}`;
    const D = l.append("g");
    D.attr("class", "sections");
    const I = l.append("g");
    I.attr("class", "items");
    const g = k.nodes.filter((f) => f.isGroup);
    let w = 0;
    const E = 10,
      G = [];
    let N = 25;
    ...
    for (const f of g) {
      ...
      const L = b?.kanban?.sectionWidth || 200,
        M = (-L * 3) / 2 + N;
      let T = M;
      const Y = k.nodes.filter((i) => i.parentId === f.id);
      for (const i of Y) {
        if (i.isGroup)
          throw new Error(
...
`,
  ...
  Me = Ge,
  qe = { db: Ve, renderer: je, parser: xe, styles: Me };
