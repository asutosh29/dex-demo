import {
  ...
  aT as sr,
  aU as hr,
} from "./mermaid-GHXKKRXX-DbhF4r8w.js";
import { p as lr } from "./chunk-4BX2VUAB-DkAy1XF6.js";
import { p as fr } from "./wardley-RL74JXVD-MgP0OKME.js";
import { c as Fe } from "./cytoscape.esm-DkOyvmE4.js";
import { g as cr } from "./react-vendor-BNYpS37_.js";
      ...
      (function (I, O) {
        (function (b, L) {
          ...
          return (function (A) {
            var b = {};
            function L(u) {
              if (b[u]) return b[u].exports;
              var h = (b[u] = { i: u, l: !1, exports: {} });
              return (
                A[u].call(h.exports, h, h.exports, L),
                (h.l = !0),
                h.exports
              );
            }
            ...
            function (A, b, L) {
              ...
              ((e.prototype.getSource = function () {
                ...
                (e.prototype.getOtherEndInGraph = function (f, r) {
                  for (
                    var d = this.getOtherEnd(f),
                      t = r.getGraphManager().getRoot();
                    ;
                  ) {
              ...
              function s(c, l, T) {
                (u.call(this, T),
                  ...
                  l != null && l instanceof e
                    ...
                    : l != null &&
                      l instanceof Layout &&
                      (this.graphManager = l.graphManager));
              }
              ...
              ((s.prototype.getNodes = function () {
                ...
                (s.prototype.remove = function (c) {
                  ...
                  if (c instanceof i) {
                    ...
                    for (
                      var T = l.edges.slice(), g, v = T.length, N = 0;
                      N < v;
                      N++
                    )
                      ((g = T[N]),
                    ...
                    var C = g.source.edges.indexOf(g),
                      U = g.target.edges.indexOf(g);
                    if (!(C > -1 && U > -1))
                      throw "Source and/or target doesn't know this edge!";
                    (g.source.edges.splice(C, 1),
                      g.target != g.source && g.target.edges.splice(U, 1));
                ...
                (s.prototype.calcEstimatedSize = function () {
                  for (
                    var c = 0, l = this.nodes, T = l.length, g = 0;
                    g < T;
                    g++
                  ) {
                    var v = l[g];
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.remove = function (e) {
                  if (e instanceof u) {
                    ...
                    if (
                      ...
                      !(
                        r.source.owner != null &&
                        r.source.owner.getGraphManager() != null
                      ))
                    )
                ...
                (a.prototype.getAllNodes = function () {
                  if (this.allNodes == null) {
                    for (
                      var e = [], i = this.getGraphs(), f = i.length, r = 0;
                      r < f;
                      r++
                    )
                  ...
                  for (
                    ...
                    for (r = i.getOwner(); e.lca == null; ) {
                      for (
                        ...
                        ((e.targetInLca = d.getParent()),
                          (d = e.targetInLca.getOwner()));
                      }
              ...
              ((s.RANDOM_SEED = 1),
                ...
                (s.prototype.update2 = function () {
                  if (
                    ...
                    for (
                      ...
                      o[c];
                    for (
                      var l = this.graphManager.getRoot().getNodes(), c = 0;
                      c < l.length;
                      c++
                    )
                      l[c];
                ...
                (s.prototype.getFlatForest = function () {
                  for (
                    var o = [],
                      c = !0,
                      l = this.graphManager.getRoot().getNodes(),
                      T = !0,
                      g = 0;
                    g < l.length;
                    g++
                ...
                (s.prototype.createDummyNodesForBendpoints = function (o) {
                  ...
                  var N = this.newEdge(null);
                  return (
                    this.graphManager.add(N, l, o.target),
                ...
                (s.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  for (var c = 0; c < o.length; c++) {
                    ...
                    if (l.bendpoints.length > 0) {
                      for (
                        var T = this.edgeToDummyNodes.get(l), g = 0;
                        g < T.length;
                        g++
                      ) {
                        var v = T[g],
                          N = new r(v.getCenterX(), v.getCenterY()),
                          P = l.bendpoints.get(g);
              ...
              ((r.prototype.initParameters = function () {
                ...
                (r.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      ...
                      ((l = g[o]),
                        this.calculateRepulsionForceOfANode(l, v, t, s),
                        v.add(l));
                  else
                    for (o = 0; o < g.length; o++)
                      for (l = g[o], c = o + 1; c < g.length; c++)
                        ((T = g[c]),
                          l.getOwner() == T.getOwner() &&
                            this.calcRepulsionForce(l, T));
                }),
                ...
                (r.prototype.calcRepulsionForce = function (t, s) {
                  ...
                  if (o.intersects(c)) {
                    ...
                    var X =
                      ...
                      (t.noOfChildren + s.noOfChildren);
                    ((t.repulsionForceX -= X * U),
                      (t.repulsionForceY -= X * k),
                      (s.repulsionForceX += X * U),
                      (s.repulsionForceY += X * k));
                  } else
                    (this.uniformLeafNodeSizes &&
                    t.getChild() == null &&
                    s.getChild() == null
                      ? ((g = c.getCenterX() - o.getCenterX()),
                        (v = c.getCenterY() - o.getCenterY()))
                      : (i.getIntersection(o, c, T),
                        (g = T[2] - T[0]),
                        (v = T[3] - T[1])),
                      Math.abs(g) < a.MIN_REPULSION_DIST &&
                        (g = f.sign(g) * a.MIN_REPULSION_DIST),
                ...
                (r.prototype.calcGrid = function (t) {
                  ...
                  for (var c = new Array(s), l = 0; l < s; l++)
                    c[l] = new Array(o);
                  for (var l = 0; l < s; l++)
                    for (var T = 0; T < o; T++) c[l][T] = new Array();
                  return c;
                }),
                (r.prototype.addNodeToGrid = function (t, s, o) {
                  ...
                  for (var v = c; v <= l; v++)
                    for (var N = T; N <= g; N++)
                      (this.grid[v][N].push(t),
                        t.setGridCoordinates(c, l, T, g));
                }),
                ...
                (r.prototype.calculateRepulsionForceOfANode = function (
                  t,
                  s,
                  o,
                  c,
                  ...
                  if (
                    ...
                    for (
                      var T, g = this.grid, v = t.startX - 1;
                      v < t.finishX + 2;
                      v++
                    )
                      for (var N = t.startY - 1; N < t.finishY + 2; N++)
                        if (
                          !(v < 0 || N < 0 || v >= g.length || N >= g[0].length)
                        ) {
            ...
            function (A, b, L) {
              ...
              ((h.prototype.add = function (a) {
                ...
                (h.prototype.addAllTo = function (a) {
                  for (
                    var e = Object.keys(this.set), i = e.length, f = 0;
                    f < i;
                    f++
                  )
                    a.push(this.set[e[f]]);
                    ...
                    u(i, [
                      {
                        ...
                        value: function (r, d, t) {
                          if (d < t) {
                            ...
                            (this._quicksort(r, d, s),
                              this._quicksort(r, s + 1, t));
                          }
                        },
                      },
                      {
            ...
            function (A, b, L) {
              ...
              ((u.svd = function (h) {
                ...
                for (
                  var $ = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966);
                  n > 0;
                ) {
                  var Q = void 0,
                    It = void 0;
                    ...
                    case 3:
                      {
                        ...
                        (function (Tt, Ct) {
                          ...
                          (ct = at / (Z + ct)));
                        for (
                          var nt = (B + Vt) * (B - Vt) + ct, tt = B * K, j = Q;
                          j < n - 1;
                          j++
                        ) {
                          ...
                          for (var xt = 0; xt < this.n; xt++)
                            ((ut = wt * this.V[xt][j] + pt * this.V[xt][j + 1]),
                              (this.V[xt][j + 1] =
                                -pt * this.V[xt][j] + wt * this.V[xt][j + 1]),
                              (this.V[xt][j] = ut));
                          if (
                            ((ut = u.hypot(nt, tt)),
                            (wt = nt / ut),
                            ...
                            for (var lt = 0; lt < this.m; lt++)
                              ((ut =
                                wt * this.U[lt][j] + pt * this.U[lt][j + 1]),
                                (this.U[lt][j + 1] =
                                  -pt * this.U[lt][j] + wt * this.U[lt][j + 1]),
                                (this.U[lt][j] = ut));
                        }
                        e[n - 2] = nt;
                      }
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (var r = 1; r < this.iMax; r++)
                          ((this.grid[r][0] =
                            this.grid[r - 1][0] + this.gap_penalty),
            ...
            var b = {
                ...
                765: (a, e, i) => {
                  ...
                  ((D.prototype.newGraphManager = function () {
                    ...
                    (D.prototype.tick = function () {
                      ...
                      if (
                        this.totalIterations % l.CONVERGENCE_CHECK_PERIOD ==
                          0 &&
                        !this.isTreeGrowing &&
                        !this.isGrowthFinished
                      ) {
                      ...
                      if (this.constraints.relativePlacementConstraint) {
                        ...
                        if (
                          ...
                          this.fixedNodeSet.forEach(function (M) {
                            (n.fixedNodesOnHorizontal.add(M),
                              n.fixedNodesOnVertical.add(M));
                          }),
                    ...
                    (D.branchRadialLayout = function (n, m, p, E, y, R) {
                      ...
                      m != null && Y--;
                      for (
                        var et = 0, z = V.length, M, H = n.getEdgesBetween(m);
                        H.length > 1;
                      ) {
                        var $ = H[0];
                        H.splice(0, 1);
                ...
                991: (a, e, i) => {
                  ...
                  ((d.prototype.calculateDisplacement = function () {
                    ...
                    (d.prototype.propogateDisplacementToChildren = function (
                      s,
                      o,
                    ) {
                      for (
                        var c = this.getChild().getNodes(), l, T = 0;
                        T < c.length;
                        T++
                      )
                        ((l = c[T]),
                ...
                902: (a, e, i) => {
                  ...
                  ((o.handleConstraints = function (c) {
                    ...
                    l.relativePlacementConstraint &&
                      l.relativePlacementConstraint.forEach(function (F) {
                        !F.gap &&
                          F.gap != 0 &&
                          (F.left
                            ? (F.gap =
                    ...
                    var X = function (G, B) {
                            ...
                            ? (ut.push(ot),
                              K ||
                                (B == "horizontal"
                                  ? tt.set(
                                      ot,
                                      g.has(ot) ? v[g.get(ot)] : Z.get(ot),
                                    )
                                  : tt.set(
                                      ot,
                                      g.has(ot) ? N[g.get(ot)] : Z.get(ot),
                                    )))
                              ...
                              if (
                                ...
                                (ot.forEach(function (st) {
                                  B == "horizontal"
                                    ? (tt.set(
                                        st,
                                        g.has(st) ? v[g.get(st)] : Z.get(st),
                                      ),
                                      (Lt += tt.get(st)))
                                    : (tt.set(
                                        st,
                                        g.has(st) ? N[g.get(st)] : Z.get(st),
                                      ),
                                      (Lt += tt.get(st)));
                                }),
                                  (Lt = Lt / ot.length),
                      ...
                      n = function (G) {
                        var B = [],
                          ...
                          at = 0;
                        return (
                          G.forEach(function (ct, nt) {
                            if (!Z.has(nt)) {
                              B[at] = [];
                              var tt = nt;
                              for (
                                K.push(tt), Z.add(tt), B[at].push(tt);
                                K.length != 0;
                              ) {
                                tt = K.shift();
                                var j = G.get(tt);
                    ...
                    if (
                      ...
                      if (
                        l.fixedNodeConstraint &&
                        l.fixedNodeConstraint.length > 1
                      )
                        (l.fixedNodeConstraint.forEach(function (F, G) {
                          ((E[G] = [F.position.x, F.position.y]),
                            (y[G] = [v[g.get(F.nodeId)], N[g.get(F.nodeId)]]));
                        }),
                          (R = !0));
                        ...
                        (function () {
                          ...
                          if (l.alignmentConstraint.vertical) {
                            for (
                              var G = l.alignmentConstraint.vertical,
                                B = function (tt) {
                                  var j = new Set();
                                  ...
                                  var ut = new Set(
                                    ...
                                    wt = void 0;
                                  (ut.size > 0
                                    ? (wt = v[g.get(ut.values().next().value)])
                                    : (wt = J(j).x),
                                    G[tt].forEach(function (pt) {
                                      ((E[F] = [wt, N[g.get(pt)]]),
                                        (y[F] = [v[g.get(pt)], N[g.get(pt)]]),
                                        F++);
                                    }));
                                },
                                K = 0;
                        ...
                        if (V < x.size / 2)
                          (rt(l.relativePlacementConstraint),
                            (R = !1),
                            (w = !1));
                        else {
                          var z = new Map(),
                          ...
                          (q[Y].forEach(function (F) {
                            W.get(F).forEach(function (G) {
                              G.direction == "horizontal"
                                ? (z.has(F) ? z.get(F).push(G) : z.set(F, [G]),
                                  z.has(G.id) || z.set(G.id, []),
                                  H.push({ left: F, right: G.id }))
                                : (M.has(F) ? M.get(F).push(G) : M.set(F, [G]),
                                  M.has(G.id) || M.set(G.id, []),
                                  H.push({ top: F, bottom: G.id }));
                            });
                          }),
                            rt(H),
                            (w = !1));
                    ...
                    if (r.ENFORCE_CONSTRAINTS) {
                      if (
                        l.fixedNodeConstraint &&
                        l.fixedNodeConstraint.length > 0
                      ) {
                        var Et = { x: 0, y: 0 };
                        (l.fixedNodeConstraint.forEach(function (F, G) {
                          var B = {
                          ...
                          l.fixedNodeConstraint.forEach(function (F) {
                            ((v[g.get(F.nodeId)] = F.position.x),
                              (N[g.get(F.nodeId)] = F.position.y));
                          }));
                      }
                      ...
                      l.relativePlacementConstraint &&
                        (function () {
                          ...
                          var _t = D(lt, "horizontal", ct, Z, Qt),
                    ...
                    for (var Yt = 0; Yt < P.length; Yt++) {
                      var Vt = P[Yt];
                      Vt.getChild() == null &&
                        Vt.setCenter(v[g.get(Vt.id)], N[g.get(Vt.id)]);
                    }
                  }),
                    (a.exports = o));
                },
                      ...
                      var l = new r(),
                        ...
                        J = function () {
                          ...
                          if (
                            ...
                            g.length == o.length && (C = !0),
                            !C || (C && U > 1))
                          ) {
                            ((N = g[0]),
                              (P = N.connectedEdges().length),
                              g.forEach(function (y) {
                                y.connectedEdges().length < P &&
                                  ((P = y.connectedEdges().length), (N = y));
                              }),
                              k.push(N.id()));
                            var E = t.collection();
                            (E.merge(g[0]),
                    ...
                    (d.relocateComponent = function (t, s, o) {
                      if (!o.fixedNodeConstraint) {
                        ...
                        if (o.quality == "draft") {
                          ...
                          try {
                            for (
                              var C = s.nodeIndexes[Symbol.iterator](), U;
                              !(v = (U = C.next()).done);
                              v = !0
                            ) {
                              var k = U.value,
                  ...
                  var f = i(548),
                    ...
                    T = function (v, N) {
                      var P = v.cy,
                        ...
                        rt = {};
                      v.randomize &&
                        ((X = N.nodeIndexes), (J = N.xCoords), (D = N.yCoords));
                      var n = function (x) {
                      ...
                      (v.nestingFactor != null &&
                        ...
                        v.gravity != null &&
                          (l.DEFAULT_GRAVITY_STRENGTH =
                            c.DEFAULT_GRAVITY_STRENGTH =
                              v.gravity),
                        v.numIter != null &&
                          (l.MAX_ITERATIONS = c.MAX_ITERATIONS = v.numIter),
                        v.gravityRange != null &&
                          (l.DEFAULT_GRAVITY_RANGE_FACTOR =
                        ...
                        v.tilingCompareBy != null &&
                          (l.TILING_COMPARE_BY = v.tilingCompareBy),
                        v.quality == "proof"
                          ? (o.QUALITY = 2)
                          : (o.QUALITY = 0),
                      ...
                      var w = new r(),
                        S = w.newGraphManager();
                      return (
                        E(S.addRoot(), f.getTopMostNodes(U), w, v),
                        y(w, S, k),
                        R(w, v),
                        w.runLayout(),
                        rt
                        ...
                        f(v, [
                          {
                            ...
                            value: function () {
                              ...
                              if (
                                (U.layoutUtilities &&
                                  C.packComponents &&
                                  ((m = U.layoutUtilities("get")),
                                  m || (m = U.layoutUtilities()),
                                  (p = !0)),
                                k.nodes().length > 0)
                              )
                                if (p) {
                                  ...
                                  if (
                                    ((D = t.connectComponents(U, C.eles, R)),
                                    ...
                                    D.forEach(function (vt, it) {
                                      ((C.eles = vt),
                                        J.push(l(C, X[it])),
                                        t.relocateComponent(rt[it], J[it], C));
                                    });
                                  } else
                                    D.forEach(function (vt, it) {
                                        ...
                                        (vt
                                          ...
                                          .forEach(function (Ot) {
                                            if (C.quality == "draft")
                                              ...
                                              J[it][Ot.id()] &&
                                                mt.nodes.push({
                                                  x: J[it][Ot.id()].getLeft(),
                                                  y: J[it][Ot.id()].getTop(),
                                                  width:
                                                    J[it][Ot.id()].getWidth(),
                                                  height:
                                                    J[it][Ot.id()].getHeight(),
                                                });
                                          }),
                                  ...
                                  C.quality == "default" || C.quality == "proof"
                                    ? (J.push(l(C, X[0])),
                                      t.relocateComponent(rt[0], J[0], C))
                              ...
                              if (
                                ...
                                var It = t.calcParentsWithoutChildren(U, k),
                ...
                657: (a, e, i) => {
                  var f = i(548),
                    ...
                    t = function (o) {
                      var c = o.cy,
                        ...
                        q = function (G) {
                          ...
                          if (G) {
                            ...
                            for (var Z = 0; Z < m; Z++) J[Z] = p;
                            for (var at = 0; at < S; at++)
                              ((X[at] = B), (B = x(B, at, G)));
                          } else {
                            W();
                            for (var K = 0; K < S; K++) x(X[K], K, G);
                          }
                        ...
                        Y = function () {
                          ...
                          for (var tt = E, j = E, ut = void 0; ; ) {
                            ...
                            if (
                              ((K = r.multGamma(
                                r.multL(r.multGamma(at), D, n),
                              )),
                              (G = r.dotProduct(at, K)),
                              (K = r.normalize(K)),
                              (tt = r.dotProduct(at, K)),
                              (ut = Math.abs(tt / j)),
                              ut <= 1 + y && ut >= 1)
                            )
                              break;
                          ...
                          for (j = E; ; ) {
                            ...
                            if (
                              ((ct = r.minusOp(
                                ct,
                                r.multCons(at, r.dotProduct(at, ct)),
                              )),
                              (Z = r.multGamma(r.multL(r.multGamma(ct), D, n))),
                              (B = r.dotProduct(ct, Z)),
                              (Z = r.normalize(Z)),
                              (tt = r.dotProduct(ct, Z)),
                              (ut = Math.abs(tt / j)),
                              ut <= 1 + y && ut >= 1)
                            )
                              break;
                          ...
                          ((U = r.multCons(at, Math.sqrt(Math.abs(G)))),
                            (k = r.multCons(ct, Math.sqrt(Math.abs(B)))));
                        };
                      (f.connectComponents(c, l, f.getTopMostNodes(T), v),
                        g.forEach(function (F) {
                          f.connectComponents(
                            c,
                            l,
                            f.getTopMostNodes(F.descendants().intersection(l)),
                            v,
                          );
                        }));
                      ...
                      (g.forEach(function (F) {
                        for (
                          var G = F.children().intersection(l);
                          G.nodes(":childless").length == 0;
                        )
                          G = G.nodes()[0].children().intersection(l);
                        var B = 0,
                          K = G.nodes(":childless")[0].connectedEdges().length;
                        (G.nodes(":childless").forEach(function (Z, at) {
                          Z.connectedEdges().length < K &&
                            ((K = Z.connectedEdges().length), (B = at));
                        }),
                        ...
                        T.forEach(function (F) {
                          ...
                          (F.isParent()
                            ...
                            F.neighborhood()
                              .nodes()
                              .forEach(function (B) {
                                l.intersection(F.edgesWith(B)).length > 0 &&
                                  (B.isParent()
                                    ? C[G].push(P.get(B.id()))
                                    : C[G].push(B.id()));
                              }));
                      ...
                      if (m > 2) {
                        ...
                        return (
                          o.quality == "draft" || o.step == "all"
                            ? (q(R),
                              V(),
                              Y(),
                              (Et = { nodeIndexes: N, xCoords: U, yCoords: k }))
                            : (N.forEach(function (F, G) {
                                (U.push(c.getElementById(G).position("x")),
                                  k.push(c.getElementById(G).position("y")));
                              }),
                              (Et = {
                                nodeIndexes: N,
                                xCoords: U,
                        ...
                        if ((U.push(Pt.x), k.push(Pt.y), m == 2)) {
                          var Yt = c.getElementById(Ht.next().value),
                            Vt = Yt.outerWidth();
                          (U.push(Pt.x + Ft / 2 + Vt / 2 + o.idealEdgeLength),
                            k.push(Pt.y));
                        }
                        return (
                          (Et = { nodeIndexes: N, xCoords: U, yCoords: k }),
...
var xe = { L: "left", R: "right", T: "top", B: "bottom" },
  ...
  Pe =
    ((ae = class {
      ...
      addService({ id: O, icon: A, in: b, title: L, iconText: u }) {
        ...
        if (b !== void 0) {
          if (O === b)
            throw new Error(
              `The service [${O}] cannot be placed within itself`,
            );
      ...
      addJunction({ id: O, in: A }) {
        ...
        if (A !== void 0) {
          if (O === A)
            throw new Error(
              `The junction [${O}] cannot be placed within itself`,
            );
      ...
      addGroup({ id: O, icon: A, in: b, title: L }) {
        ...
        ((this.registeredIds[O] = "group"),
          (this.groups[O] = { id: O, icon: A, title: L, in: b }));
      }
      getGroups() {
...
`,
  ...
  Sr = dt(async function (I, O, A, b) {
    const L = A.getConfigField("padding"),
      u = A.getConfigField("iconSize"),
      h = u / 2,
      a = u / 6,
      e = a / 2;
    await Promise.all(
      O.edges().map(async (i) => {
        ...
        if (
          ...
          !t &&
            ...
            (Wt(r) ? (g += r === "L" ? h : -h) : (v += r === "T" ? h : -h)),
          !l &&
            A.getNode(s)?.type === "junction" &&
            (Wt(o) ? (C += o === "L" ? h : -h) : (U += o === "T" ? h : -h)),
          i[0]._private.rscratch)
        ) {
          const X = I.insert("g");
          if (
            (X.insert("path")
              .attr("d", `M ${g},${v} L ${N},${P} L${C},${U} `)
              .attr("class", "edge")
              .attr("id", `${b}-${or(f, s, { prefix: "L" })}`),
            d)
          ) {
            const J = Wt(r) ? se[r](g, a) : g - e,
              D = qt(r) ? se[r](v, a) : v - e;
            X.insert("polygon")
              .attr("points", Ie[r](a))
              .attr("transform", `translate(${J},${D})`)
              .attr("class", "arrow");
          }
          if (c) {
            const J = Wt(o) ? se[o](C, a) : C - e,
              D = qt(o) ? se[o](U, a) : U - e;
            X.insert("polygon")
              .attr("points", Ie[o](a))
              .attr("transform", `translate(${J},${D})`)
  ...
  Fr = dt(async function (I, O, A, b) {
    const u = A.getConfigField("padding") * 0.75,
  ...
  Pr = dt(function (I, O, A, b) {
    A.forEach((L) => {
      ...
      (u
        ...
        .attr("width", h)
        .attr("height", h),
        u.attr("class", "architecture-junction"));
...
function Xe(I, O) {
  O.nodes().map((A) => {
    ...
    ((b.x = A.position().x),
      (b.y = A.position().y),
      I.getElementById(b.id).attr(
        "transform",
        "translate(" + (b.x || 0) + "," + (b.y || 0) + ")",
      ));
  });
}
dt(Xe, "positionNodes");
  ...
  const b = dt(
    ...
    L = O.map((a) => {
      ...
      return (
        ...
        {
          horiz: Object.values(b(e, "horizontal")).filter((f) => f.length > 1),
          vert: Object.values(b(i, "vertical")).filter((f) => f.length > 1),
        }
      );
    }),
    [u, h] = L.reduce(
...
function ze(I, O) {
  const A = [],
    b = dt((u) => `${u[0]},${u[1]}`, "posToStr"),
    L = dt((u) => u.split(",").map((h) => parseInt(h)), "strToPos");
  return (
    I.forEach((u) => {
  ...
  return new Promise((a) => {
    const e = nr("body")
      ...
      i = Fe({
        ...
        style: [
          ...
          {
            selector: ".node-group",
            style: { padding: `${L.getConfigField("padding")}px` },
          },
        ],
        layout: {
          name: "grid",
      ...
      d = i.layout({
        ...
        idealEdgeLength(t) {
          const [s, o] = t.connectedNodes(),
            ...
            { parent: l } = ie(o);
          return c === l
            ? 1.5 * L.getConfigField("iconSize")
            : 0.5 * L.getConfigField("iconSize");
        },
        edgeElasticity(t) {
          const [s, o] = t.connectedNodes(),
            { parent: c } = ie(s),
    ...
    (d.one("layoutstop", () => {
      function t(s, o, c, l) {
        ...
        ((g =
          (l - N + ((v - c) * (N - C)) / (v - P)) /
          Math.sqrt(1 + Math.pow((N - C) / (v - P), 2))),
          (T = Math.sqrt(
            Math.pow(l - N, 2) + Math.pow(c - v, 2) - Math.pow(g, 2),
          )));
        ...
        return (
          (g = Math.abs(g) * k),
          (T = T * X),
          { distances: g, weights: T }
        );
      }
      (dt(t, "getSegmentWeights"), i.startBatch());
      for (const s of Object.values(i.edges()))
        if (s.data?.()) {
          const { x: o, y: c } = s.source().position(),
            { x: l, y: T } = s.target().position();
          if (o !== l && c !== T) {
            const g = s.sourceEndpoint(),
              v = s.targetEndpoint(),
              { sourceDir: N } = be(s),
              [P, C] = qt(N) ? [g.x, v.y] : [v.x, g.y],
              { weights: U, distances: k } = t(g, v, P, C);
...
var Gr = dt(async (I, O, A, b) => {
    const L = b.db;
    L.setDiagramId(O);
    const u = L.getServices(),
      h = L.getJunctions(),
      a = L.getGroups(),
      e = L.getEdges(),
      i = L.getDataStructures(),
      f = ke(O),
      r = f.append("g");
    ...
    (await Sr(r, s, L, O),
      ...
      Ze(
        void 0,
        f,
        L.getConfigField("padding"),
        L.getConfigField("useMaxWidth"),
      ));
  }, "draw"),
  Ur = { draw: Gr },
  Jr = {
