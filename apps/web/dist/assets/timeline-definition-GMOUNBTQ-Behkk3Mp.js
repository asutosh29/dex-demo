...
import { d as ot } from "./arc-BWkOuiEZ.js";
      ...
      performAction: o(function (s, d, l, p, x, u, S) {
        ...
        switch (x) {
          ...
          case 10:
            ...
            break;
          case 11:
            (p.getCommonDb().setDiagramTitle(u[v].substr(6)),
              (this.$ = u[v].substr(6)));
            break;
          case 12:
      ...
      parse: o(function (s) {
        ...
        function b() {
          ...
          return (
            (A = p.pop() || w.lex() || z),
            typeof A != "number" &&
              (A instanceof Array && ((p = A), (A = p.pop())),
              (A = d.symbols_[A] || A)),
            A
          );
        }
...
` +
        ...
        next: o(function () {
          ...
          for (var x = this._currentRules(), u = 0; u < x.length; u++)
            if (
              ((l = this._input.match(this.rules[x[u]])),
...
var D = "",
  ...
  Dt = o(function (e, t) {
    ...
    return (
      o(a, "ambivalent"),
      t.score > 3 ? h(r) : t.score < 3 ? c(r) : a(r),
      i
    );
  }, "drawFace"),
  jt = o(function (e, t) {
...
o(it, "wrap");
var Qt = o(function (e, t, n, i, r, h = !1) {
  ...
  ee = o(function (e, t, n, i) {
    ...
    k === "sandbox" && (s = U("#i" + t));
    const l = (
      k === "sandbox" ? U(s.nodes()[0].contentDocument.body) : U("body")
    ).select("#" + t);
    l.append("g");
    ...
    for (const [N, b] of p.entries()) {
      ...
      (b.events.length > 0 && (T += (b.events.length - 1) * 10),
        (V = Math.max(V, T)));
    }
      ...
      u && u.length > 0
        ? u.forEach((N) => {
            ...
            (E.debug("sectionNode output", T),
              ...
              (z += S + 50),
              b.length > 0 && lt(l, b, L, W, z, v, r, H, V, S, !1, t),
              (W += 200 * Math.max(b.length, 1)),
              (z = R),
              L++);
          })
        : ((w = !1), lt(l, p, L, W, z, v, r, H, V, S, !0, t)));
  ...
  ne = o(function (e, t, n, i, r, h, c) {
    ...
    for (const g of t) {
      ...
      ((a = a + s),
        y.attr("transform", `translate(${i}, ${r})`),
        (r = r + 10 + s));
    }
    return ((r = f), a);
  }, "drawEvents"),
  ...
  oe = o(function (e, t, n, i) {
    ...
    for (const [N, b] of a.entries()) {
      ...
      (b.events.length > 0 && (T += (b.events.length - 1) * Lt),
        (W = Math.max(W, T) + ae));
    }
    (E.debug("maxSectionHeight before draw", m),
      E.debug("maxTaskHeight before draw", y));
  ...
  de = o((e) => {
    ...
    for (let n = 0; n < e.THEME_COLOR_LIMIT; n++)
      ((e["lineColor" + n] = e["lineColor" + n] || e["cScaleInv" + n]),
        Rt(e["lineColor" + n])
          ? (e["lineColor" + n] = Ct(e["lineColor" + n], 20))
          : (e["lineColor" + n] = Wt(e["lineColor" + n], 20)));
    for (let n = 0; n < e.THEME_COLOR_LIMIT; n++) {
      const i = "" + (17 - 3 * n);
      t += `
...
`;
  ...
  we = { db: yt, renderer: ge, parser: zt, styles: pe };
