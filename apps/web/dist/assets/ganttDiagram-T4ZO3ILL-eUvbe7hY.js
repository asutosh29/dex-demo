...
import { g as oe } from "./react-vendor-BNYpS37_.js";
import {
  b as jn,
  t as Ne,
  c as Qn,
...
function et(t, e, n, r) {
  ...
  return (
    ...
    (i.offset = (a, c) => (
      e((a = new Date(+a)), c == null ? 1 : Math.floor(c)),
      a
    )),
    (i.range = (a, c, m) => {
      const Y = [];
...
function Dt(t) {
  return et(
    ...
    (e, n) =>
      (n - e - (n.getTimezoneOffset() - e.getTimezoneOffset()) * ct) / Se,
  );
}
const Rt = Dt(0),
  Nt = Dt(1),
    ...
    return function (R) {
      ...
      if (
        ...
        ("W" in l || "U" in l) &&
          ...
          (Q =
            "Z" in l
              ? ve(At(l.y, 0, 1)).getUTCDay()
              : pe(At(l.y, 0, 1)).getDay()),
          (l.m = 0),
          (l.d =
            "W" in l
              ? ((l.w + 6) % 7) + l.W * 7 - ((Q + 5) % 7)
              : l.w + l.U * 7 - ((Q + 6) % 7)));
      return "Z" in l
        ? ((l.H += (l.Z / 100) | 0), (l.M += l.Z % 100), ve(l))
        : pe(l);
    };
  }
  function y(M, H, R, l) {
...
function bi(t, e) {
  return ((t = Sn(t)), Z(Et.count(wt(t), t) + (wt(t).getUTCDay() === 4), e, 2));
}
function wi(t) {
  return t.getUTCDay();
}
...
function _i(t, e) {
  var n = t.getUTCDay();
  return (
    (t = n >= 4 || n === 0 ? Et(t) : Et.ceil(t)),
    Z(t.getUTCFullYear() % 1e4, e, 4)
  );
}
function Fi() {
  return "+0000";
...
function Ei() {
  return tr.apply(
    _n(_r, Fr, kt, Pt, Rt, xt, Ht, Ot, vt, ie).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
        ...
        (function (n, r) {
            ...
            return function (D) {
              ...
              return (
                (function (o) {
                  ...
                  if (X !== void 0) {
                    var s = o.hours;
                    (X ? s < 12 && (o.hours += 12) : s === 12 && (o.hours = 0),
                      delete o.afternoon);
                  }
                })(w),
                w
          ...
          return function (U, E, N) {
            ((N.p.customParseFormat = !0),
              U && U.parseTwoDigitYear && (C = U.parseTwoDigitYear));
            var W = E.prototype,
              q = W.parse;
            W.parse = function (j) {
              var p = j.date,
              ...
              return (
                ...
                (g.toISOString = function () {
                  ...
                  var w = W(D, "D"),
                    ...
                    u = this.$d.seconds || 0;
                  this.$d.milliseconds &&
                    ((u += this.$d.milliseconds / 1e3),
                    (u = Math.round(1e3 * u) / 1e3));
                  var f = W(u, "S"),
                    x =
                      y.negative ||
                      h.negative ||
    ...
    D = {
      ...
      performAction: d(function (u, f, x, b, F, o, X) {
        ...
        switch (F) {
          ...
          case 36:
            ((this.$ = o[s - 2]),
              b.setClickEvent(o[s - 2], o[s - 1], null),
              b.setLink(o[s - 2], o[s]));
            break;
          case 37:
            ((this.$ = o[s - 3]),
              b.setClickEvent(o[s - 3], o[s - 2], o[s - 1]),
              b.setLink(o[s - 3], o[s]));
            break;
          case 38:
            ((this.$ = o[s - 2]),
              b.setClickEvent(o[s - 2], o[s], null),
              b.setLink(o[s - 2], o[s - 1]));
            break;
          case 39:
            ((this.$ = o[s - 3]),
              b.setClickEvent(o[s - 3], o[s - 1], o[s]),
              b.setLink(o[s - 3], o[s - 2]));
            break;
          case 40:
      ...
      parse: d(function (u) {
        ...
        function l(ot) {
          ((x.length = x.length - 2 * ot),
            (F.length = F.length - ot),
            (o.length = o.length - ot));
        }
        d(l, "popStack");
        function J() {
          var ot;
          return (
            (ot = b.pop() || O.lex() || P),
            typeof ot != "number" &&
              (ot instanceof Array && ((b = ot), (ot = b.pop())),
              (ot = f.symbols_[ot] || ot)),
            ot
          );
        }
        ...
        unput: d(function (u) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: x
                ? (x.length === b.length ? this.yylloc.first_column : 0) +
                  b[b.length - x.length].length -
                  x[0].length
                : this.yylloc.first_column - f,
            }),
            this.options.ranges &&
              (this.yylloc.range = [F[0], F[0] + this.yyleng - f]),
...
` +
        ...
        next: d(function () {
          ...
          for (var F = this._currentRules(), o = 0; o < F.length; o++)
            if (
              ((x = this._input.match(this.rules[F[o]])),
              x && (!f || x[0].length > f[0].length))
            ) {
...
var rn = { friday: 5, saturday: 6 },
  ...
  Yn = d(function (t, e, n, r) {
    ...
    return r.includes(i) || r.includes(a)
      ? !1
      : (n.includes("weekends") &&
            (t.isoWeekday() === rn[ae] || t.isoWeekday() === rn[ae] + 1)) ||
  ...
  sn = d(function () {
    const t = d(function (n) {
      ...
      switch (tt[n].raw.startTime.type) {
        ...
        case "getStartDate":
          ((i = Me(void 0, lt, tt[n].raw.startTime.startData)),
            i && (tt[n].startTime = i));
          break;
      }
      return (
  ...
  Fs = d(function (t, e) {
    let n = e;
    (Ft().securityLevel !== "loose" && (n = Zn.sanitizeUrl(e)),
...
var Ls = d(function () {
  ...
  Ws = d(function (t, e, n, r) {
    ...
    a === "sandbox" && (c = Zt("#i" + e));
    const m =
        a === "sandbox" ? Zt(c.nodes()[0].contentDocument.body) : Zt("body"),
    ...
    function N(h, D, w, T, v, u, f) {
      ...
      const b = [...new Set(h.map((s) => s.order))].map((s) =>
        h.find((I) => I.order === s),
      );
      B.append("g")
        .selectAll("rect")
      ...
      if (
        (F.append("rect")
          ...
          .attr("height", function (s) {
            return s.vert
              ? k.length * (i.barHeight + i.barGap) + i.barHeight * 2
              : v;
          })
        ...
        F.append("text")
          ...
          .attr("x", function (s) {
            ...
            if (
              (s.milestone &&
                ((I += 0.5 * (A(s.endTime) - A(s.startTime)) - 0.5 * v),
                (z = I + v)),
              s.vert)
            )
          ...
          .attr("y", function (s, I) {
            return s.vert
              ? i.gridLineStartPadding +
                  k.length * (i.barHeight + i.barGap) +
                  60
              : ((I = s.order),
                I * D + i.barHeight / 2 + (i.fontSize / 2 - 2) + w);
          })
          .attr("text-height", v)
          .attr("class", function (s) {
            ...
            return (
              s.active &&
                (s.crit ? (O = "activeCritText" + K) : (O = "activeText" + K)),
              s.done
                ? s.crit
                  ? (O = O + " doneCritText" + K)
                  : (O = O + " doneText" + K)
    ...
    function W(h, D, w, T, v, u, f, x) {
      ...
      B.append("g")
        ...
        .attr("transform-origin", function (V, P) {
          return (
            (A(V.start) + w + 0.5 * (A(V.end) - A(V.start))).toString() +
            "px " +
            (P * h + 0.5 * v).toString() +
            "px"
          );
    ...
    function p(h, D) {
      ...
      B.append("g")
        ...
        .enter()
        .append(function (v) {
          const u = v[0].split(Bn.lineBreakRegex),
            f = -(u.length - 1) / 2,
    ...
    function y(h) {
      ...
      for (let T = 0, v = h.length; T < v; ++T)
        Object.prototype.hasOwnProperty.call(D, h[T]) ||
          ((D[h[T]] = !0), w.push(h[T]));
      return w;
    }
    d(y, "checkUnique");
...
`,
  ...
  Hs = Os,
  js = { parser: ji, db: Es, renderer: $s, styles: Hs };
export { js as diagram };
