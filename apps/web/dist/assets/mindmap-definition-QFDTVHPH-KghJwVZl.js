import { g as le } from "./chunk-55IACEB6-D1lW6dHe.js";
import { s as he } from "./chunk-EDXVE4YY-B7A2tvs3.js";
import {
  h,
  l as C,
  x as de,
    ...
    H = {
      ...
      parse: h(function (s) {
        ...
        for (var W in this.yy)
          Object.prototype.hasOwnProperty.call(this.yy, W) &&
            (T.yy[W] = this.yy[W]);
        (m.setInput(s, T.yy),
          (T.yy.lexer = m),
          (T.yy.parser = this),
      ...
      var L = {
        ...
        unput: h(function (s) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [p[0], p[0] + this.yyleng - i]),
...
` +
        ...
        next: h(function () {
          ...
          for (var p = this._currentRules(), r = 0; r < p.length; r++)
            if (
              ((o = this._input.match(this.rules[p[r]])),
  ...
  Ne =
    ((w = class {
      ...
      decorateNode(e) {
        ...
        (e.icon && (l.icon = G(e.icon, a)),
          e.class && (l.class = G(e.class, a)));
      }
      type2Str(e) {
        switch (e) {
      ...
      assignSections(e, a) {
        if (
          (e.level === 0 ? (e.section = void 0) : (e.section = a), e.children)
        )
      ...
      flattenNodes(e, a) {
        ...
        if ((a.push(y), e.children))
          for (const E of e.children) this.flattenNodes(E, a);
      }
      generateEdges(e, a) {
