...
var U = P ? P.prototype : void 0,
  K = U ? U.toString : void 0;
function k(n) {
  if (typeof n == "string") return n;
  if (A(n)) return vn(n, k) + "";
...
function nn(n, r) {
  r = j(r, n);
  for (var e = 0, i = r.length; n != null && e < i; ) n = n[R(r[e++])];
...
v.prototype.add = v.prototype.push = Qn;
v.prototype.has = Xn;
function Jn(n, r) {
...
function fn(n, r, e, i, f, t) {
  ...
  for (t.set(n, r), t.set(r, n); ++l < u; ) {
    ...
    if (o) {
      if (
        !Jn(r, function (b, O) {
          if (!tn(o, O) && (p === b || f(p, b, e, i, t))) return o.push(O);
        })
      ) {
        d = !1;
        break;
...
function dr(n, r, e, i, f, t, s) {
  switch (e) {
    ...
    case sr:
      var a = i & kn;
      if ((u || (u = $), n.size != r.size && !a)) return !1;
      var h = s.get(n);
      if (h) return h == r;
      ((i |= jn), s.set(n, r));
...
function _r(n, r, e, i, f, t) {
  ...
  for (var w = s; ++l < a; ) {
    ...
    var b = n[d],
      O = r[d];
    if (i) var G = s ? i(O, b, d, r, n, t) : i(b, O, d, n, r, t);
    if (!(G === void 0 ? b === O || f(b, O, e, i, t) : G)) {
      _ = !1;
      break;
    }
    w || (w = d == "constructor");
...
function br(n, r, e, i, f, t) {
  ...
  if (d && !g)
    return (
      t || (t = new T()),
      s || _n(n) ? fn(n, r, e, i, f, t) : dr(n, r, a, e, i, f, t)
    );
  if (!(e & or)) {
    var o = g && J.call(n, "__wrapped__"),
      p = l && J.call(r, "__wrapped__");
    if (o || p) {
      var _ = o ? n.value() : n,
        w = p ? r.value() : r;
...
function vr(n, r, e, i) {
  ...
  for (; ++f < t; ) {
    ...
    if (s[2]) {
      ...
      var g = new T(),
        l;
      if (!(l === void 0 ? D(h, a, Or | Pr, i, g) : l)) return !1;
    }
  }
  return !0;
}
