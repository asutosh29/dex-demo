import { g as Ge } from "./chunk-55IACEB6-0eoBi3pJ.js";
import { s as Xe } from "./chunk-EDXVE4YY-B6Y9M-0S.js";
import {
  h as f,
  O as Be,
  f as Je,
      ...
      performAction: f(function (i, l, o, s, d, t, de) {
        ...
        switch (d) {
          ...
          case 21:
            ...
            break;
          case 22:
            (s.addRequirement(t[c - 5], t[c - 6]),
              s.setClass([t[c - 5]], t[c - 3]));
            break;
          case 23:
            s.setNewReqId(t[c - 2]);
            break;
          ...
          switch (N[0]) {
            ...
            case 2:
              if (
                ...
                (ke = this.performAction.apply(
                  J,
                  [c, $e, ge, z.yy, N[1], d, t].concat(We),
                )),
                typeof ke < "u")
              )
                return ke;
      ...
      var $ = {
        ...
        unput: f(function (i) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [d[0], d[0] + this.yyleng - l]),
    ...
    ((Z = class {
      ...
      setNewReqId(n) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.requirementId = n);
      }
      setNewReqText(n) {
      ...
      setNewReqVerifyMethod(n) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.verifyMethod = n);
      }
      addElement(n) {
        return (
          this.elements.has(n) ||
        ...
        for (const h of n) {
          ...
          (r === void 0 &&
            ...
            this.requirements.forEach((a) => {
              a.classes.includes(h) &&
                a.cssStyles.push(...u.flatMap((m) => m.split(",")));
            }),
