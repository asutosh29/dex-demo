import { g as oe } from "./chunk-FMBD7UC4-K5VIVLaq.js";
import {
  h as d,
  O as at,
  j as T,
...
import { c as Le } from "./clone-DMqd9rW8.js";
import { G as Se } from "./graph-DLmGs16Y.js";
import { c as ke } from "./channel-CnZQi0RR.js";
...
var yt = (function () {
  var e = d(function (D, m, g, y) {
      for (g = g || {}, y = D.length; y--; g[D[y]] = m);
      return g;
    }, "o"),
    t = [1, 15],
    a = [1, 7],
    ...
    L = {
      ...
      performAction: d(function (m, g, y, k, E, h, W) {
        var p = h.length - 1;
        switch (E) {
          case 4:
          ...
          case 6:
            ...
            break;
          case 7:
            (k.getLogger().debug("Rule: hierarchy: ", h[p - 1]),
              k.setHierarchy(h[p - 1]));
            break;
          case 8:
      ...
      parse: d(function (m) {
        ...
        function Bt() {
          ...
          return (
            (Y = k.pop() || z.lex() || st),
            typeof Y != "number" &&
              (Y instanceof Array && ((k = Y), (Y = k.pop())),
              (Y = g.symbols_[Y] || Y)),
            Y
          );
        }
          ...
          switch (K[0]) {
            ...
            case 2:
              ...
              (G &&
                ...
                E.push(Q.$),
                h.push(Q._$),
                (Nt = W[y[y.length - 2]][y[y.length - 1]]),
                y.push(Nt));
              break;
            case 3:
              return !0;
...
` +
        ...
        next: d(function () {
          ...
          for (var E = this._currentRules(), h = 0; h < E.length; h++)
            if (
              ((y = this._input.match(this.rules[E[h]])),
          ...
          return g
            ? ((m = this.test_match(g, E[k])), m !== !1 ? m : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        options: {},
        performAction: d(function (g, y, k, E) {
          switch (k) {
            case 0:
            ...
            case 7:
              return (
                ...
                g.getLogger().debug("COLUMNS (LEX)", y.yytext),
                28
              );
            case 8:
            ...
            case 11:
              ...
              break;
            case 12:
              (g.getLogger().debug("LEX: POPPING STR:", y.yytext),
                this.popState());
              break;
            case 13:
            ...
            case 14:
              return (
                ...
                g.getLogger().debug("SPACE NUM (LEX)", y.yytext),
                21
              );
            case 15:
              return (
            ...
            case 82:
              return (
                g.getLogger().debug("LEX: NODE_DESCR:", y.yytext),
                "NODE_DESCR"
              );
            case 83:
            ...
            case 85:
              return (
                ...
                g.getLogger().debug("Lex (right): dir:", y.yytext),
                "DIR"
              );
            case 86:
              return (
                (y.yytext = y.yytext.replace(/^,\s*/, "")),
                g.getLogger().debug("Lex (left):", y.yytext),
                "DIR"
              );
            case 87:
              return (
                (y.yytext = y.yytext.replace(/^,\s*/, "")),
                g.getLogger().debug("Lex (x):", y.yytext),
                "DIR"
              );
            case 88:
              return (
                (y.yytext = y.yytext.replace(/^,\s*/, "")),
                g.getLogger().debug("Lex (y):", y.yytext),
                "DIR"
              );
            case 89:
              return (
                (y.yytext = y.yytext.replace(/^,\s*/, "")),
                g.getLogger().debug("Lex (up):", y.yytext),
                "DIR"
              );
            case 90:
              return (
                (y.yytext = y.yytext.replace(/^,\s*/, "")),
                g.getLogger().debug("Lex (down):", y.yytext),
                "DIR"
              );
            case 91:
              return (
                (y.yytext = "]>"),
                g.getLogger().debug("Lex (ARROW_DIR end):", y.yytext),
                this.popState(),
                this.popState(),
                "BLOCK_ARROW_END"
              );
            case 92:
              return (
                g.getLogger().debug("Lex: LINK", "#" + y.yytext + "#"),
                15
              );
            case 93:
            ...
            case 96:
              return (
                g.getLogger().debug("Lex: START_LINK", y.yytext),
            ...
            case 104:
              return (
                g.getLogger().debug("Lex: COLON", y.yytext),
...
var zt = 0,
  Ce = d(
    () => (zt++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + zt),
    "generateId",
  ),
  Oe = d((e) => {
...
var nr = d((e) => {
  ...
  for (const i of e.children) {
    ...
    (S.debug(
      ...
      i.type !== "space" &&
        (l > t && (t = l / (i.widthInColumns ?? 1)), s > a && (a = s)));
  }
  ...
  if (e.children?.length > 0) {
    ...
    for (const f of e.children)
      f.size &&
        ...
        (f.size.width =
          l * (f.widthInColumns ?? 1) + C * ((f.widthInColumns ?? 1) - 1)),
        (f.size.height = s),
        (f.size.x = 0),
        (f.size.y = 0),
        S.debug(
...
function _t(e, t) {
  ...
  const a = e.columns ?? -1;
  if (
    (S.debug("layoutBlocks columns abc95", e.id, "=>", a, e),
    ...
    for (const o of e.children) {
      ...
      (a > 0 && (L = Math.min(L, a - (n % a))),
        (n += L),
        S.debug("abc88 columnsPos", o, n));
    }
  }
  S.debug(
  ...
  if (e.children)
    for (const s of e.children)
      ({
        ...
        maxX: i,
        maxY: l,
      } = Dt(s, { minX: t, minY: a, maxX: i, maxY: l }));
...
var lr = d(async (e, t, a, i = !1, l = !1) => {
  ...
  U = lr,
  cr = d((e, t, a, i, l) => {
    (t.arrowTypeStart && At(e, "start", t.arrowTypeStart, a, i, l),
      t.arrowTypeEnd && At(e, "end", t.arrowTypeEnd, a, i, l));
  }, "addEdgeMarkers"),
  or = {
    arrow_cross: "cross",
    arrow_point: "point",
    ...
    if (t.startLabelLeft) {
      ...
      if (i) {
        ...
        ((w = v.getBoundingClientRect()),
          L.attr("width", w.width),
          L.attr("height", w.height));
      }
...
var dr = d((e, t) => {
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(l - t.y) * r > Math.abs(i - t.x) * c) {
      ...
      return (
        S.debug(`sides calc abc89, Q ${x}, q ${u}, R ${o}, r ${n}`, {
          _x: b,
          _y: f,
        }),
        n === 0 && ((b = t.x), (f = t.y)),
...
function $t(e, t, a) {
  ...
  for (
    var c = i - e.width / 2 - r, x = l - e.height / 2 - n, o = 0;
    o < t.length;
    o++
  ) {
    var u = t[o],
      b = t[o < t.length - 1 ? o + 1 : 0],
      f = mr(e, a, { x: c + u.x, y: x + u.y }, { x: c + b.x, y: x + b.y });
    f && s.push(f);
  }
  return s.length
    ? (s.length > 1 &&
...
var Lr = d((e, t) => {
  ...
  Sr = Lr,
  B = { node: yr, circle: br, ellipse: qt, polygon: wr, rect: Sr },
  A = d(async (e, t, a, i) => {
    const l = R();
    let s;
    ...
    t.labelType === "markdown"
      ...
      : (o = await U(c, It(Ct(x), l), t.labelStyle, !1, i));
    let u = o.getBBox();
    const b = t.padding / 2;
    if (F(l)) {
...
var kr = d(async (e, t) => {
  ...
  vr = kr,
  Ft = d((e) => (e ? " " + e : ""), "formatClass"),
  H = d(
    (e, t) => `${t || "node default"}${Ft(e.classes)} ${Ft(e.class)}`,
    "getClassesFromNode",
  ),
  Pt = d(async (e, t) => {
...
var Fr = d(async (e, t) => {
  ...
  Wr = d(async (e, t) => {
    ...
    return (
      ...
      (t.intersect = function (r) {
        return (
          S.info("Circle intersect", t, i.width / 2 + l, r),
          B.circle(t, i.width / 2 + l, r)
        );
      }),
      a
    );
  ...
  Xr = d(async (e, t) => {
    ...
    if (F(R())) {
      ...
      ((_ = E.getBoundingClientRect()),
        h.attr("width", _.width),
        h.attr("height", _.height));
    }
    ...
    if (F(R())) {
      ...
      ((m = E.getBoundingClientRect()),
        h.attr("width", m.width),
        h.attr("height", m.height));
    }
    ...
    (t.classData.members.forEach(async (E) => {
      ...
      if (F(R())) {
        ...
        ((O = Z.getBoundingClientRect()),
          V.attr("width", O.width),
          V.attr("height", O.height));
      }
  ...
  te = d(async (e, t, a) => {
    ...
    if (t.link) {
      ...
      (R().securityLevel === "sandbox"
        ...
        (l = await Yt[t.shape](i, t, a)));
    } else ((l = await Yt[t.shape](e, t, a)), (i = l));
    return (
      ...
      if (n?.size && c?.size) {
        ...
        (pr(
          ...
          r.label &&
            ...
            dr({ ...r, x: u[1].x, y: u[1].y }, { originalPath: u })));
      }
    }
}
d(ie, "insertEdges");
var Vr = d(function (e, t) {
  ...
  Gr = d(async function (e, t, a, i) {
    ...
    l === "sandbox" && (n = T("#i" + t));
    const c =
        l === "sandbox" ? T(n.nodes()[0].contentDocument.body) : T("body"),
    ...
    await ae(w, u, r);
    const v = Vt(r);
    if ((await se(w, u, r), await ie(w, f, b, r, t), v)) {
      const L = v,
  ...
  oa = { parser: ve, db: Xe, renderer: Zr, styles: Ve };
export { oa as diagram };
