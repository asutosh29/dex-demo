import { aN as St } from "./index-pheiOOBb.js";
import { m as Gt, f as Eh, d as Ah } from "./min-zg1WETvq.js";
import {
  b as $h,
  l as Ch,
  c as Sh,
  ...
  r as Rc,
  n as Ls,
} from "./_baseUniq-o2_CVhJE.js";
import { bj as kh } from "./mermaid-GHXKKRXX-DbhF4r8w.js";
import { d as bh } from "./react-vendor-BNYpS37_.js";
function Nh(t, e) {
  return $h(Gt(t, e));
}
function _h(t, e) {
  return t && t.length ? Ch(t, Sh(e)) : [];
}
function Fe(t) {
...
function $f(t) {
  return _i(t) && typeof t.fullText == "string";
}
class xe {
  constructor(e, r) {
  ...
  join(e = ",") {
    ...
    let n = "",
      ...
      a = !1;
    do
      ((i = r.next()), i.done || (a && (n += e), (n += Ph(i.value))), (a = !0));
    while (!i.done);
    return n;
  }
  indexOf(e, r = 0) {
    ...
    return new xe(
      ...
      (r) => {
        do {
          ...
          if (!n) {
            const a = e(i);
            if (Ja(a)) r.iterator = a[Symbol.iterator]();
    ...
    return new xe(
      ...
      (n) => {
        do {
          ...
          if (!i)
            if (Ja(a)) n.iterator = a[Symbol.iterator]();
            else return { done: !1, value: a };
        } while (n.iterator);
        return Ze;
      },
  ...
  for (const [r, n] of Object.entries(t))
    r.startsWith("$") ||
      (Array.isArray(n)
        ...
        : Fe(n) &&
          ((n.$container = t), (n.$containerProperty = r), e.deep && fo(n, e)));
}
function Rs(t, e) {
  let r = t;
  for (; r; ) {
      ...
      for (; e.keyIndex < e.keys.length; ) {
        ...
        if (!r.startsWith("$")) {
          ...
          if (ut(n) || Zt(n))
            return (
              e.keyIndex++,
              { done: !1, value: { reference: n, container: t, property: r } }
            );
          if (Array.isArray(n)) {
            for (; e.arrayIndex < n.length; ) {
              ...
              if (ut(a) || Zt(n))
                return {
                  ...
                  value: { reference: a, container: t, property: r, index: i },
                };
            }
            e.arrayIndex = 0;
          }
...
const Ma = { $type: "AbstractParserRule" };
function qi(t) {
  return J.isInstance(t, Ma.$type);
}
const ma = { $type: "AbstractRule" },
...
const ho = { $type: "BooleanLiteral", true: "true" };
function xh(t) {
  return J.isInstance(t, ho.$type);
}
const Er = {
  $type: "CharacterRange",
  cardinality: "cardinality",
...
const Mr = { $type: "Condition" },
  Ga = { $type: "Conjunction", left: "left", right: "right" };
function Mh(t) {
...
const ja = { $type: "Disjunction", left: "left", right: "right" };
function Fh(t) {
  return J.isInstance(t, ja.$type);
}
const po = { $type: "EndOfFile", cardinality: "cardinality" };
function Gh(t) {
...
const mo = { $type: "InferredType", name: "name" };
function kf(t) {
...
const go = { $type: "Negation", value: "value" };
function Uh(t) {
  return J.isInstance(t, go.$type);
}
const wc = { $type: "NumberLiteral", value: "value" },
  ya = { $type: "Parameter", name: "name" },
  yo = { $type: "ParameterReference", parameter: "parameter" };
function qh(t) {
...
const To = { $type: "ReturnType", name: "name" };
function Wh(t) {
...
const za = { $type: "Type", name: "name", type: "type" };
function Yh(t) {
  ...
  constructor() {
    (super(...arguments),
      (this.types = {
        AbstractElement: {
          name: Je.$type,
          properties: { cardinality: { name: Je.cardinality } },
          superTypes: [],
        },
        AbstractParserRule: {
          name: Ma.$type,
          properties: {},
          superTypes: [ma.$type, ot.$type],
        },
        AbstractRule: { name: ma.$type, properties: {}, superTypes: [] },
        ...
        Action: {
          ...
          properties: {
            ...
            inferredType: { name: Rr.inferredType },
            operator: { name: Rr.operator },
            type: { name: Rr.type, referenceType: ot.$type },
          },
          superTypes: [Je.$type],
        },
        Alternatives: {
          name: Fa.$type,
          properties: {
            cardinality: { name: Fa.cardinality },
            elements: { name: Fa.elements, defaultValue: [] },
          },
          superTypes: [Je.$type],
        },
        ArrayLiteral: {
        ...
        ArrayType: {
          name: $c.$type,
          properties: { elementType: { name: $c.elementType } },
          superTypes: [Zn.$type],
        },
        Assignment: {
          name: vr.$type,
          properties: {
            ...
            terminal: { name: vr.terminal },
          },
          superTypes: [Je.$type],
        },
        BooleanLiteral: {
          name: ho.$type,
          properties: { true: { name: ho.true, defaultValue: !1 } },
          superTypes: [Mr.$type, Qn.$type],
        },
        CharacterRange: {
          name: Er.$type,
          properties: {
            ...
            left: { name: Er.left },
            lookahead: { name: Er.lookahead },
            parenthesized: { name: Er.parenthesized, defaultValue: !1 },
            right: { name: Er.right },
          },
          superTypes: [rt.$type],
        },
        Condition: { name: Mr.$type, properties: {}, superTypes: [] },
        Conjunction: {
          name: Ga.$type,
          properties: { left: { name: Ga.left }, right: { name: Ga.right } },
          superTypes: [Mr.$type],
        },
        CrossReference: {
          name: Ar.$type,
          properties: {
            ...
            deprecatedSyntax: { name: Ar.deprecatedSyntax, defaultValue: !1 },
            isMulti: { name: Ar.isMulti, defaultValue: !1 },
            terminal: { name: Ar.terminal },
            type: { name: Ar.type, referenceType: ot.$type },
          },
          superTypes: [Je.$type],
        },
        Disjunction: {
        ...
        EndOfFile: {
          name: po.$type,
          properties: { cardinality: { name: po.cardinality } },
          superTypes: [Je.$type],
        },
        Grammar: {
          name: ar.$type,
        ...
        Group: {
          ...
          properties: {
            ...
            elements: { name: qr.elements, defaultValue: [] },
            guardCondition: { name: qr.guardCondition },
            predicate: { name: qr.predicate },
          },
          superTypes: [Je.$type],
        },
        InferredType: {
          name: mo.$type,
          properties: { name: { name: mo.name } },
          superTypes: [ot.$type],
        },
        InfixRule: {
          name: Lt.$type,
        ...
        InfixRuleOperatorList: {
          name: xs.$type,
          properties: {
            associativity: { name: xs.associativity },
            operators: { name: xs.operators, defaultValue: [] },
          },
          superTypes: [],
        },
        InfixRuleOperators: {
          name: Sc.$type,
          properties: {
            precedences: { name: Sc.precedences, defaultValue: [] },
          },
          superTypes: [],
        },
        Interface: {
          name: vi.$type,
          properties: {
            attributes: { name: vi.attributes, defaultValue: [] },
            name: { name: vi.name },
            superTypes: {
              name: vi.superTypes,
              defaultValue: [],
        ...
        NamedArgument: {
          name: ga.$type,
          properties: {
            calledByName: { name: ga.calledByName, defaultValue: !1 },
            parameter: { name: ga.parameter, referenceType: ya.$type },
            value: { name: ga.value },
          },
          superTypes: [],
        },
        NegatedToken: {
          ...
          properties: {
            ...
            terminal: { name: Br.terminal },
          },
          superTypes: [rt.$type],
        },
        Negation: {
          name: go.$type,
          properties: { value: { name: go.value } },
          superTypes: [Mr.$type],
        },
        NumberLiteral: {
          name: wc.$type,
          properties: { value: { name: wc.value } },
          superTypes: [Qn.$type],
        },
        Parameter: {
          name: ya.$type,
        ...
        ParameterReference: {
          name: yo.$type,
          properties: {
            parameter: { name: yo.parameter, referenceType: ya.$type },
          },
          superTypes: [Mr.$type],
        },
        ParserRule: {
        ...
        ReferenceType: {
          name: Ds.$type,
          properties: {
            isMulti: { name: Ds.isMulti, defaultValue: !1 },
            referenceType: { name: Ds.referenceType },
          },
          superTypes: [Zn.$type],
        },
        RegexToken: {
        ...
        ReturnType: {
          name: To.$type,
          properties: { name: { name: To.name } },
          superTypes: [],
        },
        RuleCall: {
          name: Vr.$type,
          properties: {
            arguments: { name: Vr.arguments, defaultValue: [] },
            cardinality: { name: Vr.cardinality },
            predicate: { name: Vr.predicate },
            rule: { name: Vr.rule, referenceType: ma.$type },
          },
          superTypes: [Je.$type],
        },
        SimpleType: {
          ...
          properties: {
            ...
            typeRef: { name: Ai.typeRef, referenceType: ot.$type },
          },
          superTypes: [Zn.$type],
        },
        StringLiteral: {
          name: kc.$type,
          properties: { value: { name: kc.value } },
          superTypes: [Qn.$type],
        },
        TerminalAlternatives: {
          ...
          properties: {
            ...
            elements: { name: Kr.elements, defaultValue: [] },
            lookahead: { name: Kr.lookahead },
            parenthesized: { name: Kr.parenthesized, defaultValue: !1 },
          },
          superTypes: [rt.$type],
        },
        TerminalElement: {
        ...
        TerminalRule: {
          ...
          properties: {
            ...
            hidden: { name: Jt.hidden, defaultValue: !1 },
            name: { name: Jt.name },
            type: { name: Jt.type },
          },
          superTypes: [ma.$type],
        ...
        TerminalRuleCall: {
          ...
          properties: {
            ...
            rule: { name: Xr.rule, referenceType: Jt.$type },
          },
          superTypes: [rt.$type],
        },
        Type: {
          name: za.$type,
          properties: { name: { name: za.name }, type: { name: za.type } },
          superTypes: [ot.$type],
        },
        TypeAttribute: {
          name: Jn.$type,
          properties: {
            defaultValue: { name: Jn.defaultValue },
            isOptional: { name: Jn.isOptional, defaultValue: !1 },
            name: { name: Jn.name },
            type: { name: Jn.type },
          },
          superTypes: [],
        },
        TypeDefinition: { name: Zn.$type, properties: {}, superTypes: [] },
        UnionType: {
          name: bc.$type,
        ...
        UnorderedGroup: {
          ...
          properties: {
            ...
            elements: { name: Ua.elements, defaultValue: [] },
          },
          superTypes: [Je.$type],
        },
        UntilToken: {
          ...
          properties: {
            ...
            terminal: { name: Yr.terminal },
          },
          superTypes: [rt.$type],
        },
        ValueLiteral: { name: Qn.$type, properties: {}, superTypes: [] },
        Wildcard: {
          name: $i.$type,
          properties: {
            cardinality: { name: $i.cardinality },
            lookahead: { name: $i.lookahead },
            parenthesized: { name: $i.parenthesized, defaultValue: !1 },
          },
          superTypes: [rt.$type],
        },
      }));
...
const J = new Nf();
function Ro(t) {
  return new Yl(t, (e) => (_i(e) ? e.content : []), { includeRoot: !0 });
}
function Qh(t, e) {
...
function ep(t, e) {
  ...
  const r =
    ...
    n =
      t.end.line < e.end.line ||
      (t.end.line === e.end.line && t.end.character <= e.end.character);
  return r && n
    ? Mt.Inside
    : r
      ? Mt.OverlapBack
...
function tp(t, e) {
  return ep(t, e) > Mt.After;
}
const rp = /^[\w\p{L}]$/u;
function np(t, e) {
  if (t) {
    const r = ip(t, !0);
    if (r && Nc(r, e)) return r;
    if ($f(t)) {
...
function Bi(t, e = "Error: Got unexpected value.") {
  throw new Error(e);
}
function U(t) {
...
const ts = [];
for (let t = U("0"); t <= U("9"); t++) ts.push(t);
const rs = [U("_")].concat(ts);
for (let t = U("a"); t <= U("z"); t++) rs.push(t);
for (let t = U("A"); t <= U("Z"); t++) rs.push(t);
const Ic = [
    U(" "),
    U("\f"),
      ...
      case "{":
        ...
        switch (this.popChar()) {
          ...
          case ",":
            let a;
            (this.isDigit()
              ? ((a = this.integerIncludingZero()),
                (r = { atLeast: i, atMost: a }))
...
`),
  ...
  characterClassEscape() {
    ...
    if (Fr(e)) return { type: "Set", value: e, complement: r };
  }
  controlEscapeAtom() {
    let e;
    switch (this.popChar()) {
...
`);
    ...
    if (Fr(e)) return { type: "Character", value: e };
  }
...
`:
  ...
  characterClass() {
    ...
    for (
      ...
      if ((n.type, _c(n) && this.isRangeDash())) {
        this.consumeChar("-");
        ...
        } else (Ms(n.value, e), e.push(U("-")), Ms(i.value, e));
      } else Ms(n.value, e);
    }
...
`:
  ...
  positiveInteger() {
    let e = this.popChar();
    if (op.test(e) === !1) throw Error("Expecting a positive integer");
    for (; Ta.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  integerIncludingZero() {
    let e = this.popChar();
    if (Ta.test(e) === !1) throw Error("Expecting an integer");
    for (; Ta.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  patternCharacter() {
...
`:
  ...
  isDigit() {
    return Ta.test(this.peekChar(0));
  }
  isClassAtom(e = 0) {
...
`:
  ...
  parseHexDigits(e) {
    ...
    for (let i = 0; i < e; i++) {
      ...
      if (sp.test(a) === !1) throw Error("Expecting a HexDecimal digits");
      r += a;
    }
...
function yp(t) {
  ...
  if (t.type.ref) return Df(t.type.ref)?.terminal;
}
function Tp(t) {
...
function Ql(t, e, r, n) {
  if (!n) {
    const i = Rs(t.grammarSource, kr);
    if (i && i.feature === e) return [t];
  }
  return _i(t) && t.astNode === r
    ? t.content.flatMap((i) => Ql(i, e, r, !1))
    : [];
}
function vp(t, e, r) {
  if (!t) return;
  const n = Ep(t, e, t?.astNode);
  if (n.length !== 0)
    return (
      r !== void 0 ? (r = Math.max(0, Math.min(r, n.length - 1))) : (r = 0),
      n[r]
...
function Ep(t, e, r) {
  ...
  do
    if (((i = n.next()), !i.done)) {
      const s = i.value;
      s.astNode === r
        ? br(s.grammarSource) && s.grammarSource.value === e && a.push(s)
        : n.prune();
    }
  while (!i.done);
  return a;
...
function Mf(t, e, r) {
  function n(i, a) {
    let s;
    return (Rs(i, kr) || (s = Mf(a, a, r)), r.set(t, s), s);
  }
  if (r.has(t)) return r.get(t);
  r.set(t, void 0);
  for (const i of Ui(e)) {
    if (kr(i) && i.feature.toLowerCase() === "name") return (r.set(t, i), i);
    if (Nr(i) && Bt(i.rule.ref)) return n(i, i.rule.ref);
    if (Vh(i) && i.typeRef?.ref) return n(i, i.typeRef.ref);
  }
}
function Ff(t) {
  return Gf(t, new Set());
...
function Ii(t) {
  if (qi(t)) return Bt(t) && Ff(t) ? t.name : (jf(t) ?? t.name);
  if (jh(t) || Yh(t) || Wh(t)) return t.name;
  if (vs(t)) {
    const e = $p(t);
    if (e) return e;
...
function $p(t) {
  if (t.inferredType) return t.inferredType.name;
  if (t.type?.ref) return Ii(t.type.ref);
}
function Cp(t) {
  return Wt(t) ? (t.type?.name ?? "string") : (jf(t) ?? t.name);
}
function ec(t) {
  const e = { s: !1, i: !1, u: !1 },
    r = Pn(t.definition, e),
...
function Pn(t, e) {
  ...
  if (Xh(t)) {
    ...
    if (Bh(t)) {
      ...
      throw new Error(
        `Invalid terminal element: ${t?.$type}, ${t?.$cstNode?.text}`,
      );
    }
  }
}
function Sp(t) {
  return Ut(t.elements.map((e) => Pn(e)).join("|"), {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized,
    wrap: !1,
...
function _p(t) {
  const e = [],
    r = t.Grammar;
  for (const n of r.rules) Wt(n) && Tp(n) && fp(ec(n)) && e.push(n.name);
  return { multilineCommentRules: e, nameRegexp: rp };
}
function Eo(t) {
  ...
  if (t instanceof qe) {
    ...
    if (t instanceof tt)
      return {
        ...
        idx: t.idx,
        separator: qa(new ae({ terminalType: t.separator })),
        definition: e(t.definition),
      };
    if (t instanceof Ke)
      return {
    ...
    if (t instanceof ae) {
      ...
      return (
        t.terminalType.PATTERN &&
          (r.pattern = n instanceof RegExp ? n.source : n),
        r
      );
    } else {
      if (t instanceof On)
...
function ns(t, e = []) {
  return t instanceof Me || t instanceof Te || t instanceof Ke
    ? !0
    : t instanceof He
      ? t.definition.some((n) => ns(n, e))
      : t instanceof qe && e.includes(t)
        ? !1
        : t instanceof Tt
          ? (t instanceof qe && e.push(t), t.definition.every((n) => ns(n, e)))
          : !1;
}
function xp(t) {
...
function mt(t) {
  ...
  if (t instanceof ae) return "CONSUME";
  throw Error("non exhaustive match");
}
class Cs {
  walk(e, r = []) {
    e.definition.forEach((n, i) => {
      ...
      else if (n instanceof ae) this.walkTerminal(n, a, r);
...
function Pc(t, e, r) {
  return [
    new Me({
      definition: [new ae({ terminalType: t.separator })].concat(t.definition),
    }),
  ].concat(e, r);
}
function Wi(t) {
  if (t instanceof qe) return Wi(t.referencedRule);
  if (t instanceof ae) return Fp(t);
  if (Lp(t)) return Dp(t);
  if (xp(t)) return Mp(t);
  throw Error("non exhaustive match");
}
...
function Mp(t) {
  const e = t.definition.map((r) => Wi(r));
...
class Gp extends Cs {
  ...
  walkTerminal(e, r, n) {}
  walkProdRef(e, r, n) {
    const i = zp(e.referencedRule, e.idx) + this.topProd.name,
      a = r.concat(n),
...
function Ss(t) {
  const e = t.toString();
  if (Ba.hasOwnProperty(e)) return Ba[e];
  {
    const r = Up.pattern(e);
    return ((Ba[e] = r), r);
  }
}
function qp() {
...
const Wf = "Complement Sets are not supported for first char optimization",
  is = `Unable to use "first char" lexer optimizations:
`;
function Bp(t, e = !1) {
  try {
    const r = Ss(t);
    ...
    if (r.message === Wf)
      e &&
        zf(`${is}	Unable to optimize: < ${t.toString()} >
      ...
      for (let i = 0; i < n.length; i++) {
        ...
        switch (s.type) {
          case "Character":
            ...
            break;
          case "Set":
            if (s.complement === !0) throw Error(Wf);
            s.value.forEach((l) => {
              if (typeof l == "number") Ra(l, e, r);
              else {
                const c = l;
                if (r === !0) for (let u = c.from; u <= c.to; u++) Ra(u, e, r);
                else {
                  for (let u = c.from; u <= c.to && u < Si; u++) Ra(u, e, r);
                  if (c.to >= Si) {
                    const u = c.from >= Si ? c.from : Si,
                      d = c.to,
                      p = Qt(u),
                      m = Qt(d);
                    for (let A = p; A <= m; A++) e[A] = A;
                  }
                }
              }
            });
...
function Wp(t, e) {
  const r = String.fromCharCode(t),
    n = r.toUpperCase();
  if (n !== r) {
    const i = Qt(n.charCodeAt(0));
    e[i] = i;
  } else {
    const i = r.toLowerCase();
    if (i !== r) {
      const a = Qt(i.charCodeAt(0));
      e[a] = a;
    }
  }
}
...
`,
    ...
    ((i = !1),
      (a = n.map((S) => {
        ...
        if (C instanceof RegExp) {
          ...
          if (typeof C == "function") return ((i = !0), { exec: C });
  ...
  r("misc mapping", () => {
    ((s = n.map((S) => S.tokenTypeIdx)),
      ...
      (c = n.map((S) => S.PUSH_MODE)),
      (u = n.map((S) => Object.hasOwn(S, "POP_MODE"))));
  });
  let d;
  r("Line Terminator Handling", () => {
    const S = Hf(e.lineTerminatorCharacters);
    ((d = n.map((C) => !1)),
      e.positionTracking !== "onlyOffset" &&
        (d = n.map((C) =>
          Object.hasOwn(C, "LINE_BREAKS")
            ? !!C.LINE_BREAKS
            : Kf(C, S) === !1 && rc(S, C.PATTERN),
        )));
  });
  let p, m, A, b;
  r("Misc Mapping #2", () => {
      ...
      r("First Char Optimization", () => {
        w = n.reduce((S, C, P) => {
          if (typeof C.PATTERN == "string") {
            const W = C.PATTERN.charCodeAt(0),
              B = Qt(W);
            js(S, B, b[P]);
            ...
            C.START_CHARS_HINT.forEach((B) => {
              const H = typeof B == "string" ? B.charCodeAt(0) : B,
                ne = Qt(H);
              W !== ne && ((W = ne), js(S, ne, b[P]));
            });
          } else if (C.PATTERN instanceof RegExp)
            if (C.PATTERN.unicode)
              ((I = !1),
                e.ensureOptimizations &&
                  Eo(`${is}	Unable to analyze < ${C.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`));
            else {
              const W = Bp(C.PATTERN, e.ensureOptimizations);
              (W.length === 0 && (I = !1),
                W.forEach((B) => {
                  js(S, B, b[P]);
                }));
            ...
            (e.ensureOptimizations &&
              Eo(`${is}	TokenType: <${C.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
...
function Xp(t) {
  let e = [];
  const r = t.filter((n) => n[_r] instanceof RegExp);
  return (
    (e = e.concat(Qp(r))),
    (e = e.concat(rm(r))),
    (e = e.concat(nm(r))),
...
function Yp(t) {
  const e = t.filter((i) => !Object.hasOwn(i, _r)),
    r = e.map((i) => ({
      message:
      ...
      return (
        s === We.NA ||
          (typeof s == "string"
            ...
            : s instanceof RegExp &&
              cm(s) &&
              n.push({ str: s.source, idx: a, tokenType: i })),
        n
      );
    }, []);
  return (
  ...
  return (
    e &&
      s.forEach((l) => {
        const c = Kf(l, o);
        if (c !== !1) {
          const d = { message: gm(l, c), type: c.issue, tokenType: l };
          n.push(d);
        } else
...
function Kf(t, e) {
  ...
  if (t.PATTERN instanceof RegExp) {
    ...
    if (Vf(t)) return { issue: Re.CUSTOM_LINE_BREAK };
    throw Error("non exhaustive match");
  }
}
function gm(t, e) {
...
function ym() {
  if (Wa.length === 0) {
    Wa = new Array(65536);
    for (let t = 0; t < 65536; t++) Wa[t] = t > 255 ? 255 + ~~(t / 255) : t;
  }
}
function Vi(t, e) {
...
function Rm(t) {
  t.forEach((e) => {
    (Jf(e) || ((Xf[xc] = e), (e.tokenTypeIdx = xc++)),
      Dc(e) && !Array.isArray(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]),
      Dc(e) || (e.CATEGORIES = []),
      Am(e) || (e.categoryMatches = []),
      $m(e) || (e.categoryMatchesMap = {}));
  });
}
function vm(t) {
  t.forEach((e) => {
    ((e.categoryMatches = []),
      Object.keys(e.categoryMatchesMap).forEach((r) => {
        e.categoryMatches.push(Xf[r].tokenTypeIdx);
      }));
  });
}
function Em(t) {
...
a boolean 2nd argument is no longer supported`);
      ...
      this.TRACE_INIT("Lexer Constructor", () => {
        ...
        (this.TRACE_INIT("Lexer Config handling", () => {
          if (this.config.lineTerminatorsPattern === wi.lineTerminatorsPattern)
            this.config.lineTerminatorsPattern = mm;
          else if (
            this.config.lineTerminatorCharacters === wi.lineTerminatorCharacters
          )
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          ((this.trackStartLines = /full|onlyStart/i.test(
            ...
            Array.isArray(e)
              ? (i = { modes: { defaultMode: [...e] }, defaultMode: Ci })
        ...
        if (
              ...
              if (
                ...
                this.config.skipValidations === !1 &&
                  this.TRACE_INIT("validatePatterns", () => {
                    this.lexerDefinitionErrors =
                      this.lexerDefinitionErrors.concat(Hp(l, s));
                  }),
                ...
                (this.TRACE_INIT("analyzeTokenTypes", () => {
                  ...
                  (this.charCodeToPatternIdxToConfig[o] =
          ...
          const l = this.lexerDefinitionErrors.map((c) => c.message)
            .join(`-----------------------
`);
          throw new Error(
...
` + l,
  ...
  tokenize(e, r = this.defaultMode) {
    if (this.lexerDefinitionErrors.length > 0) {
      const i = this.lexerDefinitionErrors.map((a) => a.message)
        .join(`-----------------------
`);
      throw new Error(
...
` + i,
  ...
  tokenizeInternal(e, r) {
    let n, i, a, s, o, l, c, u, d, p, m, A, b, I, w;
    const S = e,
      C = S.length;
    let P = 0,
      W = 0;
    const B = this.hasCustom ? 0 : Math.floor(e.length / 10),
      H = new Array(B),
      ne = [];
    let se = this.trackStartLines ? 1 : void 0,
      oe = this.trackStartLines ? 1 : void 0;
    const N = hm(this.emptyGroups),
    ...
    let D = !1;
    const x = (z) => {
      if (E.length === 1 && z.tokenType.PUSH_MODE === void 0) {
        const Q =
          this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(z);
        ne.push({
        ...
        E.pop();
        const Q = E.at(-1);
        ((y = this.patternIdxToConfig[Q]),
          (R = this.charCodeToPatternIdxToConfig[Q]),
          ($ = y.length));
    ...
    function j(z) {
      (E.push(z),
        (R = this.charCodeToPatternIdxToConfig[z]),
            ...
            : F.isCustom === !0
              ? ((w = me.exec(S, P, H, N)),
                w !== null
                  ? ((l = w[0]),
                    (d = l.length),
                    w.payload !== void 0 && (c = w.payload))
                  : (l = null))
              : ((me.lastIndex = P), (d = this.matchLength(me, e, P))),
          d !== -1)
        ) {
            ...
            for (a = 0; a < ke; a++) {
              ...
              if (
                ...
                Ie.isCustom === !0
                  ? ((w = Ce.exec(S, P, H, N)),
                    w !== null
                      ? ((s = w[0]), w.payload !== void 0 && (u = w.payload))
                      : (s = null))
      ...
      if (d !== -1) {
        if (
          ...
          p !== void 0 &&
            ...
            (m = F.tokenTypeIdx),
            (A = this.createTokenInstance(l, P, m, F.tokenType, se, oe, d)),
            this.handlePayload(A, c),
            p === !1 ? (W = this.addToken(H, W, A)) : N[p].push(A)),
          T === !0 && F.canLineTerminator === !0)
        ) {
          let me = 0,
            le,
            ke;
          ...
          do
            ((l = l !== null ? l : e.substring(P, P + d)),
              (le = g.test(l)),
              le === !0 && ((ke = g.lastIndex - 1), me++));
          while (le === !0);
          me !== 0
            ? ((se = se + me),
              (oe = d - ke),
              this.updateTokenEndLineColumnLocation(A, p, ke, me, se, oe, d))
            : (oe = this.computeNewColumn(oe, d));
        } else oe = this.computeNewColumn(oe, d);
        ...
        for (; Ie === !1 && P < C; )
          for (P++, i = 0; i < $; i++) {
            ...
            if (
              (Xe !== !1
                ? S.charCodeAt(P) === Xe && (Ie = !0)
                : Ce.isCustom === !0
                  ? (Ie = Y.exec(S, P, H, N) !== null)
        ...
        if (
          ...
          ne.push({ offset: me, line: le, column: ke, length: b, message: I }),
          te === !1)
        )
          break;
      }
    ...
    return (
      this.hasCustom || (H.length = W),
      { tokens: H, groups: N, errors: ne }
    );
  }
  handleModes(e, r, n, i) {
    if (e.pop === !0) {
  ...
  updateTokenEndLineColumnLocation(e, r, n, i, a, s, o) {
    ...
    r !== void 0 &&
      ...
      (c = l ? -1 : 0),
      (i === 1 && l === !0) ||
        ((e.endLine = a + c), (e.endColumn = s - 1 + -c)));
  }
...
function wm(t) {
  const e = t.pattern,
    r = {};
  if (
    ((r.name = t.name), e !== void 0 && (r.PATTERN = e), Object.hasOwn(t, Sm))
  )
...
const er = Qf({ name: "EOF", pattern: We.NA });
Ki([er]);
...
const rn = {
  buildMismatchTokenMessage({
    ...
    return `Expecting ${Zf(t) ? `--> ${an(t)} <--` : `token of type --> ${t.name} <--`} but found --> '${e.image}' <--`;
  },
...
but found: '` +
  ...
  <${t.map((c) => `[${c.map((u) => an(u)).join(",")}]`).join(" ,")}>`;
      return i + l + s;
    }
  },
};
...
and Non-Terminal names start with a lower case letter.`;
    ...
    buildAlternationPrefixAmbiguityError(t) {
      const e = t.prefixPath.map((i) => an(i)).join(", "),
...
`;
        ...
        const i = t.prefixPath.map((a) => an(a)).join(", ");
...
class Nm extends Ln {
  ...
  visitNonTerminal(e) {
    ...
    if (r) e.referencedRule = r;
      ...
      const n = this.errMsgProvider.buildRuleNotFoundError(
        this.currTopLevel,
        e,
      );
      this.errors.push({
...
class Im extends _m {
  ...
  walkTerminal(e, r, n) {
    if (
      ...
      ((this.possibleTokTypes = Wi(a)), (this.found = !0));
    }
  }
}
class ws extends Cs {
  ...
  for (; r.length < e && i < t.length; ) {
    ...
    if (o instanceof Me) n = s(o.definition);
      ...
      const l = [
        ...
        new Te({
          definition: [new ae({ terminalType: o.separator })].concat(
            o.definition,
          ),
        }),
      ];
      ...
      if (o instanceof ae) r.push(o.terminalType);
      else throw Error("non exhaustive match");
    }
    i++;
  }
...
function Lm(t, e, r, n) {
  ...
  const l = e.length,
    ...
    d = [];
  for (
    d.push({ idx: -1, def: t, ruleStack: [], occurrenceStack: [] });
    d.length !== 0;
  ) {
    const p = d.pop();
    if (p === s) {
    ...
    if (w === i) {
      ...
      const S = [...b];
      S.push(w.nonTerminalName);
      const C = [...I];
      C.push(w.idx);
      const P = {
        idx: A,
        def: w.definition.concat(a, m.slice(1)),
        ruleStack: S,
        occurrenceStack: C,
      };
      d.push(P);
    } else if (w instanceof Me) {
      const S = { idx: A, def: m.slice(1), ruleStack: b, occurrenceStack: I };
      (d.push(S), d.push(s));
      const C = {
        idx: A,
        def: w.definition.concat(m.slice(1)),
        ruleStack: b,
        occurrenceStack: I,
      };
      d.push(C);
    } else if (w instanceof et) {
      const S = new Te({ definition: w.definition, idx: w.idx }),
        C = w.definition.concat([S], m.slice(1)),
        P = { idx: A, def: C, ruleStack: b, occurrenceStack: I };
      d.push(P);
    } else if (w instanceof tt) {
      const S = new ae({ terminalType: w.separator }),
        C = new Te({ definition: [S].concat(w.definition), idx: w.idx }),
        P = w.definition.concat([C], m.slice(1)),
        W = { idx: A, def: P, ruleStack: b, occurrenceStack: I };
      d.push(W);
    } else if (w instanceof Ke) {
      const S = { idx: A, def: m.slice(1), ruleStack: b, occurrenceStack: I };
      (d.push(S), d.push(s));
      const C = new ae({ terminalType: w.separator }),
        P = new Te({ definition: [C].concat(w.definition), idx: w.idx }),
        W = w.definition.concat([P], m.slice(1)),
        B = { idx: A, def: W, ruleStack: b, occurrenceStack: I };
      d.push(B);
    } else if (w instanceof Te) {
      const S = { idx: A, def: m.slice(1), ruleStack: b, occurrenceStack: I };
      (d.push(S), d.push(s));
      const C = new Te({ definition: w.definition, idx: w.idx }),
        P = w.definition.concat([C], m.slice(1)),
        W = { idx: A, def: P, ruleStack: b, occurrenceStack: I };
      d.push(W);
    } else if (w instanceof He)
      for (let S = w.definition.length - 1; S >= 0; S--) {
        const C = w.definition[S],
          P = {
            idx: A,
    ...
    else if (w instanceof On) d.push(xm(w, A, b, I));
    else throw Error("non exhaustive match");
  }
  return u;
}
...
function ic(t) {
  if (t instanceof Me || t === "Option") return de.OPTION;
  if (t instanceof Te || t === "Repetition") return de.REPETITION;
  ...
  if (t instanceof Ke || t === "RepetitionWithSeparator")
    return de.REPETITION_WITH_SEPARATOR;
  if (t instanceof He || t === "Alternation") return de.ALTERNATION;
  throw Error("non exhaustive match");
}
function Kc(t) {
  const { occurrence: e, rule: r, prodType: n, maxLookahead: i } = t,
    a = ic(n);
  return a === de.ALTERNATION ? ks(e, r, i) : bs(e, r, a, i);
}
function Dm(t, e, r, n, i, a) {
  const s = ks(t, e, r),
    o = nd(s) ? as : Vi;
  return a(s, n, o, i);
}
...
class jm extends Cs {
  ...
  walkAtLeastOne(e, r, n) {
    this.checkIsTarget(e, de.REPETITION_MANDATORY, r, n) ||
      super.walkOption(e, r, n);
  }
  walkAtLeastOneSep(e, r, n) {
    this.checkIsTarget(e, de.REPETITION_MANDATORY_WITH_SEPARATOR, r, n) ||
      super.walkOption(e, r, n);
  }
  walkMany(e, r, n) {
  ...
  walkManySep(e, r, n) {
    this.checkIsTarget(e, de.REPETITION_WITH_SEPARATOR, r, n) ||
      super.walkOption(e, r, n);
  }
}
class td extends Ln {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      for (let u = 0; u < c.length; u++) {
        const d = c[u].partialPath,
          p = c[u].suffixDef,
          m = zs(d);
        if (zm(i, m, l) || p.length === 0 || d.length === e) {
          const b = n[l];
          if (wo(b, d) === !1) {
            b.push(d);
...
function ks(t, e, r, n) {
  const i = new td(t, de.ALTERNATION, n);
  return (e.accept(i), rd(i.result, r));
}
function bs(t, e, r, n) {
  const i = new td(t, r);
  e.accept(i);
  const a = i.result,
    o = new jm(e, t, r).startWalking(),
...
function nd(t) {
  return t.every((e) =>
    e.every((r) => r.every((n) => n.categoryMatches.length === 0)),
  );
}
function qm(t) {
...
function Bm(t, e, r, n) {
  const i = t.flatMap((l) => Wm(l, r)),
    a = ng(t, e, r),
    s = t.flatMap((l) => Qm(l, r)),
    o = t.flatMap((l) => Hm(l, t, n, r));
...
function Vm(t) {
  return `${mt(t)}_#_${t.idx}_#_${id(t)}`;
}
function id(t) {
...
function Va(t) {
  ...
  if (r instanceof qe) e.push(r.referencedRule);
    ...
    e = e.concat(Va(r.definition));
  else if (r instanceof He)
    e = r.definition.map((a) => Va(a.definition)).flat();
  else if (!(r instanceof ae)) throw Error("non exhaustive match");
  const n = ns(r),
    i = t.length > 1;
  if (n && i) {
    const a = t.slice(1);
    return e.concat(Va(a));
  } else return e;
}
class ac extends Ln {
  constructor() {
        ...
        e.definition[c].ignoreAmbiguities === !0 ||
          l.forEach((u) => {
            ...
            (t.forEach((p, m) => {
              c !== m &&
                wo(p, u) &&
                e.definition[m].ignoreAmbiguities !== !0 &&
                d.push(m);
            }),
              d.length > 1 &&
                !wo(i, u) &&
                (i.push(u), o.push({ alts: d, path: u })));
          }),
        o
      ),
      [],
...
function ig(t) {
  const e = Object.assign({ errMsgProvider: km }, t),
    r = {};
  return (
    t.rules.forEach((n) => {
      r[n.name] = n;
    }),
    bm(r, e.errMsgProvider)
  );
}
function ag(t) {
  var e;
  const r = (e = t.errMsgProvider) !== null && e !== void 0 ? e : Sr;
  return Bm(t.rules, t.tokenTypes, r, t.grammarName);
}
const sd = "MismatchedTokenException",
  od = "NoViableAltException",
  ld = "EarlyExitException",
  cd = "NotAllInputParsedException",
  ud = [sd, od, ld, cd];
Object.freeze(ud);
function ss(t) {
  return ud.includes(t.name);
}
...
class og extends Ns {
  constructor(e, r) {
    (super(e, r), (this.name = cd));
  }
}
class lg extends Ns {
  constructor(e, r, n) {
    (super(e, r), (this.previousToken = n), (this.name = ld));
  }
}
const Us = {},
  dd = "InRuleRecoveryException";
class cg extends Error {
  constructor(e) {
    (super(e), (this.name = dd));
  }
}
class ug {
  initRecoverable(e) {
    ((this.firstAfterRepMap = {}),
      ...
      (this.recoveryEnabled = Object.hasOwn(e, "recoveryEnabled")
        ? e.recoveryEnabled
        : qt.recoveryEnabled),
      this.recoveryEnabled && (this.attemptInRepetitionRecovery = fg));
  }
  getTokenToInsert(e) {
  ...
  getNextPossibleTokenTypes(e) {
    ...
    return new Im(i, e).startWalking();
  }
  ...
  findReSyncTokenType() {
    ...
    let r = this.LA_FAST(1),
      n = 2;
    for (;;) {
      const i = e.find((a) => ed(r, a));
      if (i !== void 0) return i;
      ((r = this.LA(n)), n++);
    }
  }
  getCurrFollowKey() {
    if (this.RULE_STACK_IDX === 0) return Us;
  ...
  getFollowSetFromFollowKey(e) {
    if (e === Us) return [er];
    const r = e.ruleName + e.idxInCallingRule + Bf + e.inRule;
    return this.resyncFollows[r];
  }
  addToResyncTokens(e, r) {
    return (this.tokenMatcher(e, er) || r.push(e), r);
  }
  reSyncTo(e) {
    const r = [];
  ...
  getCurrentGrammarPath(e, r) {
    const n = this.getHumanReadableRuleStack(),
      i = this.RULE_OCCURRENCE_STACK.slice(
        0,
...
function fg(t, e, r, n, i, a, s) {
  ...
  (this.RULE_STACK_IDX === 0 && d && c === void 0 && ((c = er), (u = 1)),
    !(c === void 0 || u === void 0) &&
...
class sc {
  constructor(e) {
    var r;
    this.maxLookahead =
      (r = e?.maxLookahead) !== null && r !== void 0 ? r : qt.maxLookahead;
  }
  validate(e) {
  ...
  validateNoLeftRecursion(e) {
    return e.flatMap((r) => ad(r, r, Sr));
  }
  validateEmptyOrAlternatives(e) {
    return e.flatMap((r) => Ym(r, Sr));
  }
  validateAmbiguousAlternationAlternatives(e, r) {
    return e.flatMap((n) => Jm(n, r, Sr));
  }
        ...
        (n.forEach((c) => {
          ...
          this.TRACE_INIT(`${mt(c)}${u}`, () => {
            const d = this.lookaheadStrategy.buildLookaheadForAlternation({
              ...
              p = qs(this.fullRuleNameToShort[r.name], hd, c.idx);
  ...
  computeLookaheadFunc(e, r, n, i, a, s) {
    this.TRACE_INIT(`${s}${r === 0 ? "" : r}`, () => {
      const o = this.lookaheadStrategy.buildLookaheadForOptional({
        ...
        l = qs(this.fullRuleNameToShort[e.name], n, r);
      this.setLaFuncCache(l, o);
    });
  }
  getKeyForAutomaticLookahead(e, r) {
    return qs(this.currRuleShortName, e, r);
  }
...
const Ea = new pg();
function mg(t) {
  (Ea.reset(), t.accept(Ea));
  const e = Ea.dslMethods;
  return (Ea.reset(), e);
}
function Xc(t, e) {
...
function Eg(t, e, r) {
  const n = function () {};
  md(n, t + "BaseSemanticsWithDefaults");
...
class Cg {
  ...
  cstPostTerminal(e, r) {
    ...
    (gg(n, r, e), this.setNodeLocationFromToken(n.location, r));
  }
  cstPostNonTerminal(e, r) {
    const n = this.CST_STACK[this.CST_STACK.length - 1];
    (yg(n, r, e), this.setNodeLocationFromNode(n.location, e.location));
  }
  getBaseCstVisitorConstructor() {
    if (this.baseCstVisitorConstructor === void 0) {
      const e = vg(this.className, Object.keys(this.gastProductionsCache));
...
class Sg {
  ...
  LA(e) {
    const r = this.currIdx + e;
    return r < 0 || this.tokVectorLength <= r ? wn : this.tokVector[r];
  }
  consumeToken() {
    this.currIdx++;
  }
...
class wg {
  ...
  RULE(e, r, n = ls) {
    if (this.definedRulesNames.includes(e)) {
      const s = {
        message: Sr.buildDuplicateRuleNameError({
          topLevelRule: e,
  ...
  OVERRIDE_RULE(e, r, n = ls) {
    const i = Xm(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return Op(Object.values(this.gastProductionsCache));
  }
}
class kg {
  initRecognizerEngine(e, r) {
    ...
    if (Array.isArray(e))
      ...
      Object.values(e.modes).flat().every(Cm)
    ) {
    ...
    const i = (
      ...
      var s;
      return (
        ((s = a.categoryMatches) === null || s === void 0
          ? void 0
          : s.length) == 0
      );
    });
    ((this.tokenMatcher = i ? as : Vi), Ki(Object.values(this.tokensMap)));
  }
  defineRule(e, r, n) {
    if (this.selfAnalysisDone)
      throw Error(`Grammar rule <${e}> may not be defined after the 'performSelfAnalysis' method has been called'
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const i = Object.hasOwn(n, "resyncEnabled")
        ? n.resyncEnabled
        : ls.resyncEnabled,
      a = Object.hasOwn(n, "recoveryValueFunc")
        ? n.recoveryValueFunc
        : ls.recoveryValueFunc,
      s = this.ruleShortNameIdx << (dg + rr);
  ...
  optionInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(pd, r);
  ...
  atLeastOneSepFirstInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(Ka, e);
  ...
  atLeastOneSepFirstInternalLogic(e, r, n) {
    ...
    if (this.getLaFuncFromCache(n).call(this) === !0) {
      ...
      throw this.raiseEarlyExitException(
        e,
        de.REPETITION_MANDATORY_WITH_SEPARATOR,
        r.ERR_MSG,
      );
  }
  manyInternal(e, r) {
  ...
  manySepFirstInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(No, e);
  ...
  isAtEndOfInput() {
    return this.tokenMatcher(this.LA(1), er);
  }
  reset() {
  ...
  onBeforeParse(e) {
    for (let r = 0; r < this.maxLookahead + 1; r++) this.tokVector.push(wn);
  }
  onAfterParse(e) {
    if (this.isAtEndOfInput() === !1) {
      ...
      this.SAVE_ERROR(new og(n, r));
    }
    for (; this.tokVector.at(-1) === wn; ) this.tokVector.pop();
  }
}
class bg {
  initErrorHandler(e) {
  ...
  raiseEarlyExitException(e, r, n) {
    const i = this.getCurrRuleFullName(),
      ...
      o = bs(e, a, r, this.maxLookahead)[0],
      l = [];
  ...
  raiseNoAltException(e, r) {
    ...
    throw this.SAVE_ERROR(new sg(l, this.LA(1), o));
  }
}
const _s = {
...
const Jc = !0,
  Zc = Math.pow(2, rr) - 1,
  gd = Qf({ name: "RECORDING_PHASE_TOKEN", pattern: We.NA });
Ki([gd]);
const yd = nc(
  gd,
...
class _g {
  ...
  topLevelRuleRecord(e, r) {
    try {
      const n = new On({ definition: [], name: e });
      return (
        (n.name = e),
 ...
 inside top level rule: <${this.recordingProdStack[0].name}>`);
    ...
    return (i.definition.push(s), this.outputCst ? Ng : _s);
  }
 ...
 inside top level rule: <${this.recordingProdStack[0].name}>`);
    ...
    const i = this.recordingProdStack.at(-1),
      a = new ae({ idx: r, terminalType: e, label: n?.LABEL });
    return (i.definition.push(a), yd);
  }
}
...
class Pg {
  initPerformanceTracer(e) {
    if (Object.hasOwn(e, "traceInitPerf")) {
      ...
      ((this.traceInitMaxIdent = 0), (this.traceInitPerf = qt.traceInitPerf));
    this.traceInitIndent = -1;
  }
  TRACE_INIT(e, r) {
    if (this.traceInitPerf === !0) {
...
const wn = nc(er, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(wn);
const qt = Object.freeze({
    ...
    outputCst: !0,
    errorMessageProvider: rn,
    nodeLocationTracking: "none",
    traceInitPerf: !1,
    skipValidations: !1,
  }),
  ls = Object.freeze({ recoveryValueFunc: () => {}, resyncEnabled: !0 });
var Be;
(function (t) {
    ...
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (
        (this.TRACE_INIT("Grammar Resolving", () => {
          ((n = ig({ rules: Object.values(this.gastProductionsCache) })),
        ...
        this.definitionErrors.length === 0 &&
          (this.recoveryEnabled &&
            this.TRACE_INIT("computeAllProdsFollows", () => {
              const i = jp(Object.values(this.gastProductionsCache));
        ...
        !Hi.DEFER_DEFINITION_ERRORS_HANDLING &&
          this.definitionErrors.length !== 0)
      )
        throw (
...
Hi.DEFER_DEFINITION_ERRORS_HANDLING = !1;
Og(Hi, [ug, hg, Cg, Sg, kg, wg, bg, _g, Pg]);
class Lg extends Hi {
  constructor(e, r = qt) {
...
function zg(t, e) {
  ...
  for (let n = 0; n < r; n++) {
    const i = e[n],
      a = Ne(t, i, void 0, { type: xg }),
      s = Ne(t, i, void 0, { type: Xi });
...
function Ug(t, e, r) {
  const n = Ne(t, e, r, { type: Rd });
  nr(t, n);
  const i = xn(t, e, n, r, Or(t, e, r));
  return Cd(t, e, r, i);
}
function qg(t, e, r) {
  const n = Ne(t, e, r, { type: Rd });
...
function Vg(t, e, r) {
  const n = Ne(t, e, r, { type: tr });
  nr(t, n);
  const i = Gt(r.definition, (s) => Ad(t, e, s));
  return xn(t, e, n, r, ...i);
}
function Kg(t, e, r) {
  const n = Ne(t, e, r, { type: tr });
...
function Or(t, e, r) {
  const n = wh(
    Gt(r.definition, (i) => Ad(t, e, i)),
    (i) => i !== void 0,
  );
  return n.length === 1 ? n[0] : n.length === 0 ? void 0 : Yg(t, n);
}
function $d(t, e, r, n, i) {
  ...
  return (
    ...
    i === void 0
      ? (Se(o, a), Se(o, l))
      : (Se(o, l), Se(o, i.left), Se(i.right, a)),
    { left: a, right: l }
  );
}
function Cd(t, e, r, n, i) {
  ...
  return (
    ...
    (t.decisionMap[kn(e, i ? "RepetitionWithSeparator" : "Repetition", r.idx)] =
      o),
    { left: o, right: l }
  );
}
function Hg(t, e, r, n) {
  const i = n.left,
    a = n.right;
  return (Se(i, a), (t.decisionMap[kn(e, "Option", r.idx)] = i), n);
}
function nr(t, e) {
  return (
    t.decisionStates.push(e),
    (e.decision = t.decisionStates.length - 1),
    e.decision
  );
}
function xn(t, e, r, n, ...i) {
  const a = Ne(t, e, n, { type: Dg, start: r });
  r.end = a;
  for (const o of i) o !== void 0 ? (Se(r, o.left), Se(o.right, a)) : Se(r, a);
  const s = { left: r, right: a };
  return ((t.decisionMap[kn(e, Xg(n), n.idx)] = r), s);
}
function Xg(t) {
...
function Yg(t, e) {
  ...
  for (let a = 0; a < r - 1; a++) {
    ...
    ((l && c.followState === s.right) || o.target === s.right)
      ? (l ? (c.followState = u) : (o.target = u), Qg(t, s.right))
      : Se(s.right, u);
  }
  const n = e[0],
    i = e[r - 1];
...
function fc(t, e) {
  (t.transitions.length === 0 && (t.epsilonOnlyTransitions = e.isEpsilon()),
    t.transitions.push(e));
}
function Qg(t, e) {
...
class Io {
  ...
  add(e) {
    const r = Sd(e);
    r in this.map ||
      ((this.map[r] = this.configs.length), this.configs.push(e));
  }
  get elements() {
    return this.configs;
  }
...
function ey(t, e) {
  ...
  return (n) => {
    ...
    return (
      a !== void 0 ||
        ((a = { atnStartState: t, decision: e, states: {} }), (r[i] = a)),
      a
    );
  };
}
...
class ty extends sc {
  constructor(e) {
    ...
    (super(),
      (this.logging =
        (r = e?.logging) !== null && r !== void 0 ? r : (n) => console.log(n)));
  }
  initialize(e) {
    ((this.atn = jg(e.rules)), (this.dfas = ry(this.atn)));
  }
  ...
  buildLookaheadForAlternation(e) {
    ...
    if (ru(d, !1) && !a) {
      ...
      return i
        ? function (m) {
            ...
            if (m !== void 0 && I !== void 0) {
              const w = (A = m[I]) === null || A === void 0 ? void 0 : A.GATE;
      ...
      return i
        ? function (p) {
            const m = new wd(),
              A = p === void 0 ? 0 : p.length;
            for (let I = 0; I < A; I++) {
              const w = p?.[I].GATE;
              m.set(I, w === void 0 || w.call(this));
            }
            const b = Bs.call(this, s, u, m, o);
            return typeof b == "number" ? b : void 0;
          }
        : function () {
            const p = Bs.call(this, s, u, tu, o);
  ...
  buildLookaheadForOptional(e) {
    const {
      ...
      u = this.atn.decisionMap[l].decision,
      d = Gt(
        Kc({ maxLookahead: 1, occurrence: r, prodType: i, rule: n }),
        (p) => Gt(p, (m) => m[0]),
      );
    if (ru(d) && d[0][0] && !a) {
      const p = d[0],
        m = Eh(p);
      if (m.length === 1 && kh(m[0].categoryMatches)) {
...
function ry(t) {
  const e = t.decisionStates.length,
    r = Array(e);
  for (let n = 0; n < e; n++) r[n] = ey(t.decisionStates[n], n);
  return r;
}
function Bs(t, e, r, n) {
  const i = t[e](r);
  let a = i.start;
  if (a === void 0) {
    const o = hy(i.atnStartState);
    ((a = bd(i, kd(o))), (i.start = a));
  }
  return ny.apply(this, [i, a, r, n]);
}
function ny(t, e, r, n) {
  let i = e,
    a = 1;
  ...
  for (;;) {
    let l = cy(i, o);
    if ((l === void 0 && (l = iy.apply(this, [t, i, o, a, r, n])), l === cs))
      return ly(s, i, o);
...
function iy(t, e, r, n, i, a) {
  const s = uy(e.configs, r, i);
  if (s.size === 0) return (nu(t, e, r, cs), cs);
  let o = kd(s);
  const l = dy(s, i);
  if (l !== void 0)
...
function sy(t) {
  const e = Gt(t.prefixPath, (i) => an(i)).join(", "),
    r = t.production.idx === 0 ? "" : t.production.idx;
  let n = `Ambiguous Alternatives Detected: <${t.ambiguityIndices.join(", ")}> in <${oy(t.production)}${r}> inside <${t.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
  return (
    (n =
...
function uy(t, e, r) {
  ...
  if ((i.length === 0 && n.size === 1 && (a = n), a === void 0)) {
    a = new Io();
    for (const s of n.elements) us(s, a);
  }
  if (i.length > 0 && !my(a)) for (const s of i) a.add(s);
  return a;
}
function fy(t, e) {
  if (t instanceof lc && ed(e, t.tokenType)) return t.target;
}
function dy(t, e) {
  let r;
...
function nu(t, e, r, n) {
  return ((n = bd(t, n)), (e.edges[r.tokenTypeIdx] = n), n);
}
function bd(t, e) {
  if (e === cs) return e;
...
function py(t, e) {
  if (e instanceof Ed) return { state: e.target, alt: t.alt, stack: t.stack };
  if (e instanceof cc) {
...
function my(t) {
  for (const e of t.elements) if (e.state.type === Xi) return !0;
  return !1;
}
function gy(t) {
  for (const e of t.elements) if (e.state.type !== Xi) return !1;
  return !0;
}
function yy(t) {
  if (gy(t)) return !0;
  const e = Ty(t.elements);
  return Ry(e) && !vy(e);
}
function Ty(t) {
  const e = new Map();
...
(function (t) {
  function e(n, i) {
    return (
      n === Number.MAX_VALUE && (n = Pi.MAX_VALUE),
      i === Number.MAX_VALUE && (i = Pi.MAX_VALUE),
      { line: n, character: i }
    );
  }
  t.create = e;
...
(function (t) {
  function e(n, i, a, s) {
    ...
    throw new Error(
      `Range#create called with invalid arguments[${n}, ${i}, ${a}, ${s}]`,
    );
  }
  t.create = e;
  function r(n) {
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.objectLiteral(i) &&
      K.is(i.range) &&
      (v.string(i.uri) || v.undefined(i.uri))
    );
  }
  t.is = r;
})(Oi || (Oi = {}));
...
(function (t) {
  ...
  function r(n) {
    const i = n;
    return v.objectLiteral(i) && K.is(i.range) && ds.is(i.color);
  }
  t.is = r;
})(xo || (xo = {}));
var Do;
(function (t) {
  ...
  function r(n) {
    ...
    return (
      ...
      (v.undefined(i.additionalTextEdits) ||
        v.typedArray(i.additionalTextEdits, yt.is))
    );
  }
  t.is = r;
})(Do || (Do = {}));
...
(function (t) {
  ...
  function r(n) {
    let i = n;
    return v.defined(i) && Oi.is(i.location) && v.string(i.message);
  }
  t.is = r;
})(hs || (hs = {}));
var Go;
  ...
  function r(n) {
    ...
    return (
      ...
      (v.undefined(a.codeDescription) ||
        v.string(
          (i = a.codeDescription) === null || i === void 0 ? void 0 : i.href,
        )) &&
      (v.string(a.source) || v.undefined(a.source)) &&
      (v.undefined(a.relatedInformation) ||
        v.typedArray(a.relatedInformation, hs.is))
    );
  }
  t.is = r;
})(Li || (Li = {}));
...
(function (t) {
  function e(n, i, a) {
    const s = { label: n };
    return (
      i !== void 0 && (s.needsConfirmation = i),
...
(function (t) {
  ...
  function i(a) {
    const s = a;
    return yt.is(s) && (wr.is(s.annotationId) || De.is(s.annotationId));
  }
  t.is = i;
})(Ft || (Ft = {}));
var xi;
(function (t) {
  ...
  function r(n) {
    let i = n;
    return v.defined(i) && Di.is(i.textDocument) && Array.isArray(i.edits);
  }
  t.is = r;
})(xi || (xi = {}));
var bn;
      ...
      (i.options === void 0 ||
        ((i.options.overwrite === void 0 || v.boolean(i.options.overwrite)) &&
          (i.options.ignoreIfExists === void 0 ||
            v.boolean(i.options.ignoreIfExists)))) &&
      ...
      (i.options === void 0 ||
        ((i.options.recursive === void 0 || v.boolean(i.options.recursive)) &&
          (i.options.ignoreIfNotExists === void 0 ||
            v.boolean(i.options.ignoreIfNotExists)))) &&
      (i.annotationId === void 0 || De.is(i.annotationId))
    );
  }
  t.is = r;
    ...
    return (
      ...
      (n.documentChanges === void 0 ||
        n.documentChanges.every((i) =>
          v.string(i.kind) ? bn.is(i) || Nn.is(i) || _n.is(i) : xi.is(i),
        ))
    );
  }
  t.is = e;
...
class Ey {
    ...
    if (Di.is(e)) {
      ...
      if (!n) {
        ...
        (this._workspaceEdit.documentChanges.push(a),
          (n = new Aa(i, this._changeAnnotations)),
  ...
  createFile(e, r, n) {
    ...
    let i;
    wr.is(r) || De.is(r) ? (i = r) : (n = r);
    let a, s;
    if (
      (i === void 0
        ? (a = bn.create(e, n))
        : ((s = De.is(i) ? i : this._changeAnnotations.manage(i)),
          (a = bn.create(e, n, s))),
      this._workspaceEdit.documentChanges.push(a),
      s !== void 0)
    )
  ...
  renameFile(e, r, n, i) {
    if (
      ...
      throw new Error("Workspace edit is not configured for document changes.");
    let a;
    wr.is(n) || De.is(n) ? (a = n) : (i = n);
    let s, o;
    if (
      (a === void 0
        ? (s = Nn.create(e, r, i))
        : ((o = De.is(a) ? a : this._changeAnnotations.manage(a)),
          (s = Nn.create(e, r, i, o))),
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.defined(i) &&
      v.string(i.uri) &&
      (i.version === null || v.integer(i.version))
    );
  }
  t.is = r;
})(Di || (Di = {}));
...
(function (t) {
  function e(r) {
    const n = r;
    return v.objectLiteral(r) && ms.is(n.kind) && v.string(n.value);
  }
  t.is = e;
})(In || (In = {}));
var Wo;
...
(function (t) {
  function e(r) {
    ...
    return (
      n &&
      (v.string(n.detail) || n.detail === void 0) &&
      (v.string(n.description) || n.description === void 0)
    );
  }
  t.is = e;
})(Yo || (Yo = {}));
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.string(i) ||
      (v.objectLiteral(i) && v.string(i.language) && v.string(i.value))
    );
  }
  t.is = r;
})(Mi || (Mi = {}));
...
(function (t) {
  function e(r, n, ...i) {
    let a = { label: r };
    return (
      v.defined(n) && (a.documentation = n),
      v.defined(i) ? (a.parameters = i) : (a.parameters = []),
      a
    );
  }
  t.create = e;
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.defined(i) &&
      v.typedArray(i.diagnostics, Li.is) &&
      (i.only === void 0 || v.typedArray(i.only, v.string)) &&
      (i.triggerKind === void 0 ||
        i.triggerKind === Fi.Invoked ||
        i.triggerKind === Fi.Automatic)
    );
  }
  t.is = r;
})(ul || (ul = {}));
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      i &&
      v.string(i.title) &&
      (i.diagnostics === void 0 || v.typedArray(i.diagnostics, Li.is)) &&
      (i.kind === void 0 || v.string(i.kind)) &&
      (i.edit !== void 0 || i.command !== void 0) &&
      (i.command === void 0 || Ir.is(i.command)) &&
      (i.isPreferred === void 0 || v.boolean(i.isPreferred)) &&
      (i.edit === void 0 || ps.is(i.edit))
    );
  }
  t.is = r;
})(fl || (fl = {}));
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.defined(i) &&
      K.is(i.range) &&
      (v.undefined(i.command) || Ir.is(i.command))
    );
  }
  t.is = r;
})(dl || (dl = {}));
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.defined(i) &&
      K.is(i.range) &&
      (v.undefined(i.target) || v.string(i.target))
    );
  }
  t.is = r;
})(pl || (pl = {}));
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      i != null &&
      K.is(i.range) &&
      (v.string(i.expression) || i.expression === void 0)
    );
  }
  t.is = r;
})(El || (El = {}));
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.objectLiteral(i) &&
      (i.tooltip === void 0 || v.string(i.tooltip) || In.is(i.tooltip)) &&
      (i.location === void 0 || Oi.is(i.location)) &&
      (i.command === void 0 || Ir.is(i.command))
    );
  }
  t.is = r;
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      (v.objectLiteral(i) &&
        Z.is(i.position) &&
        (v.string(i.label) || v.typedArray(i.label, ys.is)) &&
        (i.kind === void 0 || gs.is(i.kind)) &&
        i.textEdits === void 0) ||
...
(function (t) {
  function e(r) {
    const n = r;
    return v.objectLiteral(n) && fs.is(n.uri) && v.string(n.name);
  }
  t.is = e;
})(_l || (_l = {}));
const Ay = [
...
(function (t) {
  ...
  function n(a, s) {
    ...
    for (let u = l.length - 1; u >= 0; u--) {
      let d = l[u],
        p = a.offsetAt(d.range.start),
        m = a.offsetAt(d.range.end);
      if (m <= c) o = o.substring(0, p) + d.newText + o.substring(m, o.length);
  ...
  function i(a, s) {
    ...
    for (; u < l.length; ) a[p++] = l[u++];
    for (; d < c.length; ) a[p++] = c[d++];
    return a;
  }
})(Il || (Il = {}));
let $y = class {
...
(function (t) {
  ...
  function l(m) {
    return (
      e.call(m) === "[object Number]" && -2147483648 <= m && m <= 2147483647
    );
  }
  t.integer = l;
  function c(m) {
...
class Sy {
  ...
  buildLeafNode(e, r) {
    const n = new Pl(e.startOffset, e.image.length, vo(e), e.tokenType, !r);
    return (
      (n.grammarSource = r),
  ...
  addHiddenNodes(e) {
    const r = [];
    for (const a of e) {
      const s = new Pl(a.startOffset, a.image.length, vo(a), a.tokenType, !0);
  ...
  construct(e) {
    ...
    (typeof e.$type == "string" && !e.$infixName && (this.current.astNode = e),
      (e.$cstNode = r));
...
class wy extends Pd {
  ...
  rule(e, r) {
    ...
    let i;
    Qa(e) && ((i = e.name), this.registerPrecedenceMap(e));
    const a = this.wrapper.DEFINE_RULE(
      Id(e.name),
      this.startImplementation(n, i, r).bind(this),
    );
    return (
      this.allRules.set(e.name, a),
      Bt(e) && e.entry && (this.mainRule = a),
      a
    );
  }
  ...
  computeRuleType(e) {
    return Qa(e) ? Ii(e) : e.fragment ? void 0 : Ff(e) ? Ol : Ii(e);
  }
  parse(e, r = {}) {
  ...
  startImplementation(e, r, n) {
    return (i) => {
      ...
      if (a) {
        const s = { $type: e };
        (this.stack.push(s),
          e === Ol ? (s.value = "") : r !== void 0 && (s.$infixName = r));
      }
  ...
  consume(e, r, n) {
    ...
    if (!this.isRecording() && this.isValidToken(i)) {
      ...
      const s = this.nodeBuilder.buildLeafNode(i, n),
        ...
        c = this.current;
      if (o) {
        const u = br(n) ? i.image : this.converter.convert(i.image, s);
        this.assign(o.operator, o.feature, u, s, l);
      } else if (Ws(c)) {
        let u = i.image;
        (br(n) || (u = this.converter.convert(u, s).toString()),
          (c.value += u));
      }
    }
  }
    ...
    try {
      ...
      this.isRecording() ||
        ...
        o !== void 0 &&
          s &&
          s.length > 0 &&
          this.performSubruleAssignment(o, i, s));
    }
  }
  ...
  constructInfix(e, r) {
    ...
    for (let b = 0; b < i.length; b++) {
      const I = i[b],
        w = r.get(I) ?? { precedence: 1 / 0, rightAssoc: !1 };
      w.precedence > s
        ? ((s = w.precedence), (a = b))
        : w.precedence === s && (w.rightAssoc || (a = b));
    }
    const o = i.slice(0, a),
      l = i.slice(a + 1),
      c = n.slice(0, a + 1),
      ...
      m = this.constructInfix(d, r),
      A = this.constructInfix(p, r);
    return {
      $type: e.$type,
      $cstNode: e.$cstNode,
      left: m,
...
class ky {
  buildMismatchTokenMessage(e) {
    return rn.buildMismatchTokenMessage(e);
  }
  buildNotAllInputParsedMessage(e) {
    return rn.buildNotAllInputParsedMessage(e);
  }
  buildNoViableAltMessage(e) {
    return rn.buildNoViableAltMessage(e);
  }
  buildEarlyExitMessage(e) {
    return rn.buildEarlyExitMessage(e);
  }
}
class Od extends ky {
  ...
  constructor(e, r) {
    ...
    super(e, {
      ...
      lookaheadStrategy: n
        ...
        : new ty({ logging: r.skipValidations ? () => {} : void 0 }),
      ...r,
    });
  }
  get IS_RECORDING() {
...
function xd(t, e, r) {
  return (Iy({ parser: e, tokens: r, ruleNames: new Map() }, t), e);
}
function Iy(t, e) {
  const r = Of(e, !1),
    n = fe(e.rules)
  ...
  for (const a of n) {
    ...
    t.parser.rule(a, Pr(s, a.definition));
  }
  const i = fe(e.rules)
    .filter(Qa)
    .filter((a) => r.has(a));
  for (const a of i) t.parser.rule(a, Py(t, a));
}
function Py(t, e) {
  ...
  const n = e.operators.precedences.flatMap((m) => m.operators),
  ...
  s.elements.push(l, c);
  const d = n
    .map((m) => t.tokens[m.value])
    .map((m, A) => ({ ALT: () => t.parser.consume(A, m, l) }));
  let p;
  return (m) => {
    (p ?? (p = pc(t, r)),
      t.parser.subrule(0, p, !1, a, m),
      t.parser.many(0, {
        DEF: () => {
...
function Pr(t, e, r = !1) {
  let n;
  if (br(e)) n = Gy(t, e);
  else if (vs(e)) n = Oy(t, e);
  else if (kr(e)) n = Pr(t, e.terminal);
  else if (Es(e)) n = Dd(t, e);
  else if (Nr(e)) n = Ly(t, e);
  else if (wf(e)) n = Dy(t, e);
  else if (bf(e)) n = My(t, e);
  else if (Zl(e)) n = Fy(t, e);
  else if (Gh(e)) {
    const i = t.consume++;
    n = () => t.parser.consume(i, er, e);
  } else throw new _f(e.$cstNode, `Unexpected element type: ${e.$type}`);
  return Md(t, r ? void 0 : Ts(e), n, e.cardinality);
}
function Oy(t, e) {
  const r = Ii(e);
...
function Ly(t, e) {
  ...
  if (qi(r)) {
    const n = t.subrule++,
      i = Bt(r) && r.fragment,
      a = e.arguments.length > 0 ? xy(r, e.arguments) : () => ({});
    let s;
    return (o) => {
  ...
  else throw new _f(e.$cstNode, `Undefined rule: ${e.rule.$refText}`);
}
function xy(t, e) {
...
function Dy(t, e) {
  if (e.elements.length === 1) return Pr(t, e.elements[0]);
  {
    const r = [];
    for (const i of e.elements) {
      const a = { ALT: Pr(t, i, !0) },
        s = Ts(i);
...
function My(t, e) {
      ...
      t.parser.alternatives(
        ...
        r.map((l, c) => {
          ...
          return (
            p
              ? (u.GATE = () => p(o))
              : (u.GATE = () => !d.unorderedGroups.get(i(n, d))?.[c]),
            u
          );
        }),
      ),
  ...
  return (o) => {
    (s(o),
      t.parser.isRecording() ||
        t.parser.unorderedGroups.delete(i(n, t.parser)));
  };
}
function Fy(t, e) {
  const r = e.elements.map((n) => Pr(t, n));
  return (n) => r.forEach((i) => i(n));
}
function Ts(t) {
  if (Zl(t)) return t.guardCondition;
}
function Dd(t, e, r = e.terminal) {
  if (r)
    ...
    const i = Df(e.type.ref)?.terminal;
    if (!i)
      throw new Error(
        "Could not find name assignment for type: " + Ii(e.type.ref),
      );
    return Dd(t, e, i);
  }
}
...
function Md(t, e, r, n) {
  ...
  if (n === "*") {
    const a = t.many++;
    return (s) =>
      t.parser.many(a, { DEF: () => r(s), GATE: i ? () => i(s) : void 0 });
  } else if (n === "+") {
    const a = t.many++;
    if (i) {
      const s = t.or++;
      return (o) =>
        t.parser.alternatives(s, [
          {
            ALT: () => t.parser.atLeastOne(a, { DEF: () => r(o) }),
            GATE: () => i(o),
          },
          { ALT: eu(), GATE: () => !i(o) },
        ]);
    ...
    const a = t.optional++;
    return (s) =>
      t.parser.optional(a, { DEF: () => r(s), GATE: i ? () => i(s) : void 0 });
  } else Bi();
}
function pc(t, e) {
  const r = jy(t, e),
...
function zy(t) {
  const e = t.Grammar,
    r = t.parser.Lexer,
    n = new by(t);
  return (xd(e, n, r.definition), n.finalize(), n);
}
function Uy(t) {
  const e = qy(t);
  return (e.finalize(), e);
...
class Fd {
  ...
  buildTerminalToken(e) {
    ...
    return (
      ...
      e.hidden && (i.GROUP = Pf(r) ? We.SKIPPED : "hidden"),
      i
    );
  }
  ...
  buildKeywordPattern(e, r) {
    return r ? new RegExp($s(e.value), "i") : e.value;
  }
  findLongerAlt(e, r) {
    return r.reduce((n, i) => {
      const a = i?.PATTERN;
      return (a?.source && hp("^" + a.source + "$", e.value) && n.push(i), n);
    }, []);
  }
}
class Gd {
...
function Lr() {
  if (su) return $a;
  ((su = 1), Object.defineProperty($a, "__esModule", { value: !0 }));
  let t;
  function e() {
...
function Dn() {
  ...
  return ((or.Emitter = n), (n._noop = function () {}), or);
}
var cu;
function Is() {
  if (cu) return sr;
  ((cu = 1),
    ...
    (sr.CancellationTokenSource = sr.CancellationToken = void 0));
  const t = Lr(),
    e = Yi(),
    r = Dn();
  var n;
  ...
  return ((sr.CancellationTokenSource = s), sr);
}
var he = Is();
function By() {
...
let Ha = 0,
  Wy = 10;
function Vy() {
  return ((Ha = performance.now()), new he.CancellationTokenSource());
}
const nn = Symbol("OperationCancelled");
function Ps(t) {
  return t === nn;
}
async function Ue(t) {
  if (t === he.CancellationToken.None) return;
  const e = performance.now();
  if (
    (e - Ha >= Wy && ((Ha = e), await By(), (Ha = performance.now())),
...
class Gi {
  ...
  update(e, r) {
    for (const n of e)
      if (Gi.isIncremental(n)) {
        ...
        if (l - o === u.length)
          for (let p = 0, m = u.length; p < m; p++) c[p + o + 1] = u[p];
        else
          u.length < 1e4
            ? c.splice(o + 1, l - o, ...u)
            : (this._lineOffsets = c =
                c.slice(0, o + 1).concat(u, c.slice(l + 1)));
  ...
  positionAt(e) {
    ...
    const a = n - 1;
    return (
      (e = this.ensureBeforeEOL(e, r[a])),
      { line: a, character: e - r[a] }
    );
  }
  offsetAt(e) {
    const r = this.getLineOffsets();
  ...
  ensureBeforeEOL(e, r) {
    for (; e > r && jd(this._content.charCodeAt(e - 1)); ) e--;
    return e;
  }
  get lineCount() {
    return this.getLineOffsets().length;
...
(function (t) {
  function e(i, a, s, o) {
    return new Gi(i, a, s, o);
  }
  t.create = e;
  function r(i, a, s) {
    if (i instanceof Gi) return (i.update(a, s), i);
    throw new Error(
...
function uu(t, e, r = 0) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    jd(a) &&
      (a === 13 && i + 1 < t.length && t.charCodeAt(i + 1) === 10 && i++,
      n.push(r + i + 1));
  }
  return n;
}
...
(() => {
  var t = {
      975: (N) => {
        function T(y) {
          if (typeof y != "string")
            throw new TypeError(
              "Path must be a string. Received " + JSON.stringify(y),
            );
        }
        function g(y, R) {
        ...
        var $ = {
          resolve: function () {
            for (
              var y, R = "", E = !1, L = arguments.length - 1;
              L >= -1 && !E;
              L--
            ) {
              var D;
              (L >= 0
                ? (D = arguments[L])
                : (y === void 0 && (y = process.cwd()), (D = y)),
                T(D),
                D.length !== 0 &&
                  ((R = D + "/" + R), (E = D.charCodeAt(0) === 47)));
            }
            return (
              (R = g(R, !E)),
              E ? (R.length > 0 ? "/" + R : "/") : R.length > 0 ? R : "."
            );
          },
          ...
          relative: function (y, R) {
            if (
              (T(y), T(R), y === R || (y = $.resolve(y)) === (R = $.resolve(R)))
            )
              return "";
            for (var E = 1; E < y.length && y.charCodeAt(E) === 47; ++E);
            for (
              var L = y.length, D = L - E, x = 1;
              x < R.length && R.charCodeAt(x) === 47;
              ++x
            );
            for (
              var j = R.length - x, F = D < j ? D : j, te = -1, z = 0;
              z <= F;
              ++z
            ) {
              if (z === F) {
            ...
            var _e = "";
            for (z = E + te + 1; z <= L; ++z)
              (z !== L && y.charCodeAt(z) !== 47) ||
                (_e.length === 0 ? (_e += "..") : (_e += "/.."));
            return _e.length > 0
              ? _e + R.slice(x + te)
              : ((x += te), R.charCodeAt(x) === 47 && ++x, R.slice(x));
          },
          ...
          extname: function (y) {
            T(y);
            for (
              var R = -1, E = 0, L = -1, D = !0, x = 0, j = y.length - 1;
              j >= 0;
              --j
            ) {
          ...
          parse: function (y) {
            ...
            D ? ((R.root = "/"), (E = 1)) : (E = 0);
            for (
              var x = -1, j = 0, F = -1, te = !0, z = y.length - 1, Q = 0;
              z >= E;
              --z
            )
            ...
            return (
              ...
              (Q === 1 && x === F - 1 && x === j + 1)
                ? F !== -1 &&
                  (R.base = R.name =
                    j === 0 && D ? y.slice(1, F) : y.slice(j, F))
                : (j === 0 && D
                    ? ((R.name = y.slice(1, x)), (R.base = y.slice(1, F)))
                    : ((R.name = y.slice(j, x)), (R.base = y.slice(j, F))),
                  (R.ext = y.slice(x, F))),
  ...
  ((r.d = (N, T) => {
    for (var g in T)
      r.o(T, g) &&
        !r.o(N, g) &&
        Object.defineProperty(N, g, { enumerable: !0, get: T[g] });
  }),
  ...
  class p {
    ...
    with(T) {
      ...
      return (
        ...
        R === void 0 ? (R = this.query) : R === null && (R = c),
        E === void 0 ? (E = this.fragment) : E === null && (E = c),
        g === this.scheme &&
        $ === this.authority &&
        y === this.path &&
        R === this.query &&
    ...
    static file(T) {
      ...
      if ((i && (T = T.replace(/\\/g, u)), T[0] === u && T[1] === u)) {
        ...
        $ === -1
          ? ((g = T.substring(2)), (T = u))
          : ((g = T.substring(2, $)), (T = T.substring($) || u));
      }
    ...
    static revive(T) {
      if (T) {
        if (T instanceof p) return T;
        {
          const g = new A(T);
          return (
            (g._formatted = T.external),
            (g._fsPath = T._sep === m ? T.fsPath : null),
            g
          );
        }
      }
  ...
  class A extends p {
    ...
    toJSON() {
      const T = { $mid: 1 };
      return (
        this._fsPath && ((T.fsPath = this._fsPath), (T._sep = m)),
  ...
  function I(N, T, g) {
    ...
    for (let R = 0; R < N.length; R++) {
      ...
      if (
        ...
        (y !== -1 && (($ += encodeURIComponent(N.substring(y, R))), (y = -1)),
          $ !== void 0 && ($ += N.charAt(R)));
      else {
        $ === void 0 && ($ = N.substr(0, R));
        const L = b[E];
        L !== void 0
          ? (y !== -1 &&
              (($ += encodeURIComponent(N.substring(y, R))), (y = -1)),
            ($ += L))
          : y === -1 && (y = R);
      }
    }
    return (
      y !== -1 && ($ += encodeURIComponent(N.substring(y))),
      $ !== void 0 ? $ : N
    );
  }
  function w(N) {
  ...
  function C(N, T) {
    const g = T ? w : I;
    let $ = "",
      { scheme: y, authority: R, path: E, query: L, fragment: D } = N;
    if (
      (y && (($ += y), ($ += ":")),
      (R || y === "file") && (($ += u), ($ += u)),
      R)
    ...
    if (E) {
      if (E.length >= 3 && E.charCodeAt(0) === 47 && E.charCodeAt(2) === 58) {
        ...
        x >= 65 &&
          x <= 90 &&
          (E = `/${String.fromCharCode(x + 32)}:${E.substr(3)}`);
      } else if (E.length >= 2 && E.charCodeAt(1) === 58) {
        const x = E.charCodeAt(0);
        x >= 65 &&
          x <= 90 &&
          (E = `${String.fromCharCode(x + 32)}:${E.substr(2)}`);
      }
      $ += g(E, !0, !1);
    }
    return (
  ...
  ((function (N) {
    ((N.joinPath = function (T, ...g) {
      ...
      (N.resolvePath = function (T, ...g) {
        ...
        let R = ne.resolve($, ...g);
        return (
          y && R[0] === se && !T.authority && (R = R.substring(1)),
          T.with({ path: R })
        );
      }),
      (N.dirname = function (T) {
        ...
        return (
          g.length === 1 && g.charCodeAt(0) === 46 && (g = ""),
          T.with({ path: g })
        );
      }),
...
(function (t) {
  ...
  function a(s, o) {
    ...
    return (
      ...
      c === l
        ? !0
        : c.length < l.length || c.charAt(l.length) !== "/"
          ? !1
          : c.startsWith(l)
    );
  }
...
class Hy {
  ...
  getNode(e, r) {
    ...
    for (const a of n) {
      ...
      if (!s)
        if (r)
          ((s = { name: a, children: new Map(), parent: i }),
            i.children.set(a, s));
        else return;
      i = s;
    }
...
class Xy {
  ...
  fromTextDocument(e, r, n) {
    return (
      (r = r ?? ft.parse(e.uri)),
      he.CancellationToken.is(n)
        ? this.createAsync(r, e, n)
        : this.create(r, e, n)
    );
  }
  fromString(e, r, n) {
    return he.CancellationToken.is(n)
      ? this.createAsync(r, e, n)
      : this.create(r, e, n);
  }
  fromModel(e, r) {
  ...
  async update(e, r) {
    ...
    return (
      n !== a &&
        ((e.parseResult = await this.parseAsync(e.uri, a, r)),
...
class Yy {
  ...
  async getOrCreateDocument(e, r) {
    ...
    return (
      n ||
      ((n = await this.langiumDocumentFactory.fromUri(e, r)),
      this.addDocument(n),
      n)
    );
  }
...
class Jy {
  ...
  async link(e, r = he.CancellationToken.None) {
    if (this.profiler?.isActive("linking")) {
      ...
      for (const n of zt(e.parseResult.value))
        (await Ue(r), Za(n).forEach((i) => this.doLink(i, e)));
  }
  doLink(e, r) {
    const n = e.reference;
    ...
    const a = this,
      s = {
        ...
        get items() {
          ...
          } else this._items === Gr && a.throwCyclicReferenceError(e, r, i);
  ...
  createLinkingError(e, r) {
    const n = Da(e.container).$document;
    n &&
      n.state < V.ComputedScopes &&
      console.warn(
...
class eT {
  constructor(e) {
    ((this.nameProvider = e.references.NameProvider),
      ...
      (this.hasMultiReference = zt(e.Grammar).some((r) => Es(r) && r.isMulti)));
  }
  findDeclarations(e) {
    if (e) {
      const r = Ap(e),
      ...
      if (n) {
        ...
        if (i && (i === e || Qh(e, i))) return this.getSelfNodes(n);
      }
    }
    return [];
  }
  getSelfNodes(e) {
    if (this.hasMultiReference) {
      const r = this.index.findAllReferences(
          e,
      ...
      if (n) {
        for (const i of Za(n))
          if (Zt(i.reference) && i.reference.items.some((a) => a.ref === e))
  ...
  findReferences(e, r) {
    ...
    return (
      r.documentUri &&
        (i = i.filter((a) => Qe.equals(a.sourceUri, r.documentUri))),
      n.push(...i),
      fe(n)
    );
  }
...
class ji {
  ...
  get size() {
    return uo.sum(fe(this.map.values()).map((e) => e.length));
  }
  clear() {
    this.map.clear();
  }
  ...
  add(e, r) {
    return (
      this.map.has(e) ? this.map.get(e).push(r) : this.map.set(e, [r]),
      this
    );
  }
  addAll(e, r) {
...
class tT {
  ...
  async collectLocalSymbols(e, r = he.CancellationToken.None) {
    const n = e.parseResult.value,
      i = new ji();
    for (const a of Ui(n)) (await Ue(r), this.addLocalSymbol(a, e, i));
    return i;
  }
...
class sT {
  constructor(e) {
    ((this.reflection = e.shared.AstReflection),
      ...
      (this.globalScopeCache = new aT(e.shared)));
  }
  getScope(e) {
    const r = [],
    ...
    if (i) {
      ...
      do
        (i.has(s) &&
          r.push(
            i.getStream(s).filter((o) => this.reflection.isSubtype(o.type, n)),
          ),
          (s = s.$container));
      while (s);
    }
  ...
  getGlobalScope(e, r) {
    return this.globalScopeCache.get(
      e,
      () => new rT(this.indexManager.allElements(e)),
    );
  }
}
function oT(t) {
...
class lT {
  ...
  serialize(e, r) {
    const n = r ?? {},
      ...
      s = i ? (o, l) => i(o, l, a) : a;
    try {
      return ((this.currentDocument = jt(e)), JSON.stringify(e, s, r?.space));
    } finally {
  ...
  replacer(
    e,
    r,
    { refText: n, sourceText: i, textRegions: a, comments: s, uriConverter: o },
  ) {
    if (!this.ignoreProperties.has(e))
      if (ut(r)) {
        const l = r.ref,
          c = n ? r.$refText : void 0;
        if (l) {
          const u = jt(l);
          let d = "";
          this.currentDocument &&
            this.currentDocument !== u &&
            (o ? (d = o(u.uri, l)) : (d = u.uri.toString()));
          const p = this.astNodeLocator.getAstNodePath(l);
          return { $ref: `${d}#${p}`, $refText: c };
        } else
          return {
        ...
        for (const u of r.items) {
          ...
          this.currentDocument &&
            ...
            (o ? (m = o(p.uri, d)) : (m = p.uri.toString()));
        ...
        if (
          (a &&
            ...
            (!e || r.$document) &&
              l?.$textRegion &&
              (l.$textRegion.documentURI =
                this.currentDocument?.uri.toString())),
          i && !e && (l ?? (l = { ...r }), (l.$sourceText = r.$cstNode?.text)),
          s)
        ) {
          l ?? (l = { ...r });
    ...
    for (const [l, c] of Object.entries(e))
      if (Array.isArray(c))
        for (let u = 0; u < c.length; u++) {
          const d = c[u];
          hu(d)
            ? (c[u] = this.reviveReference(e, l, r, d, n))
            : Fe(d) && this.linkNode(d, r, n, e, l, u);
        }
      else
        hu(c)
          ? (e[l] = this.reviveReference(e, l, r, c, n))
          : Fe(c) && this.linkNode(c, r, n, e, l);
    const o = e;
  ...
  reviveReference(e, r, n, i, a) {
    ...
    if (i.$ref) {
      ...
      if (Fe(c))
        return (
          s || (s = this.nameProvider.getName(c)),
          { $refText: s ?? "", ref: c }
        );
      o = c;
    } else if (i.$refs) {
    ...
    if (o)
      return (
        ...
        (l.error = {
          info: { container: e, property: r, reference: l },
          message: o,
        }),
        l
      );
...
class uT {
  ...
  async handleException(e, r, n, i) {
    try {
      ...
      if (Ps(a)) throw a;
      (console.error(`${r}:`, a),
        a instanceof Error && a.stack && console.error(a.stack));
...
const fT = Object.freeze({ validateNode: !0, validateChildren: !0 });
class dT {
  constructor(e) {
    ...
    if (
      ...
      (!r.categories || r.categories.includes("built-in")) &&
        ...
        (r.stopAfterLexingErrors &&
          a.some((s) => s.data?.code === ct.LexingError)) ||
          (this.processParsingErrors(i, a, r),
          r.stopAfterParsingErrors &&
            a.some((s) => s.data?.code === ct.ParsingError)) ||
    ...
    if (this.profiler?.isActive("validating")) {
      ...
      try {
        ...
        for (const o of s) {
          ...
          if (l.validateNode)
            try {
              const c = this.validationRegistry.getChecks(
                o.$type,
                r.categories,
              );
      ...
      for (const s of a) {
        ...
        if (o.validateNode) {
          ...
          for (const c of l) await c(s, n, i);
        }
  ...
  return (
    typeof t.property == "string"
      ...
      : typeof t.keyword == "string" &&
        (e = vp(t.node.$cstNode, t.keyword, t.index)),
    e ?? (e = t.node.$cstNode),
    e
      ? e.range
...
function pT(t) {
  switch (t) {
    case "error":
      return ki(ct.LexingError);
    case "warning":
      return ki(ct.LexingWarning);
    case "info":
      return ki(ct.LexingInfo);
    case "hint":
      return ki(ct.LexingHint);
    default:
      throw new Error("Invalid diagnostic severity: " + t);
  }
}
...
class mT {
  ...
  createDescription(e, r, n) {
    ...
    let s;
    const o = () =>
      s ?? (s = es(this.nameProvider.getNameNode(e) ?? e.$cstNode));
    return {
      node: e,
      name: r,
      get nameSegment() {
...
class RT {
  constructor(e) {
    ((this._ready = new mc()),
      (this.onConfigurationSectionUpdateEmitter = new TT.Emitter()),
      (this.settings = {}),
...
function Wd() {
  ...
  (Object.defineProperty(wt, "__esModule", { value: !0 }),
    (wt.LRUCache = wt.LinkedMap = wt.Touch = void 0));
  var e;
  (function (i) {
    ((i.None = 0),
      (i.First = 1),
  ...
  class r {
    ...
    set(a, s, o = e.None) {
      ...
      if (l) ((l.value = s), o !== e.None && this.touch(l, o));
        ...
        switch (
          ((l = { key: a, value: s, next: void 0, previous: void 0 }), o)
        ) {
          case e.None:
            this.addItemLast(l);
            break;
    ...
    forEach(a, s) {
      ...
      for (; l; ) {
        if (
          (s ? a.bind(s)(l.value, l.key, this) : a(l.value, l.key, this),
          this._state !== o)
        )
...
function ET() {
  ...
  class r {
    ...
    enableCancellation(o) {
      ...
      ((c[0] = e.Continue),
        this.buffers.set(o.id, l),
        (o.$cancellationData = l));
    }
  ...
  ur.SharedArraySenderStrategy = r;
  class n {
    constructor(o) {
  ...
  return ((ur.SharedArrayReceiverStrategy = a), ur);
}
var kt = {},
  ii = {},
  Tu;
  ...
  class e {
    ...
    lock(n) {
      return new Promise((i, a) => {
        (this._waiting.push({ thunk: n, resolve: i, reject: a }),
          this.runNext());
      });
    }
    get active() {
...
function AT() {
  ...
  ((Ru = 1),
    ...
    (kt.ReadableStreamMessageReader =
      kt.AbstractMessageReader =
      kt.MessageReader =
        void 0));
  const t = Lr(),
    e = Yi(),
  ...
  (function (l) {
    function c(u) {
      ...
      if (u === void 0 || typeof u == "string") d = u ?? "utf-8";
        ...
        if (
          ((d = u.charset ?? "utf-8"),
          u.contentDecoder !== void 0 &&
            ((p = u.contentDecoder), m.set(p.name, p)),
          u.contentDecoders !== void 0)
        )
          for (const I of u.contentDecoders) m.set(I.name, I);
        if (
          (u.contentTypeDecoder !== void 0 &&
            ((A = u.contentTypeDecoder), b.set(A.name, A)),
      ...
      return (
        A === void 0 &&
          ((A = (0, t.default)().applicationJson.decoder), b.set(A.name, A)),
        {
          charset: d,
          contentDecoder: p,
          contentDecoders: m,
  ...
  class o extends a {
    ...
    listen(c) {
      ...
      return (
        this.readable.onError((d) => this.fireError(d)),
...
${JSON.stringify(Object.fromEntries(d))}`),
            ...
            if (isNaN(m)) {
              this.fireError(
                new Error(`Content-Length value must be a number. Got ${p}`),
              );
              return;
            }
              ...
              .lock(async () => {
                const d =
                    this.options.contentDecoder !== void 0
                      ...
                      : u,
                  p = await this.options.contentTypeDecoder.decode(
                    d,
                    this.options,
                  );
                this.callback(p);
        ...
        !(this._partialMessageTimeout <= 0) &&
          (this.partialMessageTimer = (0, t.default)().timer.setTimeout(
            (c, u) => {
              ((this.partialMessageTimer = void 0),
                c === this.messageToken &&
                  (this.firePartialMessage({ messageToken: c, waitingTime: u }),
                  this.setPartialMessageTimer()));
            },
...
function $T() {
  ...
  ((vu = 1),
    ...
    (bt.WriteableStreamMessageWriter =
      bt.AbstractMessageWriter =
      bt.MessageWriter =
        void 0));
  const t = Lr(),
    e = Yi(),
...
`;
  ...
  class o {
    ...
    asError(d) {
      return d instanceof Error
        ? d
        : new Error(
            `Writer received error. Reason: ${e.string(d.message) ? d.message : "unknown"}`,
          );
    }
  }
  ...
  (function (u) {
    function d(p) {
      return p === void 0 || typeof p == "string"
        ? {
            charset: p ?? "utf-8",
        ...
        : {
            ...
            contentEncoder: p.contentEncoder,
            contentTypeEncoder:
              p.contentTypeEncoder ?? (0, t.default)().applicationJson.encoder,
          };
    }
    u.fromOptions = d;
  })(l || (l = {}));
  class c extends o {
    constructor(d, p) {
      (super(),
        (this.writable = d),
        (this.options = l.fromOptions(p)),
        (this.errorCount = 0),
        (this.writeSemaphore = new r.Semaphore(1)),
        this.writable.onError((m) => this.fireError(m)),
        ...
        this.options.contentTypeEncoder
          ...
          .then((m) =>
            this.options.contentEncoder !== void 0
              ? this.options.contentEncoder.encode(m)
              : m,
          )
          .then(
            (m) => {
              const A = [];
              return (
                A.push(i, m.byteLength.toString(), a),
                A.push(a),
                this.doWrite(d, A, m)
              );
            },
    ...
    async doWrite(d, p, m) {
      try {
        return (
          await this.writable.write(p.join(""), "ascii"),
          this.writable.write(m)
        );
      } catch (A) {
...
function CT() {
  ...
  ((Eu = 1),
    ...
    (ai.AbstractMessageBuffer = void 0));
  const t = 13,
    e = 10,
    r = `\r
`;
  class n {
    ...
    tryReadHeaders(a = !1) {
      ...
      const u = this._read(c + l),
        d = new Map(),
        p = this.toString(u, "ascii").split(r);
...
${A}`);
  ...
  return ((ai.AbstractMessageBuffer = n), ai);
}
var Hs = {},
  Au;
function ST() {
      ...
      (function (t) {
        ...
        ((function (g) {
          ...
          (function (g) {
            function $(y) {
              return r.string(y)
                ? ((y = y.toLowerCase()), y === "json" ? g.JSON : g.Text)
                : g.Text;
            }
            g.fromString = $;
          })(A || (t.TraceFormat = A = {})));
        ...
        (function (g) {
          function $(y) {
            ...
            return (
              ...
              r.func(R.createCancellationTokenSource) &&
              (R.dispose === void 0 || r.func(R.dispose))
            );
          }
          g.is = $;
        ...
        (function (g) {
          function $(y) {
            ...
            return (
              R &&
              (ne.is(R.cancellationStrategy) ||
                C.is(R.connectionStrategy) ||
                se.is(R.messageStrategy))
            );
          }
          g.is = $;
        ...
        function T(g, $, y, R) {
          ...
          let me,
            ...
            ge,
            it = N.New;
          const xr = new a.Emitter(),
            Gn = new a.Emitter(),
            jn = new a.Emitter(),
            zn = new a.Emitter(),
            Un = new a.Emitter(),
            at =
              R && R.cancellationStrategy ? R.cancellationStrategy : ne.Message;
          function qn(h) {
            if (h === null)
              throw new Error(
          ...
          function Qi(h, k) {
            n.Message.isRequest(k)
              ? h.set(qn(k.id), k)
              : n.Message.isResponse(k)
                ? h.set(Ji(k.id), k)
                : h.set(Zi(), k);
          }
          function ea(h) {}
          ...
          function Vn() {
            (it === N.New || it === N.Listening) &&
              ((it = N.Closed), Gn.fire(void 0));
          }
          function ta(h) {
            xr.fire([h, void 0, void 0]);
          }
          function ra(h) {
            xr.fire(h);
          }
          (g.onClose(Vn), g.onError(ta), $.onClose(Vn), $.onError(ra));
          function Kn() {
            me ||
              le.size === 0 ||
              (me = (0, e.default)().timer.setImmediate(() => {
                ((me = void 0), na());
              }));
          }
          function Hn(h) {
            n.Message.isRequest(h)
              ? aa(h)
              : n.Message.isNotification(h)
                ? oa(h)
                : n.Message.isResponse(h)
                  ? sa(h)
                  : la(h);
          }
          function na() {
            ...
            const h = le.shift();
            try {
              const k = R?.messageStrategy;
              se.is(k) ? k.handleMessage(h, Hn) : Hn(h);
            } finally {
              Kn();
            }
          }
            ...
            try {
              if (n.Message.isNotification(h) && h.method === o.type.method) {
                ...
                if (n.Message.isRequest(M)) {
                  const re = R?.connectionStrategy,
                    ye =
                      re && re.cancelUndispatched
                        ? re.cancelUndispatched(M, ea)
                        : void 0;
                  if (ye && (ye.error !== void 0 || ye.result !== void 0)) {
                    (le.delete(O),
                      Ce.delete(k),
                      (ye.id = M.id),
                      ir(ye, h.method, Date.now()),
                      $.write(ye).catch(() =>
                        E.error(
          ...
          function aa(h) {
            if ($t()) return;
            function k(X, ce, ee) {
              const be = { jsonrpc: j, id: h.id };
              (X instanceof n.ResponseError
                ? (be.error = X.toJson())
                : (be.result = X === void 0 ? null : X),
                ir(be, ce, ee),
                $.write(be).catch(() => E.error("Sending response failed.")));
            }
            function O(X, ce, ee) {
              const be = { jsonrpc: j, id: h.id, error: X.toJson() };
              (ir(be, ce, ee),
                $.write(be).catch(() => E.error("Sending response failed.")));
            }
            function M(X, ce, ee) {
              X === void 0 && (X = null);
              const be = { jsonrpc: j, id: h.id, result: X };
              (ir(be, ce, ee),
                $.write(be).catch(() => E.error("Sending response failed.")));
            }
            fa(h);
            ...
            const Ae = Date.now();
            if (ye || F) {
              const X = h.id ?? String(Date.now()),
                ce = P.is(at.receiver)
                  ? at.receiver.createCancellationTokenSource(X)
                  : at.receiver.createCancellationTokenSource(h);
              (h.id !== null && Ie.has(h.id) && ce.cancel(),
                h.id !== null && Ce.set(X, ce));
              try {
                let ee;
                if (ye)
                  if (h.params === void 0) {
                    if (re !== void 0 && re.numberOfParams !== 0) {
                      O(
                        new n.ResponseError(
                          ...
                          `Request ${h.method} defines ${re.numberOfParams} params but received none.`,
                        ),
                        h.method,
                        Ae,
                      );
                    ...
                    if (
                      re !== void 0 &&
                      re.parameterStructures === n.ParameterStructures.byName
                    ) {
                      O(
                        new n.ResponseError(
                          n.ErrorCodes.InvalidParams,
                ...
                ee
                  ? be.then
                              ...
                              : Ge && r.string(Ge.message)
                                ? O(
                                    new n.ResponseError(
                                      ...
                                      `Request ${h.method} failed with message: ${Ge.message}`,
                                    ),
                                    h.method,
                                    Ae,
                                  )
                    ...
                    : (Ce.delete(X), k(ee, h.method, Ae))
                  : (Ce.delete(X), M(ee, h.method, Ae));
              } catch (ee) {
                (Ce.delete(X),
                  ee instanceof n.ResponseError
                    ...
                    : ee && r.string(ee.message)
                      ? O(
                          new n.ResponseError(
                            n.ErrorCodes.InternalError,
                            `Request ${h.method} failed with message: ${ee.message}`,
                          ),
                          h.method,
                          Ae,
                        )
...
${JSON.stringify(h.error, void 0, 4)}`)
                ...
                if ((da(h, O), O !== void 0)) {
                  ...
                  try {
                    ...
                    } else if (h.result !== void 0) O.resolve(h.result);
                    else throw new Error("Should never happen.");
                  } catch (M) {
                    M.message
                      ? E.error(
                          `Response handler '${O.method}' failed with message: ${M.message}`,
                        )
                      : E.error(
                          `Response handler '${O.method}' failed unexpectedly.`,
                        );
                  }
                }
              }
          ...
          function oa(h) {
            ...
            if (O || z)
              try {
                if ((Dr(h), O))
                  if (h.params === void 0)
                    (k !== void 0 &&
                      ...
                      E.error(
                        `Notification ${h.method} defines ${k.numberOfParams} params but received none.`,
                      ),
                      O());
                  else if (Array.isArray(h.params)) {
                    const M = h.params;
                    h.method === c.type.method && M.length === 2 && l.is(M[0])
                      ? O({ token: M[0], value: M[1] })
                      : (k !== void 0 &&
                          (k.parameterStructures ===
                            n.ParameterStructures.byName &&
                            E.error(
                              `Notification ${h.method} defines parameters by name but received parameters by position`,
                            ),
                          k.numberOfParams !== h.params.length &&
                            E.error(
                              `Notification ${h.method} defines ${k.numberOfParams} params but received ${M.length} arguments`,
                            )),
                        O(...M));
                  } else
                    (k !== void 0 &&
                ...
                M.message
                  ? E.error(
                      `Notification handler '${h.method}' failed with message: ${M.message}`,
                    )
                  : E.error(
                      `Notification handler '${h.method}' failed unexpectedly.`,
                    );
              }
            else jn.fire(h);
          }
...
${JSON.stringify(h, null, 4)}`);
          ...
          function ca(h) {
            if (!(Y === p.Off || !ge))
              if (Xe === A.Text) {
                let k;
                ((Y === p.Verbose || Y === p.Compact) &&
                  h.params &&
                  (k = `Params: ${st(h.params)}

`),
                  ge.log(`Sending request '${h.method} - (${h.id})'.`, k));
              } else Ct("send-request", h);
          }
          function ua(h) {
            if (!(Y === p.Off || !ge))
              if (Xe === A.Text) {
...
`)),
                  ge.log(`Sending notification '${h.method}'.`, k));
              } else Ct("send-notification", h);
          }
          function ir(h, k, O) {
            if (!(Y === p.Off || !ge))
              if (Xe === A.Text) {
                ...
                ((Y === p.Verbose || Y === p.Compact) &&
                  (h.error && h.error.data
                    ? (M = `Error data: ${st(h.error.data)}

`)
                    : h.result
                      ? (M = `Result: ${st(h.result)}
...
`)),
                  ge.log(
                    `Sending response '${k} - (${h.id})'. Processing request took ${Date.now() - O}ms`,
                    M,
                  ));
              } else Ct("send-response", h);
          }
          function fa(h) {
            if (!(Y === p.Off || !ge))
              if (Xe === A.Text) {
...
`),
                  ge.log(`Received request '${h.method} - (${h.id})'.`, k));
              } else Ct("receive-request", h);
          }
          function Dr(h) {
...
`)),
                  ge.log(`Received notification '${h.method}'.`, k));
              } else Ct("receive-notification", h);
          }
          function da(h, k) {
            if (!(Y === p.Off || !ge))
              if (Xe === A.Text) {
                ...
                if (
                  ((Y === p.Verbose || Y === p.Compact) &&
                    (h.error && h.error.data
                      ? (O = `Error data: ${st(h.error.data)}

`)
                      : h.result
                        ? (O = `Result: ${st(h.result)}
...
`)),
                  ...
                  const M = h.error
                    ? ` Request failed: ${h.error.message} (${h.error.code}).`
                    : "";
                  ge.log(
                    `Received response '${k.method} - (${h.id})' in ${Date.now() - k.timerStart}ms.${M}`,
                    O,
                  );
                } else
                  ge.log(
                    `Received response ${h.id} without active response promise.`,
                    O,
                  );
              } else Ct("receive-response", h);
          }
          function Ct(h, k) {
            if (!ge || Y === p.Off) return;
            const O = {
              isLSPMessage: !0,
              type: h,
              message: k,
          ...
          function Xt() {
            if (Wn()) throw new S(w.Closed, "Connection is closed.");
            if ($t()) throw new S(w.Disposed, "Connection is disposed.");
          }
          function ha() {
            if (Bn())
              throw new S(
          ...
          function pa() {
            if (!Bn()) throw new Error("Call listen() first.");
          }
          function Yt(h) {
          ...
          function Ee(h, k) {
            ...
            switch (M) {
              case 0:
                ...
                break;
              case 1:
                O = ve(h.parameterStructures, k[0]);
                break;
              default:
                O = [];
                for (let ie = 0; ie < k.length && ie < M; ie++)
                  O.push(Yt(k[ie]));
                if (k.length < M)
                  for (let ie = k.length; ie < M; ie++) O.push(null);
                break;
            }
            return O;
          }
          const q = {
            sendNotification: (h, ...k) => {
              Xt();
              let O, M;
              if (r.string(h)) {
                O = h;
                ...
                switch (ce) {
                  ...
                  default:
                    if (Ae === n.ParameterStructures.byName)
                      throw new Error(
                        `Received ${ce} parameters for 'by Name' notification parameter structure.`,
                      );
                    M = k.slice(ye, X).map((ee) => Yt(ee));
                    break;
                }
              } else {
                const re = k;
              ...
              const ie = { jsonrpc: j, method: O, params: M };
              return (
                ua(ie),
                $.write(ie).catch((re) => {
            ...
            onNotification: (h, k) => {
              ...
              return (
                r.func(h)
                  ...
                  : k &&
                    (r.string(h)
                      ? ((O = h), Q.set(h, { type: void 0, handler: k }))
                      : ((O = h.method),
                        Q.set(h.method, { type: h, handler: k }))),
                {
                  dispose: () => {
            ...
            onProgress: (h, k, O) => {
              if (_e.has(k))
                throw new Error(
                  `Progress handler for token ${k} already registered`,
                );
              return (
                _e.set(k, O),
                {
            ...
            sendProgress: (h, k, O) =>
              q.sendNotification(c.type, { token: k, value: O }),
            onUnhandledProgress: zn.event,
            sendRequest: (h, ...k) => {
              (Xt(), pa());
              let O, M, ie;
              if (r.string(h)) {
                ...
                switch (dt) {
                  ...
                  default:
                    if (be === n.ParameterStructures.byName)
                      throw new Error(
                        `Received ${dt} parameters for 'by Name' request parameter structure.`,
                      );
                    M = k.slice(ee, Ge).map((vh) => Yt(vh));
                    break;
                }
              } else {
                const X = k;
              ...
              let ye;
              ie &&
                (ye = ie.onCancellationRequested(() => {
                  const X = at.sender.sendCancellation(q, re);
                  return X === void 0
                    ? (E.log(
                        `Received no promise from cancellation strategy when cancelling id ${re}`,
                      ),
                      Promise.resolve())
                    : X.catch(() => {
                        E.log(
                          `Sending cancellation messages for id ${re} failed`,
                        );
                      });
                }));
              ...
              return (
                ca(Ae),
                typeof at.sender.enableCancellation == "function" &&
                  at.sender.enableCancellation(Ae),
                new Promise(async (X, ce) => {
                  const ee = (dt) => {
                    ...
                    throw (
                      ...
                      Ge.reject(
                        new n.ResponseError(
                          ...
                          dt.message ? dt.message : "Unknown reason",
                        ),
                      ),
                      dt
                    );
              ...
              return (
                d.is(h)
                  ...
                  : r.string(h)
                    ? ((O = null),
                      k !== void 0 &&
                        ((O = h), te.set(h, { handler: k, type: void 0 })))
                    : k !== void 0 &&
                      ((O = h.method),
                      te.set(h.method, { type: h, handler: k })),
                {
                  dispose: () => {
            ...
            trace: async (h, k, O) => {
              ...
              (O !== void 0 &&
                (r.boolean(O)
                  ? (M = O)
                  : ((M = O.sendNotification || !1),
                    (ie = O.traceFormat || A.Text))),
                (Y = h),
                (Xe = ie),
                Y === p.Off ? (ge = void 0) : (ge = k),
                M &&
                  !Wn() &&
                  !$t() &&
                  (await q.sendNotification(b.type, { value: p.toString(h) })));
            },
            onError: xr.event,
            onClose: Gn.event,
            ...
            dispose: () => {
              if ($t()) return;
              ((it = N.Disposed), Un.fire(void 0));
              const h = new n.ResponseError(
                n.ErrorCodes.PendingResponseRejected,
                "Pending response rejected since connection got disposed",
              );
              for (const k of ke.values()) k.reject(h);
              ((ke = new Map()),
                (Ce = new Map()),
                (Ie = new Set()),
                (le = new i.LinkedMap()),
            ...
            listen: () => {
              (Xt(), ha(), (it = N.Listening), g.listen(ia));
            },
            inspect: () => {
          ...
          return (
            q.onNotification(I.type, (h) => {
              if (Y === p.Off || !ge) return;
              const k = Y === p.Verbose || Y === p.Compact;
              ge.log(h.message, k ? h.verbose : void 0);
            }),
            q.onNotification(c.type, (h) => {
              const k = _e.get(h.token);
              k ? k(h.value) : zn.fire(h);
            }),
            q
          );
        }
...
function wT() {
  if (Cu) return Ca;
  ((Cu = 1), Object.defineProperty(Ca, "__esModule", { value: !0 }));
  const t = Fl();
  class e extends t.AbstractMessageBuffer {
    ...
    toString(l, c) {
      return c === "ascii"
        ? this.asciiDecoder.decode(l)
        : new TextDecoder(c).decode(l);
    }
    asNative(l, c) {
      ...
      applicationJson: Object.freeze({
        ...
        decoder: Object.freeze({
          ...
          decode: (o, l) => {
            ...
            return Promise.resolve(
              JSON.parse(new TextDecoder(l.charset).decode(o)),
            );
          },
        }),
      }),
...
function kT() {
  ...
  ((_u = 1),
    ...
    (si.ImplementationRequest = void 0));
  const t = pe();
  var e;
  return (
    (function (r) {
...
function bT() {
  ...
  ((Iu = 1),
    ...
    (oi.TypeDefinitionRequest = void 0));
  const t = pe();
  var e;
  return (
    (function (r) {
...
function NT() {
  ...
  ((Pu = 1),
    ...
    (dr.DidChangeWorkspaceFoldersNotification = dr.WorkspaceFoldersRequest =
      void 0));
  const t = pe();
  var e;
  (function (n) {
  ...
  })(e || (dr.WorkspaceFoldersRequest = e = {}));
  var r;
  return (
    (function (n) {
    ...
    })(r || (dr.DidChangeWorkspaceFoldersNotification = r = {})),
    dr
  );
}
var li = {},
...
function _T() {
  ...
  ((Ou = 1),
    ...
    (li.ConfigurationRequest = void 0));
  const t = pe();
  var e;
  return (
    (function (r) {
...
function IT() {
  ...
  ((Lu = 1),
    ...
    (hr.ColorPresentationRequest = hr.DocumentColorRequest = void 0));
  const t = pe();
  var e;
  (function (n) {
  ...
  return (
    (function (n) {
      ((n.method = "textDocument/colorPresentation"),
        (n.messageDirection = t.MessageDirection.clientToServer),
        (n.type = new t.ProtocolRequestType(n.method)));
    })(r || (hr.ColorPresentationRequest = r = {})),
    hr
  );
}
var pr = {},
...
function PT() {
  ...
  ((xu = 1),
    ...
    (pr.FoldingRangeRefreshRequest = pr.FoldingRangeRequest = void 0));
  const t = pe();
  var e;
  (function (n) {
  ...
  return (
    (function (n) {
      ((n.method = "workspace/foldingRange/refresh"),
        (n.messageDirection = t.MessageDirection.serverToClient),
        (n.type = new t.ProtocolRequestType0(n.method)));
    })(r || (pr.FoldingRangeRefreshRequest = r = {})),
    pr
  );
}
var ci = {},
...
function LT() {
  ...
  ((Mu = 1),
    ...
    (ui.SelectionRangeRequest = void 0));
  const t = pe();
  var e;
  return (
    (function (r) {
...
function xT() {
  ...
  ((Fu = 1),
    ...
    (Nt.WorkDoneProgressCancelNotification =
      Nt.WorkDoneProgressCreateRequest =
      Nt.WorkDoneProgress =
        void 0));
  const t = Mn(),
    e = pe();
  ...
  })(n || (Nt.WorkDoneProgressCreateRequest = n = {}));
  var i;
  return (
    (function (a) {
    ...
    })(i || (Nt.WorkDoneProgressCancelNotification = i = {})),
    Nt
  );
}
var _t = {},
...
function DT() {
  ...
  ((Gu = 1),
    ...
    (_t.CallHierarchyOutgoingCallsRequest =
      _t.CallHierarchyIncomingCallsRequest =
      _t.CallHierarchyPrepareRequest =
        void 0));
  const t = pe();
  var e;
  (function (i) {
  ...
  })(e || (_t.CallHierarchyPrepareRequest = e = {}));
  var r;
  (function (i) {
    ((i.method = "callHierarchy/incomingCalls"),
      (i.messageDirection = t.MessageDirection.clientToServer),
      (i.type = new t.ProtocolRequestType(i.method)));
  })(r || (_t.CallHierarchyIncomingCallsRequest = r = {}));
  var n;
  return (
    (function (i) {
      ((i.method = "callHierarchy/outgoingCalls"),
        (i.messageDirection = t.MessageDirection.clientToServer),
        (i.type = new t.ProtocolRequestType(i.method)));
    })(n || (_t.CallHierarchyOutgoingCallsRequest = n = {})),
    _t
  );
}
var ze = {},
...
function MT() {
  ...
  (function (o) {
    ((o.method = "textDocument/semanticTokens"),
      (o.type = new t.RegistrationType(o.method)));
...
function GT() {
  ...
  ((Uu = 1),
    ...
    (di.LinkedEditingRangeRequest = void 0));
  const t = pe();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/linkedEditingRange"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (di.LinkedEditingRangeRequest = e = {})),
    di
  );
}
var Oe = {},
...
function UT() {
  ...
  ((Wu = 1),
    ...
    (Pt.TypeHierarchySubtypesRequest =
      Pt.TypeHierarchySupertypesRequest =
      Pt.TypeHierarchyPrepareRequest =
        void 0));
  const t = pe();
  var e;
  (function (i) {
...
function qT() {
  ...
  ((Vu = 1),
    ...
    (mr.InlineValueRefreshRequest = mr.InlineValueRequest = void 0));
  const t = pe();
  var e;
  (function (n) {
  ...
  return (
    (function (n) {
      ((n.method = "workspace/inlineValue/refresh"),
        (n.messageDirection = t.MessageDirection.serverToClient),
        (n.type = new t.ProtocolRequestType0(n.method)));
    })(r || (mr.InlineValueRefreshRequest = r = {})),
    mr
  );
}
var Ot = {},
...
function BT() {
  ...
  ((Ku = 1),
    ...
    (Ot.InlayHintRefreshRequest =
      Ot.InlayHintResolveRequest =
      Ot.InlayHintRequest =
        void 0));
  const t = pe();
  var e;
...
function VT() {
  ...
  ((Xu = 1),
    ...
    (ue.DidCloseNotebookDocumentNotification =
      ue.DidSaveNotebookDocumentNotification =
      ue.DidChangeNotebookDocumentNotification =
      ue.NotebookCellArrayChange =
      ue.DidOpenNotebookDocumentNotification =
      ue.NotebookDocumentSyncRegistrationType =
      ue.NotebookDocument =
      ue.NotebookCell =
      ue.ExecutionSummary =
      ue.NotebookCellKind =
  ...
  (function (m) {
    ...
    function b(w) {
      ...
      return (
        e.objectLiteral(S) &&
        t.uinteger.is(S.executionOrder) &&
    ...
    function I(w, S) {
      return w === S
        ? !0
        : w == null || S === null || S === void 0
          ? !1
          : w.executionOrder === S.executionOrder && w.success === S.success;
    }
    m.equals = I;
  ...
  (function (m) {
    ...
    function I(S, C) {
      const P = new Set();
      return (
        S.document !== C.document && P.add("document"),
        S.kind !== C.kind && P.add("kind"),
        S.executionSummary !== C.executionSummary && P.add("executionSummary"),
        (S.metadata !== void 0 || C.metadata !== void 0) &&
          !w(S.metadata, C.metadata) &&
          P.add("metadata"),
        (S.executionSummary !== void 0 || C.executionSummary !== void 0) &&
          !i.equals(S.executionSummary, C.executionSummary) &&
    ...
    function w(S, C) {
      ...
      if (P && W) {
        ...
        for (let B = 0; B < S.length; B++) if (!w(S[B], C[B])) return !1;
      }
      if (e.objectLiteral(S) && e.objectLiteral(C)) {
        const B = Object.keys(S),
          H = Object.keys(C);
        if (B.length !== H.length || (B.sort(), H.sort(), !w(B, H))) return !1;
        for (let ne = 0; ne < B.length; ne++) {
          const se = B[ne];
          if (!w(S[se], C[se])) return !1;
        }
      }
      return !0;
    }
  ...
  (function (m) {
    function A(I, w, S, C) {
      return { uri: I, notebookType: w, version: S, cells: C };
    }
    m.create = A;
    function b(I) {
      const w = I;
      return (
        e.objectLiteral(w) &&
        e.string(w.uri) &&
        t.integer.is(w.version) &&
        e.typedArray(w.cells, a.is)
      );
    }
    m.is = b;
  ...
  (function (m) {
    ((m.method = "notebookDocument/sync"),
      (m.messageDirection = r.MessageDirection.clientToServer),
      (m.type = new r.RegistrationType(m.method)));
  })(o || (ue.NotebookDocumentSyncRegistrationType = o = {}));
  var l;
  (function (m) {
    ((m.method = "notebookDocument/didOpen"),
      (m.messageDirection = r.MessageDirection.clientToServer),
      (m.type = new r.ProtocolNotificationType(m.method)),
      (m.registrationMethod = o.method));
  ...
  (function (m) {
    function A(I) {
      ...
      return (
        e.objectLiteral(w) &&
        t.uinteger.is(w.start) &&
        t.uinteger.is(w.deleteCount) &&
        (w.cells === void 0 || e.typedArray(w.cells, a.is))
      );
    }
    m.is = A;
    function b(I, w, S) {
      const C = { start: I, deleteCount: w };
  ...
  return (
    (function (m) {
      ((m.method = "notebookDocument/didClose"),
        ...
        (m.type = new r.ProtocolNotificationType(m.method)),
        (m.registrationMethod = o.method));
    })(p || (ue.DidCloseNotebookDocumentNotification = p = {})),
    ue
  );
}
var hi = {},
...
function KT() {
  ...
  ((Yu = 1),
    ...
    (hi.InlineCompletionRequest = void 0));
  const t = pe();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/inlineCompletion"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (hi.InlineCompletionRequest = e = {})),
    hi
  );
}
var Ju;
      ...
      (function (t) {
        ...
        (function (f) {
          function ve(Ee) {
            ...
            return (
              n.objectLiteral(q) &&
              (n.string(q.notebook) || oe.is(q.notebook)) &&
        ...
        (function (f) {
          function ve(Ee) {
            ...
            for (let q of Ee)
              if (!n.string(q) && !se.is(q) && !N.is(q)) return !1;
            return !0;
          }
          f.is = ve;
        ...
        (function (f) {
          function ve(Ee) {
            const q = Ee;
            return (
              q && (q.documentSelector === null || T.is(q.documentSelector))
            );
          }
          f.is = ve;
        ...
        (function (f) {
          function ve(q) {
            ...
            return (
              n.objectLiteral(h) &&
              (h.workDoneProgress === void 0 || n.boolean(h.workDoneProgress))
            );
          }
          f.is = ve;
          function Ee(q) {
        ...
        (function (f) {
          ((f.method = "textDocument/didClose"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(xr || (t.DidCloseTextDocumentNotification = xr = {}));
        var Gn;
        (function (f) {
          ((f.method = "textDocument/didSave"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(Gn || (t.DidSaveTextDocumentNotification = Gn = {}));
        var jn;
        (function (f) {
          ((f.Manual = 1), (f.AfterDelay = 2), (f.FocusOut = 3));
        })(jn || (t.TextDocumentSaveReason = jn = {}));
        var zn;
        (function (f) {
          ((f.method = "textDocument/willSave"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(zn || (t.WillSaveTextDocumentNotification = zn = {}));
        var Un;
        (function (f) {
          ((f.method = "textDocument/willSaveWaitUntil"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Un || (t.WillSaveTextDocumentWaitUntilRequest = Un = {}));
        var at;
        (function (f) {
        ...
        (function (f) {
          function ve(Ee) {
            ...
            return (
              n.objectLiteral(q) &&
              (r.URI.is(q.baseUri) || r.WorkspaceFolder.is(q.baseUri)) &&
              n.string(q.pattern)
            );
          }
          f.is = ve;
        })(Ji || (t.RelativePattern = Ji = {}));
        var Zi;
        (function (f) {
        ...
        (function (f) {
          ((f.method = "textDocument/publishDiagnostics"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(Qi || (t.PublishDiagnosticsNotification = Qi = {}));
        var ea;
        (function (f) {
          ((f.Invoked = 1),
            (f.TriggerCharacter = 2),
            (f.TriggerForIncompleteCompletions = 3));
        })(ea || (t.CompletionTriggerKind = ea = {}));
        var Bn;
        (function (f) {
          ((f.method = "textDocument/completion"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Bn || (t.CompletionRequest = Bn = {}));
        var Wn;
        (function (f) {
          ((f.method = "completionItem/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Wn || (t.CompletionResolveRequest = Wn = {}));
        var $t;
        (function (f) {
        ...
        })(Vn || (t.SignatureHelpTriggerKind = Vn = {}));
        var ta;
        (function (f) {
          ((f.method = "textDocument/signatureHelp"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ta || (t.SignatureHelpRequest = ta = {}));
        var ra;
        (function (f) {
          ((f.method = "textDocument/definition"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ra || (t.DefinitionRequest = ra = {}));
        var Kn;
        (function (f) {
        ...
        (function (f) {
          ((f.method = "textDocument/documentHighlight"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Hn || (t.DocumentHighlightRequest = Hn = {}));
        var na;
        (function (f) {
          ((f.method = "textDocument/documentSymbol"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(na || (t.DocumentSymbolRequest = na = {}));
        var ia;
        (function (f) {
          ((f.method = "textDocument/codeAction"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ia || (t.CodeActionRequest = ia = {}));
        var aa;
        (function (f) {
          ((f.method = "codeAction/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(aa || (t.CodeActionResolveRequest = aa = {}));
        var sa;
        (function (f) {
          ((f.method = "workspace/symbol"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(sa || (t.WorkspaceSymbolRequest = sa = {}));
        var oa;
        (function (f) {
          ((f.method = "workspaceSymbol/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(oa || (t.WorkspaceSymbolResolveRequest = oa = {}));
        var la;
        (function (f) {
          ((f.method = "textDocument/codeLens"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(la || (t.CodeLensRequest = la = {}));
        var st;
        (function (f) {
        ...
        (function (f) {
          ((f.method = "workspace/codeLens/refresh"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolRequestType0(f.method)));
        })(ca || (t.CodeLensRefreshRequest = ca = {}));
        var ua;
        (function (f) {
          ((f.method = "textDocument/documentLink"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ua || (t.DocumentLinkRequest = ua = {}));
        var ir;
        (function (f) {
          ((f.method = "documentLink/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ir || (t.DocumentLinkResolveRequest = ir = {}));
        var fa;
        (function (f) {
          ((f.method = "textDocument/formatting"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(fa || (t.DocumentFormattingRequest = fa = {}));
        var Dr;
        (function (f) {
          ((f.method = "textDocument/rangeFormatting"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Dr || (t.DocumentRangeFormattingRequest = Dr = {}));
        var da;
        (function (f) {
          ((f.method = "textDocument/rangesFormatting"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(da || (t.DocumentRangesFormattingRequest = da = {}));
        var Ct;
        (function (f) {
        ...
        (function (f) {
          ((f.method = "textDocument/rename"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ha || (t.RenameRequest = ha = {}));
        var pa;
        (function (f) {
          ((f.method = "textDocument/prepareRename"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(pa || (t.PrepareRenameRequest = pa = {}));
        var Yt;
        (function (f) {
        ...
        })(Xn || (t.ApplyWorkspaceEditRequest = Xn = {}));
      })(Ys)),
    Ys
  );
}
...
function XT() {
  ...
  ((Zu = 1),
    ...
    (pi.createProtocolConnection = void 0));
  const t = Mn();
  function e(r, n, i, a) {
    return (
      t.ConnectionStrategy.is(a) && (a = { connectionStrategy: a }),
      (0, t.createMessageConnection)(r, n, i, a)
    );
  }
...
class ZT {
  constructor(e) {
    ((this.updateBuildOptions = {
      ...
      (this.buildPhaseListeners = new ji()),
      (this.documentPhaseListeners = new ji()),
  ...
  async build(e, r = {}, n = he.CancellationToken.None) {
    for (const i of e) {
      ...
      if (i.state === V.Validated) {
        if (typeof r.validation == "boolean" && r.validation)
          this.resetToState(i, V.IndexedReferences);
  ...
  async buildDocuments(e, r, n) {
    (this.prepareBuild(e, r),
      await this.runCancelable(e, V.Parsed, n, (s) =>
        this.langiumDocumentFactory.update(s, n),
      ),
      await this.runCancelable(e, V.IndexedContent, n, (s) =>
        this.indexManager.updateContent(s, n),
      ),
      await this.runCancelable(e, V.ComputedScopes, n, async (s) => {
        const o = this.serviceRegistry.getServices(s.uri).references
          .ScopeComputation;
    ...
    (await this.runCancelable(i, V.Linked, n, (s) =>
      ...
      await this.runCancelable(i, V.IndexedReferences, n, (s) =>
        this.indexManager.updateReferences(s, n),
      ));
    const a = e.filter((s) =>
      this.shouldValidate(s) ? !0 : (this.markAsCompleted(s), !1),
    );
  ...
  async runCancelable(e, r, n, i) {
    for (const s of e)
      s.state < r &&
        ...
        await i(s),
        (s.state = r),
        await this.notifyDocumentPhase(s, r, n));
  ...
  awaitDocumentState(e, r, n) {
    ...
    if (i) {
      ...
      if (n.isCancellationRequested) return Promise.reject(nn);
      if (this.currentState >= e && e > i.state)
        return Promise.reject(
          new Sa.ResponseError(
            Sa.LSPErrorCodes.RequestFailed,
      ...
      return Promise.reject(
        new Sa.ResponseError(
          Sa.LSPErrorCodes.ServerCancelled,
  ...
  async validate(e, r) {
    ...
    o &&
      ...
      o.result.validationChecks
        ? (o.result.validationChecks = fe(o.result.validationChecks)
            .concat(a.categories)
            .distinct()
            .toArray())
  ...
  getFileDescriptions(e, r) {
    return r
      ? this.symbolByTypeIndex.get(e, r, () =>
          (this.symbolIndex.get(e) ?? []).filter((a) =>
            this.astReflection.isSubtype(a.type, r),
          ),
        )
...
class eR {
  ...
  initialized(e) {
    return this.mutex.write((r) =>
      this.initializeWorkspace(this.folders ?? [], r),
    );
  }
  ...
  async performStartup(e) {
    ...
    await Promise.all(
      e
        .map((s) => this.getRootFolder(s))
        .map(async (s) => this.traverseFolder(s, i)),
    );
    const a = fe(i)
      ...
      await Promise.all(
        n.map(async (i) => {
          this.shouldIncludeEntry(i) &&
            (i.isDirectory
              ? await this.traverseFolder(i.uri, r)
              : i.isFile && r.push(i.uri));
        }),
      );
    } catch (n) {
      console.error(
...
class nR {
  ...
  toTokenTypeDictionary(e) {
    if (tf(e)) return e;
    const r = Kd(e) ? Object.values(e.modes).flat() : e,
      n = {};
...
function aR(t, e, r) {
  ...
  const a = Hd(t),
    s = Tc(n),
    o = lR({ lines: a, position: i, options: s });
  return hR({ index: 0, tokens: o, position: i });
}
function sR(t, e) {
  const r = Tc(e),
    n = Hd(t);
...
function Hd(t) {
  let e = "";
  return (typeof t == "string" ? (e = t) : (e = t.text), e.split(lp));
}
...
function lR(t) {
  ...
  for (let i = 0; i < t.lines.length; i++) {
    ...
    if (((o = o.substring(0, dR(o))), Gl(o, l) >= o.length)) {
      if (e.length > 0) {
        const u = Z.create(r, n);
        e.push({ type: "break", content: "", range: K.create(u, u) });
      }
    } else {
      rf.lastIndex = l;
      const u = rf.exec(o);
      if (u) {
        const d = u[0],
          p = u[1],
          m = Z.create(r, n + l),
          A = Z.create(r, n + l + d.length);
        (e.push({ type: "tag", content: p, range: K.create(m, A) }),
          (l += d.length),
          (l = Gl(o, l)));
      }
      if (l < o.length) {
        const d = o.substring(l),
          p = Array.from(d.matchAll(oR));
        e.push(...cR(p, d, r, n + l));
      }
    }
    (r++, (n = 0));
  ...
  if (t.length === 0) {
    ...
    for (const o of t) {
      ...
      c.length > 0 &&
        i.push({
          ...
          range: K.create(Z.create(r, a + n), Z.create(r, l + n)),
        });
      let u = c.length + 1;
      const d = o[1];
      if (
        ...
        i.push({
          type: "text",
          content: "",
          range: K.create(Z.create(r, a + u + n), Z.create(r, a + u + n)),
        });
      a = l + o[0].length;
    }
    ...
    s.length > 0 &&
      i.push({
        type: "text",
        content: s,
        range: K.create(Z.create(r, a + n), Z.create(r, a + n + s.length)),
      });
  }
  return i;
}
const uR = /\S/,
  fR = /\s*$/;
function Gl(t, e) {
  const r = t.substring(e).match(uR);
...
function hR(t) {
  ...
  for (; t.index < t.tokens.length; ) {
    const a = pR(t, r[r.length - 1]);
    a && r.push(a);
  }
  const n = r[0]?.range.start ?? e,
    i = r[r.length - 1]?.range.end ?? e;
  return new nf(r, K.create(n, i));
}
function pR(t, e) {
  const r = t.tokens[t.index];
  if (r.type === "tag") return Yd(t, !1);
  if (r.type === "text" || r.type === "inline-tag") return Xd(t);
  (mR(r, e), t.index++);
}
function mR(t, e) {
  if (e) {
    const r = new Zd("", t.range);
...
function Xd(t) {
  ...
  for (; e && e.type !== "break" && e.type !== "tag"; )
    (i.push(gR(t)), (n = e), (e = t.tokens[t.index]));
  return new jl(i, K.create(r.range.start, n.range.end));
}
function gR(t) {
  return t.tokens[t.index].type === "inline-tag" ? Yd(t, !0) : Jd(t);
}
function Yd(t, e) {
  const r = t.tokens[t.index++],
  ...
  if (t.tokens[t.index]?.type === "text")
    if (e) {
      ...
      return new Zs(
        ...
        new jl([a], a.range),
        e,
        K.create(r.range.start, a.range.end),
      );
    } else {
      const a = Xd(t);
      return new Zs(n, a, e, K.create(r.range.start, a.range.end));
    }
  else {
    const a = r.range;
    return new Zs(n, new jl([], a), e, a);
  }
}
function Jd(t) {
  const e = t.tokens[t.index++];
  return new Zd(e.content, e.range);
}
function Tc(t) {
  if (!t) return Tc({ start: "/**", end: "*/", line: "*" });
  const { start: e, end: r, line: n } = t;
  return { start: Js(e, !0), end: Js(r, !1), line: Js(n, !0) };
}
function Js(t, e) {
  if (typeof t == "string" || typeof t == "object") {
    const r = typeof t == "string" ? $s(t) : t.source;
...
function yR(t, e, r) {
  if (t === "linkplain" || t === "linkcode" || t === "link") {
    ...
    return (
      (t === "linkcode" || (t === "link" && r.link === "code")) &&
        (i = `\`${i}\``),
      r.renderLink?.(e, i) ?? TR(e, i)
    );
  }
}
function TR(t, e) {
...
class RR {
  ...
  documentationLinkRenderer(e, r, n) {
    const i =
      this.findNameInLocalSymbols(e, r) ?? this.findNameInGlobalScope(e, r);
    if (i && i.nameSegment) {
...
class vR {
  ...
  getComment(e) {
    return oT(e)
      ? e.$comment
      : np(e.$cstNode, this.grammarConfig().multilineCommentRules)?.text;
  }
}
class ER {
  constructor(e) {
...
class AR {
  ...
  write(e) {
    ...
    return (
      ...
      this.enqueue(this.writeQueue, e, r.token)
    );
  }
  read(e) {
      ...
      await Promise.all(
        e.map(async ({ action: r, deferred: n, cancellationToken: i }) => {
          try {
            ...
            Ps(a) ? n.resolve(void 0) : n.reject(a);
          }
        }),
      ),
      (this.done = !0),
...
class $R {
  ...
  createDehyrationContext(e) {
    ...
    if (e.$cstNode) for (const i of Ro(e.$cstNode)) n.set(i, {});
  ...
  dehydrateAstNode(e, r) {
    ...
    ((n.$type = e.$type),
      ...
      e.$cstNode !== void 0 &&
        (n.$cstNode = this.dehydrateCstNode(e.$cstNode, r)));
    for (const [i, a] of Object.entries(e))
      if (!i.startsWith("$"))
        if (Array.isArray(a)) {
          const s = [];
  ...
  hydrateCstLeafNode(e) {
    ...
    return new Pl(
      n,
      i,
      { start: { line: a, character: s }, end: { line: o, character: l } },
      r,
      c,
    );
  }
  ...
  createGrammarElementIdMap() {
    let e = 0;
    for (const r of zt(this.grammar))
      Lh(r) && this.grammarElementIdMap.set(r, e++);
  }
}
function vt(t) {
  return {
    documentation: {
      CommentProvider: (e) => new vR(e),
      DocumentationProvider: (e) => new RR(e),
    },
    parser: {
      AsyncParser: (e) => new ER(e),
      GrammarConfig: (e) => _p(e),
      LangiumParser: (e) => Uy(e),
      CompletionParser: (e) => zy(e),
      ValueConverter: () => new Gd(),
      TokenBuilder: () => new Fd(),
      Lexer: (e) => new nR(e),
      ParserErrorMessageProvider: () => new Od(),
      LexerErrorMessageProvider: () => new tR(),
    },
    workspace: {
      AstNodeLocator: () => new yT(),
      AstNodeDescriptionProvider: (e) => new mT(e),
      ReferenceDescriptionProvider: (e) => new gT(e),
    },
    references: {
      Linker: (e) => new Jy(e),
      NameProvider: () => new Qy(),
      ScopeProvider: (e) => new sT(e),
      ScopeComputation: (e) => new tT(e),
      References: (e) => new eT(e),
    },
    serializer: {
      Hydrator: (e) => new $R(e),
      JsonSerializer: (e) => new lT(e),
    },
    validation: {
      DocumentValidator: (e) => new dT(e),
      ValidationRegistry: (e) => new uT(e),
    },
    shared: () => t.shared,
  };
}
function Et(t) {
  return {
    ServiceRegistry: (e) => new cT(e),
    workspace: {
      LangiumDocuments: (e) => new Yy(e),
      LangiumDocumentFactory: (e) => new Xy(e),
      DocumentBuilder: (e) => new ZT(e),
      IndexManager: (e) => new QT(e),
      WorkspaceManager: (e) => new eR(e),
      FileSystemProvider: (e) => t.fileSystemProvider(e),
      WorkspaceLock: () => new AR(),
      ConfigurationProvider: (e) => new RT(e),
    },
    profilers: {},
  };
}
var sf;
(function (t) {
  t.merge = (e, r) => zi(zi({}, e), r);
})(sf || (sf = {}));
function we(t, e, r, n, i, a, s, o, l) {
  const c = [t, e, r, n, i, a, s, o, l].reduce(zi, {});
  return Qd(c);
}
const CR = Symbol("isProxy");
function Qd(t, e) {
  const r = new Proxy(
    {},
    {
...
function lf(t, e, r, n) {
  if (e in t) {
    ...
    t[e] = of;
    try {
      t[e] = typeof i == "function" ? i(n) : Qd(i, n);
    } catch (a) {
...
const At = { fileSystemProvider: () => new SR() },
  wR = {
    Grammar: () => {},
    LanguageMetaData: () => ({
      caseInsensitive: !1,
...
function Vt(t) {
  ...
  return (
    e.shared.workspace.LangiumDocumentFactory.fromModel(
      r,
      ft.parse(`memory:/${r.name ?? "grammar"}.langium`),
    ),
    r
  );
}
var NR = Object.defineProperty,
  _ = (t, e) => NR(t, "name", { value: e, configurable: !0 }),
  zl;
((t) => {
  t.Terminals = {
...
var wa = { $type: "Accelerator", name: "name", x: "x", y: "y" },
  ka = {
    $type: "Anchor",
    evolution: "evolution",
    name: "name",
  ...
  mi = { $type: "Annotation", number: "number", text: "text", x: "x", y: "y" },
  Qs = { $type: "Annotations", x: "x", y: "y" },
  xt = {
    $type: "Architecture",
    accDescr: "accDescr",
    accTitle: "accTitle",
...
_(_R, "isArchitecture");
var ba = { $type: "Axis", label: "label", name: "name" },
  Xa = { $type: "Branch", name: "name", order: "order" };
function IR(t) {
  return nt.isInstance(t, Xa.$type);
}
_(IR, "isBranch");
...
var gr = {
  ...
  _a = { $type: "Curve", entries: "entries", label: "label", name: "name" },
  Ia = { $type: "Deaccelerator", name: "name", x: "x", y: "y" },
  ...
  to = { $type: "Entry", axis: "axis", value: "value" },
  ...
  ro = { $type: "Evolve", component: "component", target: "target" },
  $r = {
    $type: "GitGraph",
    accDescr: "accDescr",
    accTitle: "accTitle",
...
_(OR, "isGitGraph");
var gi = { $type: "Group", icon: "icon", id: "id", in: "in", title: "title" },
  bi = {
    $type: "Info",
    accDescr: "accDescr",
    accTitle: "accTitle",
...
function LR(t) {
  return nt.isInstance(t, bi.$type);
}
_(LR, "isInfo");
var yi = { $type: "Item", classSelector: "classSelector", name: "name" },
  no = { $type: "Junction", id: "id", in: "in" },
  Ti = {
    $type: "Label",
    negX: "negX",
    negY: "negY",
...
var La = {
  ...
  io = { $type: "Option", name: "name", value: "value" },
  Qr = {
    $type: "Packet",
    accDescr: "accDescr",
    accTitle: "accTitle",
...
_(FR, "isPie");
var Ya = { $type: "PieSection", label: "label", value: "value" };
function GR(t) {
  return nt.isInstance(t, Ya.$type);
}
_(GR, "isPieSection");
var ao = { $type: "Pipeline", components: "components", parent: "parent" },
  xa = {
  ...
  so = { $type: "Section", classSelector: "classSelector", name: "name" },
  zr = {
    $type: "Service",
    icon: "icon",
    iconText: "iconText",
  ...
  oo = { $type: "Size", height: "height", width: "width" },
  Ur = { $type: "Statement" },
  tn = {
    $type: "Treemap",
    accDescr: "accDescr",
...
_(jR, "isTreemap");
var lo = { $type: "TreemapRow", indent: "indent", item: "item" },
  co = { $type: "TreeNode", indent: "indent", name: "name" },
  Ri = {
    $type: "TreeView",
    accDescr: "accDescr",
    accTitle: "accTitle",
...
var sn,
        ...
        (super(...arguments),
          (this.types = {
            ...
            Anchor: {
              name: ka.$type,
              properties: {
                evolution: { name: ka.evolution },
                name: { name: ka.name },
                visibility: { name: ka.visibility },
              },
              superTypes: [],
            },
            Annotation: {
            ...
            Annotations: {
              name: Qs.$type,
              properties: { x: { name: Qs.x }, y: { name: Qs.y } },
              superTypes: [],
            },
            Architecture: {
              name: xt.$type,
            ...
            Checkout: {
              name: cf.$type,
              properties: { branch: { name: cf.branch } },
              superTypes: [Ur.$type],
            },
            CherryPicking: {
              name: Na.$type,
            ...
            ClassDefStatement: {
              name: eo.$type,
              properties: {
                className: { name: eo.className },
                styleText: { name: eo.styleText },
              },
              superTypes: [],
            },
            Commit: {
              ...
              properties: {
                id: { name: Jr.id },
                message: { name: Jr.message },
                tags: { name: Jr.tags, defaultValue: [] },
                type: { name: Jr.type },
              },
              superTypes: [Ur.$type],
            },
            Component: {
              name: gr.$type,
              properties: {
                decorator: { name: gr.decorator },
                evolution: { name: gr.evolution },
                inertia: { name: gr.inertia, defaultValue: !1 },
                label: { name: gr.label },
                name: { name: gr.name },
                visibility: { name: gr.visibility },
              },
              superTypes: [],
            },
            Curve: {
              name: _a.$type,
              properties: {
                entries: { name: _a.entries, defaultValue: [] },
                label: { name: _a.label },
                name: { name: _a.name },
              },
              superTypes: [],
            ...
            Decorator: {
              name: uf.$type,
              properties: { strategy: { name: uf.strategy } },
              superTypes: [],
            },
            Direction: {
              name: jr.$type,
              properties: {
                accDescr: { name: jr.accDescr },
                accTitle: { name: jr.accTitle },
                dir: { name: jr.dir },
                statements: { name: jr.statements, defaultValue: [] },
                title: { name: jr.title },
              },
              superTypes: [$r.$type],
            },
            ...
            Entry: {
              name: to.$type,
              properties: {
                axis: { name: to.axis, referenceType: ba.$type },
                value: { name: to.value },
              },
              superTypes: [],
            },
            ...
            EvolutionStage: {
              name: Pa.$type,
              properties: {
                boundary: { name: Pa.boundary },
                name: { name: Pa.name },
                secondName: { name: Pa.secondName },
              },
              superTypes: [],
            },
            Evolve: {
              name: ro.$type,
              properties: {
                component: { name: ro.component },
                target: { name: ro.target },
              },
              superTypes: [],
            },
            GitGraph: {
              ...
              properties: {
                ...
                statements: { name: $r.statements, defaultValue: [] },
                title: { name: $r.title },
              },
              superTypes: [],
            },
            ...
            Info: {
              name: bi.$type,
              properties: {
                accDescr: { name: bi.accDescr },
                accTitle: { name: bi.accTitle },
                title: { name: bi.title },
              },
              superTypes: [],
            },
            Item: {
              name: yi.$type,
              properties: {
                classSelector: { name: yi.classSelector },
                name: { name: yi.name },
              },
              superTypes: [],
            },
            Junction: {
              name: no.$type,
              properties: { id: { name: no.id }, in: { name: no.in } },
              superTypes: [],
            },
            Label: {
              name: Ti.$type,
              properties: {
                negX: { name: Ti.negX, defaultValue: !1 },
                negY: { name: Ti.negY, defaultValue: !1 },
                offsetX: { name: Ti.offsetX },
                offsetY: { name: Ti.offsetY },
              },
              superTypes: [],
            },
            Leaf: {
              name: Oa.$type,
              properties: {
                classSelector: { name: Oa.classSelector },
                name: { name: Oa.name },
                value: { name: Oa.value },
              },
              superTypes: [yi.$type],
            ...
            Link: {
              ...
              properties: {
                arrow: { name: yr.arrow },
                from: { name: yr.from },
                fromPort: { name: yr.fromPort },
                linkLabel: { name: yr.linkLabel },
                to: { name: yr.to },
                toPort: { name: yr.toPort },
              },
              superTypes: [],
            },
            Merge: {
            ...
            Note: {
              name: La.$type,
              properties: {
                evolution: { name: La.evolution },
                text: { name: La.text },
                visibility: { name: La.visibility },
              },
              superTypes: [],
            },
            Option: {
              ...
              properties: {
                name: { name: io.name },
                value: { name: io.value, defaultValue: !1 },
              },
              superTypes: [],
            },
            Packet: {
              ...
              properties: {
                ...
                blocks: { name: Qr.blocks, defaultValue: [] },
                title: { name: Qr.title },
              },
              superTypes: [],
            },
            ...
            Pie: {
              ...
              properties: {
                ...
                sections: { name: Cr.sections, defaultValue: [] },
                showData: { name: Cr.showData, defaultValue: !1 },
                title: { name: Cr.title },
              },
              superTypes: [],
            },
            ...
            Pipeline: {
              name: ao.$type,
              properties: {
                components: { name: ao.components, defaultValue: [] },
                parent: { name: ao.parent },
              },
              superTypes: [],
            },
            PipelineComponent: {
            ...
            Radar: {
              ...
              properties: {
                ...
                axes: { name: Tr.axes, defaultValue: [] },
                curves: { name: Tr.curves, defaultValue: [] },
                options: { name: Tr.options, defaultValue: [] },
                title: { name: Tr.title },
              },
              superTypes: [],
            },
            Section: {
              name: so.$type,
              properties: {
                classSelector: { name: so.classSelector },
                name: { name: so.name },
              },
              superTypes: [yi.$type],
            },
            ...
            Size: {
              name: oo.$type,
              properties: {
                height: { name: oo.height },
                width: { name: oo.width },
              },
              superTypes: [],
            },
            Statement: { name: Ur.$type, properties: {}, superTypes: [] },
            TreeNode: {
              name: co.$type,
              properties: {
                indent: { name: co.indent },
                name: { name: co.name },
              },
              superTypes: [],
            },
            TreeView: {
              ...
              properties: {
                ...
                nodes: { name: Ri.nodes, defaultValue: [] },
                title: { name: Ri.title },
              },
              superTypes: [],
            },
            Treemap: {
              ...
              properties: {
                ...
                title: { name: tn.title },
                TreemapRows: { name: tn.TreemapRows, defaultValue: [] },
              },
              superTypes: [],
            },
            TreemapRow: {
  ...
  Kt = { AstReflection: _(() => new eh(), "AstReflection") },
  sv = {
    Grammar: _(() => UR(), "Grammar"),
    LanguageMetaData: _(() => JR, "LanguageMetaData"),
    parser: {},
  },
  ov = {
    Grammar: _(() => qR(), "Grammar"),
    LanguageMetaData: _(() => ZR, "LanguageMetaData"),
    parser: {},
  },
  lv = {
    Grammar: _(() => BR(), "Grammar"),
    LanguageMetaData: _(() => QR, "LanguageMetaData"),
    parser: {},
  },
  cv = {
    Grammar: _(() => WR(), "Grammar"),
    LanguageMetaData: _(() => ev, "LanguageMetaData"),
    parser: {},
  },
  uv = {
    Grammar: _(() => VR(), "Grammar"),
    LanguageMetaData: _(() => tv, "LanguageMetaData"),
    parser: {},
  },
  fv = {
    Grammar: _(() => KR(), "Grammar"),
    LanguageMetaData: _(() => rv, "LanguageMetaData"),
    parser: {},
  },
  dv = {
    Grammar: _(() => HR(), "Grammar"),
    LanguageMetaData: _(() => nv, "LanguageMetaData"),
    parser: {},
  },
  hv = {
    Grammar: _(() => XR(), "Grammar"),
    LanguageMetaData: _(() => iv, "LanguageMetaData"),
    parser: {},
  },
  pv = {
    Grammar: _(() => YR(), "Grammar"),
    LanguageMetaData: _(() => av, "LanguageMetaData"),
    parser: {},
  },
  mv = /accDescr(?:[\t ]*:([^\n\r]*)|\s*{([^}]*)})/,
  gv = /accTitle[\t ]*:([^\n\r]*)/,
  yv = /title([\t ][^\n\r]*|)/,
  Tv = { ACC_DESCR: mv, ACC_TITLE: gv, TITLE: yv },
  on,
  Fn =
    ((on = class extends Gd {
      runConverter(e, r, n) {
...
`,
    ...
    _(on, "AbstractMermaidValueConverter"),
    on),
  ln,
  Os =
    ((ln = class extends Fn {
  ...
  Ht =
    ...
    _(cn, "AbstractMermaidTokenBuilder"),
    cn),
  un;
((un = class extends Ht {}), _(un, "CommonTokenBuilder"));
var fn,
  Rv =
    ((fn = class extends Ht {
      constructor() {
    ...
    _(fn, "TreemapTokenBuilder"),
    fn),
  vv = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/,
  dn,
  Ev =
    ((dn = class extends Fn {
      runCustomConverter(e, r, n) {
...
var hn,
  Av =
    ...
    _(hn, "TreemapValidator"),
    hn),
  rh = {
    parser: {
      TokenBuilder: _(() => new Rv(), "TokenBuilder"),
      ValueConverter: _(() => new Ev(), "ValueConverter"),
    },
    validation: { TreemapValidator: _(() => new Av(), "TreemapValidator") },
  };
function nh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), dv, rh);
  return (e.ServiceRegistry.register(r), th(r), { shared: e, Treemap: r });
}
_(nh, "createTreemapServices");
var pn,
  $v =
    ((pn = class extends Fn {
      runCustomConverter(e, r, n) {
    ...
    _(pn, "WardleyValueConverter"),
    pn),
  ih = { parser: { ValueConverter: _(() => new $v(), "ValueConverter") } };
function ah(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), pv, ih);
  return (e.ServiceRegistry.register(r), { shared: e, Wardley: r });
}
_(ah, "createWardleyServices");
var mn,
  Cv =
    ((mn = class extends Ht {
      constructor() {
    ...
    _(mn, "GitGraphTokenBuilder"),
    mn),
  sh = {
    parser: {
      TokenBuilder: _(() => new Cv(), "TokenBuilder"),
      ValueConverter: _(() => new Os(), "ValueConverter"),
    },
  };
function oh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), ov, sh);
  return (e.ServiceRegistry.register(r), { shared: e, GitGraph: r });
}
_(oh, "createGitGraphServices");
var gn,
  Sv =
    ((gn = class extends Ht {
      constructor() {
    ...
    _(gn, "InfoTokenBuilder"),
    gn),
  lh = {
    parser: {
      TokenBuilder: _(() => new Sv(), "TokenBuilder"),
      ValueConverter: _(() => new Os(), "ValueConverter"),
    },
  };
function ch(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), lv, lh);
  return (e.ServiceRegistry.register(r), { shared: e, Info: r });
}
_(ch, "createInfoServices");
var yn,
  wv =
    ((yn = class extends Ht {
      constructor() {
    ...
    _(yn, "PacketTokenBuilder"),
    yn),
  uh = {
    parser: {
      TokenBuilder: _(() => new wv(), "TokenBuilder"),
      ValueConverter: _(() => new Os(), "ValueConverter"),
    },
  };
function fh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), cv, uh);
  return (e.ServiceRegistry.register(r), { shared: e, Packet: r });
}
_(fh, "createPacketServices");
var Tn,
  kv =
    ((Tn = class extends Ht {
      constructor() {
  ...
  bv =
    ...
    _(Rn, "PieValueConverter"),
    Rn),
  dh = {
    parser: {
      TokenBuilder: _(() => new kv(), "TokenBuilder"),
      ValueConverter: _(() => new bv(), "ValueConverter"),
    },
  };
function hh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), uv, dh);
  return (e.ServiceRegistry.register(r), { shared: e, Pie: r });
}
_(hh, "createPieServices");
var vn,
  Nv =
    ((vn = class extends Fn {
      runCustomConverter(e, r, n) {
  ...
  _v =
    ...
    _(En, "TreeViewTokenBuilder"),
    En),
  ph = {
    parser: {
      TokenBuilder: _(() => new _v(), "TokenBuilder"),
      ValueConverter: _(() => new Nv(), "ValueConverter"),
    },
  };
function mh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), hv, ph);
  return (e.ServiceRegistry.register(r), { shared: e, TreeView: r });
}
_(mh, "createTreeViewServices");
var An,
  Iv =
    ((An = class extends Ht {
      constructor() {
  ...
  Pv =
    ...
    _($n, "ArchitectureValueConverter"),
    $n),
  gh = {
    parser: {
      TokenBuilder: _(() => new Iv(), "TokenBuilder"),
      ValueConverter: _(() => new Pv(), "ValueConverter"),
    },
  };
function yh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), sv, gh);
  return (e.ServiceRegistry.register(r), { shared: e, Architecture: r });
}
_(yh, "createArchitectureServices");
var Cn,
  Ov =
    ((Cn = class extends Ht {
      constructor() {
    ...
    _(Cn, "RadarTokenBuilder"),
    Cn),
  Th = {
    parser: {
      TokenBuilder: _(() => new Ov(), "TokenBuilder"),
      ValueConverter: _(() => new Os(), "ValueConverter"),
    },
  };
function Rh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), fv, Th);
  return (e.ServiceRegistry.register(r), { shared: e, Radar: r });
}
_(Rh, "createRadarServices");
var lt = {},
  Lv = {
    info: _(async () => {
      const { createInfoServices: t } = await St(
          async () => {
            const { createInfoServices: r } = await Promise.resolve().then(
              () => Mv,
            );
    ...
    packet: _(async () => {
      const { createPacketServices: t } = await St(
          async () => {
            const { createPacketServices: r } = await Promise.resolve().then(
              () => Fv,
            );
    ...
    pie: _(async () => {
      const { createPieServices: t } = await St(
          async () => {
            const { createPieServices: r } = await Promise.resolve().then(
              () => Gv,
            );
    ...
    treeView: _(async () => {
      const { createTreeViewServices: t } = await St(
          async () => {
            const { createTreeViewServices: r } = await Promise.resolve().then(
              () => jv,
            );
    ...
    architecture: _(async () => {
      const { createArchitectureServices: t } = await St(
          async () => {
            const { createArchitectureServices: r } =
              await Promise.resolve().then(() => zv);
    ...
    gitGraph: _(async () => {
      const { createGitGraphServices: t } = await St(
          async () => {
            const { createGitGraphServices: r } = await Promise.resolve().then(
              () => Uv,
            );
    ...
    radar: _(async () => {
      const { createRadarServices: t } = await St(
          async () => {
            const { createRadarServices: r } = await Promise.resolve().then(
              () => qv,
            );
    ...
    treemap: _(async () => {
      const { createTreemapServices: t } = await St(
          async () => {
            const { createTreemapServices: r } = await Promise.resolve().then(
              () => Bv,
            );
    ...
    wardley: _(async () => {
      const { createWardleyServices: t } = await St(
          async () => {
            const { createWardleyServices: r } = await Promise.resolve().then(
              () => Wv,
            );
...
async function xv(t, e) {
  ...
  if (i.lexerErrors.length > 0 || i.parserErrors.length > 0) throw new Dv(i);
  return i.value;
}
_(xv, "parse");
var Sn,
...
`),
          n = e.parserErrors.map((i) => {
            const a =
                i.token.startLine !== void 0 && !isNaN(i.token.startLine)
                  ? i.token.startLine
                  : "?",
              s =
...
`);
    ...
    _(Sn, "MermaidParseError"),
    Sn);
const Mv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, InfoModule: lh, createInfoServices: ch },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  Fv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PacketModule: uh, createPacketServices: fh },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  Gv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PieModule: dh, createPieServices: hh },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  jv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, TreeViewModule: ph, createTreeViewServices: mh },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  zv = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        ArchitectureModule: gh,
        createArchitectureServices: yh,
      },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ...
  Uv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, GitGraphModule: sh, createGitGraphServices: oh },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  qv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, RadarModule: Th, createRadarServices: Rh },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  Bv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, TreemapModule: rh, createTreemapServices: nh },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  Wv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, WardleyModule: ih, createWardleyServices: ah },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  );
